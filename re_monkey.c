...
void func_20()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_24(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_22(iVar0) && (!func_21(14) || Global_111866))
			{
...
void func_40(int iParam0)
{
	...
	while (iVar15 < Global_112915.f_7688.f_198)
	{
		...
		{
			func_41(Global_112915.f_7688.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_41(int iParam0)
{
	...
	{
		if (func_47(iParam0, Global_19954) == 1)
		{
			func_46(iParam0, Global_19954, 0);
			if (func_45(iParam0, Global_19954) == 0)
			{
				iVar0 = Global_19954;
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				...
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_64[iVar1], -335,66f, -95,24f, 46,16f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_64[iVar1], -2,32f, 0,66f, -0,8f, 2, true);
				break;
			
			case 2:
				iLocal_64[iVar1] = OBJECT::CREATE_OBJECT(joaat("prop_paint_brush05"), -336,04f, -94,9f, 46,02f, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_64[iVar1], -336,04f, -94,9f, 46,02f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_64[iVar1], 0,01f, 3,85f, 2,72f, 2, true);
				break;
			
			case 3:
				iLocal_64[iVar1] = OBJECT::CREATE_OBJECT(joaat("prop_paint_spray01b"), -336,34f, -95,66f, 46,02f, true, true, false);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iLocal_64[iVar1], -336,34f, -95,66f, 46,02f, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_64[iVar1], -2,86f, 0,76f, 28,89f, 2, true);
				break;
		}
		iVar0++;
	}
...
int func_55()
{
	...
	else if (iLocal_48 == 2)
	{
		...
		{
			if (PED::IS_PED_DEAD_OR_DYING(iLocal_50, true))
			{
				func_150();
			}
		}
		...
		switch (iLocal_49)
		{
			...
			case 1:
				if (func_56())
				{
					...
					{
						if (CAM::GET_FOCUS_PED_ON_SCREEN(30f, 31086, 0,8f, 0,7f, 0,25f, 8f, 0,333f, 31086, 24818) == iLocal_50)
						{
...
int func_57()
{
	...
	else
	{
		...
		{
			iLocal_50 = PED::CREATE_PED(26, joaat("u_m_m_streetart_01"), Local_51, fLocal_54, true, true);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("u_m_m_streetart_01"));
			iLocal_64[0] = OBJECT::CREATE_OBJECT(joaat("prop_cs_spray_can"), Local_69, true, true, false);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_64[0], iLocal_50, PED::GET_PED_BONE_INDEX(iLocal_50, 28422), 0f, -0,01f, -0,02f, Local_78, true, true, false, false, 2, true);
			PED::SET_PED_KEEP_TASK(iLocal_50, true);
			PED::SET_PED_CONFIG_FLAG(iLocal_50, 42, true);
			iLocal_57 = func_68(iLocal_50, 0, 145);
			func_58(1);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_50, joaat("player"));
...
int func_58(int iParam0)
{
	if (func_62())
	{
		...
		if (func_14(Global_112904))
		{
			func_59(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_14(Global_112904))
		{
...
int func_62()
{
	switch (func_63(&Global_31565, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_66(iParam0, Global_42596);
}
...
void func_72()
{
	...
	if (func_50(iLocal_50))
	{
		...
		Var2 = { ENTITY::GET_ENTITY_COORDS(iLocal_50, false) };
		fVar8 = 7,5f;
		...
		if (iLocal_55 < 3)
		{
			if (MISC::IS_BULLET_IN_AREA(Var2, fVar8, false) || MISC::IS_PROJECTILE_IN_AREA(Var2 - Var9, Var2 + Var9, false))
			{
				iLocal_55 = 3;
			}
		}
		switch (iLocal_55)
		{
			case 0:
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_74))
				{
					...
					TASK::TASK_PLAY_ANIM(iLocal_50, sLocal_74, sLocal_75, 1000f, -8f, -1, 8193, 0f, false, false, false);
					iLocal_55++;
				}
				break;
			...
			case 1:
				...
				if (func_82(PLAYER::PLAYER_PED_ID(), iLocal_50, 35f))
				{
					...
					TASK::TASK_PLAY_ANIM(0, sLocal_74, sLocal_76, 8f, -8f, -1, 8192, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sLocal_74, sLocal_77, 8f, -2f, -1, 8193, 0f, false, false, false);
			...
			case 5:
				...
				if (!ENTITY::IS_ENTITY_ON_SCREEN(iLocal_50) && SYSTEM::VDIST2(Var2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)) > 2500f)
				{
					iLocal_81 = SHAPETEST::START_SHAPE_TEST_LOS_PROBE(Var5, Var2, 1, 0, 7);
					iLocal_55++;
				}
				break;
...
int func_73()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_50, sLocal_74, sLocal_76, 3))
			{
				...
				if (fLocal_58 != 0,2f)
				{
					...
					Local_61 = { ENTITY::GET_ENTITY_COORDS(iLocal_50, false) - Vector(1f, 0f, 0f) };
					iLocal_60 = 1;
				}
				else
				{
		...
		case 1:
			...
			TASK::TASK_PLAY_ANIM(iLocal_50, sLocal_74, sLocal_76, 4f, -8f, -1, 0, fLocal_58, true, false, false);
			iLocal_83 = MISC::GET_GAME_TIMER();
			func_76(&iLocal_57);
			func_75();
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_64[0]))
			{
				ENTITY::DETACH_ENTITY(iLocal_64[0], true, true);
			}
			iLocal_60++;
			break;
		...
		case 2:
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_50, sLocal_74, sLocal_76, 3))
			{
				...
				ENTITY::SET_ENTITY_COORDS(iLocal_50, Var11, false, true, false, true);
				if (fVar9 == 0,161f)
				{
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_50, false);
					return 1;
...
void func_79()
{
	if (iLocal_72 == 0)
	{
		iLocal_72 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY(sLocal_73, iLocal_64[0], Local_78, Local_78, 1f, false, false, false);
...
int func_83(int iParam0)
{
	...
	{
		func_76(&iLocal_57);
		TASK::TASK_SMART_FLEE_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 9999f, -1, true, false);
		return 1;
	}
	return 0;
}
...
int func_95(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_133(Global_112915.f_24995.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_111962) || Global_31508) || func_129()) || func_128(8, -1)) || func_127()) || func_126()) || func_125()) || func_124()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_130()) || Global_31508) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_111962) || Global_31508) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_112915.f_7688.f_919[iVar0] == 5) || Global_43143 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_111962) || Global_31508) || func_129()) || func_128(8, -1)) || func_127()) || func_126()) || func_124()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_130() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_128(8, -1)) || func_124()) || func_123()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_130()) || Global_31508) || func_129()) || func_128(8, -1)) || func_126()) || func_125()) || func_124()) || Global_112915.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_130()) || func_126()) || Global_111962) || Global_31508) || func_129()) || Global_43774) || func_128(8, -1)) || func_125()) || func_123()) || func_124()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_130()) || Global_111962) || Global_31508) || func_129()) || func_128(8, -1)) || func_125()) || func_123()) || func_127()) || func_126()) || func_124())
						{
							return 0;
						}
						break;
...
void func_151(int iParam0)
{
	...
	if (func_162())
	{
		...
		func_154(30000);
		StringCopy(&cVar0, func_153(Global_112904, 1), 64);
		if (func_28(Global_112904) > 0)
		{
...
int func_162()
{
	if ((Global_112904 == func_29() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_112905)
	{
		return 1;
	}
	return 0;
