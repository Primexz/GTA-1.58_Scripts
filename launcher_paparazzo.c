...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112002[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_112002[Var0.f_0 /*10*/].f_9));
			}
		}
		func_270(&Var0, 1);
	}
	if (!func_267(&iVar64, &Var0, Var61, 5f))
	{
		func_266();
		func_283("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (!func_258(Var0.f_0))
	{
		func_266();
		func_283("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 47)
		{
			func_197(&Var0, Var61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0.f_0 == 51)
		{
			func_197(&Var0, Var61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_196(Var0.f_0);
		func_188(&iLocal_95, &(Var0.f_9), Var61);
		if (func_173(&Var0, 0))
		{
			if (func_172(Var0.f_0))
			{
				func_169(Var0.f_0, &iLocal_97);
			}
			if (!func_2(&Var0))
			{
				func_270(&Var0, 1);
...
int func_170(struct<3> Param0, bool bParam3)
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_171(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
void func_188(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_192(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_191(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_192(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_194(iParam0);
				}
			}
...
float func_192(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_200(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_198(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_199(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_199(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_201(var uParam0, bool bParam1)
{
	...
	if ((func_238(*uParam0) || func_236(*uParam0)) || Global_78097 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_204(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_204(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
void func_206(var uParam0)
{
	...
	if (*uParam0 == 52)
	{
		func_207(&(uParam0->f_41[1]));
		func_207(&(uParam0->f_41[2]));
	}
...
int func_209(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_210(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_211(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_230(*uParam0))
					{
						if (!func_158(*uParam0))
						{
							if (func_225(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_206(uParam0);
						...
						if (func_213(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_206(uParam0);
...
int func_213(int iParam0, float fParam1)
{
	...
	{
		if (func_224(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
{
	return func_215(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_215(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_223(iParam0, iParam1);
	if (!func_127(iParam0) || !func_127(iParam1))
	{
		if (iVar4 != -1)
		{
			func_222(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	if (!func_219(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar4 == -1)
	...
	uVar0 = func_216(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_216(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_219(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_221(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_221(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_220(Var3, Var0);
...
float func_220(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_221(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
int func_225(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_229(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_226(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_226(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_227(int iParam0, float fParam1)
{
	...
	{
		if (func_228(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_228(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_221(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_229(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
{
	if ((func_237() && Global_99974.f_11 == 6) && iParam0 == func_167(&(Global_99974.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_241(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (func_247(&(uParam0->f_28[0]), 50, -490,809f, 232,39f, 82,018f, 33,84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_245(&(uParam0->f_28[1]), iVar0[3], -498,1656f, 228,6284f, 82,09948f, 292,9763f, 26);
			...
			{
				func_245(&(uParam0->f_28[2]), iVar0[4], -498,309f, 227,9112f, 82,106f, 296,4216f, 26);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_243(&(uParam0->f_35[0]), iVar0[1], -497,99f, 224,97f, 82,67f, 266,5f);
				if (func_178(uParam0->f_35[0]))
				{
			...
			{
				func_243(&(uParam0->f_35[1]), iVar0[2], -501,55f, 230,7f, 83,1f, 233,93f);
				if (func_178(uParam0->f_35[1]))
				{
			...
			{
				func_242(&(uParam0->f_41[0]), iVar0[5], -490,11f, 233,15f, 82,1f, 0f);
				if (func_127(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[0], uParam0->f_28[0], PED::GET_PED_BONE_INDEX(uParam0->f_28[0], 57005), 0,1561f, -0,003f, -0,0344f, 202,8703f, -124,43f, -121,5398f, false, false, false, false, 2, true);
				}
				else
				{
					bVar11 = false;
			...
			{
				func_242(&(uParam0->f_41[1]), iVar0[6], -490,11f, 233,15f, 82,1f, 0f);
				if (func_127(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[1], PED::GET_PED_BONE_INDEX(uParam0->f_28[1], 57005), 0,1181f, 0,2229f, -0,1535f, 259,2501f, 24,08f, -51,2899f, false, false, false, false, 2, true);
				}
				else
				{
					bVar11 = false;
...
void func_242(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_207(iParam0);
...
void func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_244(iParam0);
...
void func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_246(iParam0);
...
int func_252(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			func_243(&(uParam0->f_35[0]), iVar0[0], 307,02f, 143,17f, 103,3f, 250,08f);
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_247(&(uParam0->f_28[0]), 50, -261f, 292,22f, 90,89f, 10,53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_126(uParam0->f_28[0]))
			{
				...
				{
					func_242(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2,5f), 0f);
					if (func_127(uParam0->f_41[3]))
					{
		...
		case 3:
			if (func_127(uParam0->f_41[0]))
			{
				iLocal_94 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uParam0->f_41[0], true), ENTITY::GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], iLocal_94, "idle_closed_pap_3_rcm_dumpster", sVar30, 8f, -8f, 0, 1000f);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
				if (func_127(uParam0->f_28[0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, sVar30, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1000f, 0);
				}
				if (func_127(uParam0->f_41[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], iLocal_94, "idle_closed_pap_3_rcm_lid_l", sVar30, 8f, -8f, 0, 1000f);
				}
				if (func_127(uParam0->f_41[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], iLocal_94, "idle_closed_pap_3_rcm_lid_r", sVar30, 8f, -8f, 0, 1000f);
				}
			}
			iVar31 = 0;
			while (iVar31 <= (iVar0 - 1))
...
int func_254(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_247(&(uParam0->f_28[0]), 50, -71,283f, 301,557f, 106,711f, 4,659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_126(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_242(&(uParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2,5f), 0f);
					if (func_127(uParam0->f_41[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_243(&(uParam0->f_35[0]), iVar0[1], -78,0873f, 299,0679f, 105,3972f, 249,8696f);
		...
		case 3:
			if (func_127(uParam0->f_28[0]) && func_127(PLAYER::PLAYER_PED_ID()))
			{
				TASK::TASK_LOOK_AT_ENTITY(uParam0->f_28[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				iLocal_94 = PED::CREATE_SYNCHRONIZED_SCENE(-71,283f, 301,557f, 106,711f, 0f, 0f, 4,659f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1000f, 0);
...
int func_255(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_250(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			func_256(46, 1);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_247(&(uParam0->f_28[0]), 50, -149,75f, 285,81f, 93,67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_243(&(uParam0->f_35[0]), iVar0[1], -159,56f, 275,41f, 93,14f, 102,75f);
				if (func_178(uParam0->f_35[0]))
				{
		...
		case 3:
			if (func_127(uParam0->f_28[0]))
			{
				if (STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo1beckon"))
				{
					...
					TASK::TASK_PLAY_ANIM(0, sVar7, "pap_idle_01", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sVar7, "pap_idle_action_01", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sVar7, "pap_idle_02", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sVar7, "pap_idle_action_02", 8f, -8f, -1, 0, 0f, false, false, false);
					TASK::SET_SEQUENCE_TO_REPEAT(iVar6, true);
					TASK::CLOSE_SEQUENCE_TASK(iVar6);
					TASK::TASK_PERFORM_SEQUENCE(uParam0->f_28[0], iVar6);
...
bool func_261(int iParam0, char* sParam1)
{
...
int func_267(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_268((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_268((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_268(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_269(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_269(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_270(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		...
		switch (*iParam0)
		{
			...
			case 47:
				...
				PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_96, false);
				func_272(iParam0, 0, 0, 0);
				break;
			...
			case 48:
				...
				func_207(&(iParam0->f_41[3]));
				func_272(iParam0, 1, 0, 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", true);
				break;
	...
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			func_283("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
