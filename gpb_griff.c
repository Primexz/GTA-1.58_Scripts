...
void func_9()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_448))
	{
		...
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_448);
	}
}
...
void func_24(char* sParam0)
{
	...
	if (iVar0 == 2)
	{
		StringCopy(sParam0, "convo_trevor_whatareyoudoing", 64);
	}
	else if (iVar0 == 0)
	{
		StringCopy(sParam0, "convo_michael_heyheymanthankgod", 64);
	}
	else if (iVar0 == 1)
	{
		StringCopy(sParam0, "convo_franklin_heywhatsuphomie", 64);
	}
}
...
{
	StringCopy(sParam1, "Special_Ped@griff", 32);
	switch (iParam0)
	{
		case 1:
			StringCopy(sParam2, "IAmNotARacist", 64);
			break;
		
		case 2:
			StringCopy(sParam2, "America_is_not", 64);
			break;
		
		case 3:
			StringCopy(sParam2, "America_is_for_the_americans", 64);
			break;
		
		case 4:
			StringCopy(sParam2, "this_is_the_land", 64);
			break;
		
		case 5:
			StringCopy(sParam2, "this_is_the_land_opportunity", 64);
			break;
		
		case 6:
			StringCopy(sParam2, "keep_america_clean", 64);
			break;
		
		case 7:
			StringCopy(sParam2, "e_pluribus_unum", 64);
			break;
		
		case 8:
			StringCopy(sParam2, "let_me_be_clear", 64);
			break;
	}
}
...
void func_104()
{
	PED::SET_PED_COMPONENT_VARIATION(iLocal_240, 1, 0, 0, 0);
	PED::SET_PED_COMPONENT_VARIATION(iLocal_240, 11, 0, 0, 0);
	PED::SET_PED_PROP_INDEX(iLocal_240, 1, 0, 0, false);
	PED::SET_PED_PROP_INDEX(iLocal_240, 0, 0, 0, false);
	iLocal_448 = OBJECT::CREATE_OBJECT(joaat("prop_cs_protest_sign_01"), ENTITY::GET_ENTITY_COORDS(iLocal_240, true), true, true, false);
...
void func_105()
{
	iLocal_36 = joaat("u_m_m_griff_01");
	StringCopy(&Local_234, "PBGR", 8);
	StringCopy(&Local_236, "GRIFF", 16);
	StringCopy(&Local_202, "Special_Ped@griff", 64);
	StringCopy(&Local_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBGR_INTERACT";
	StringCopy(&Local_312, "PBGR_CONV_GM", 16);
	StringCopy(&Local_316, "PBGR_CONV_GT", 16);
	StringCopy(&Local_320, "PBGR_CONV_GF", 16);
	StringCopy(&cLocal_324, "special_ped@griff@base", 64);
	StringCopy(&cLocal_340, "special_ped@griff@intro", 64);
	iLocal_251 = 4;
	iLocal_255[0] = 8;
	iLocal_255[1] = 7;
	iLocal_255[2] = 8;
