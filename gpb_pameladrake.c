...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_31769 + 10000 && !func_106())
	{
		func_113(0);
	}
	...
	iLocal_241 = 1;
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_240) && func_102(iLocal_240))
	{
	...
	while (iVar0 == 1)
	{
		...
		fVar43 = func_96(PLAYER::PLAYER_PED_ID(), iLocal_240);
		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			if ((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_240) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_240)) && fVar43 < 25f) && func_88(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_85(iLocal_240, PLAYER::PLAYER_PED_ID(), 1126825984, 0))
			{
				if (!func_89())
				{
					func_91();
		...
		if (func_84(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 25f)
		{
		...
		switch (iLocal_250)
		{
			...
			case 3:
				...
				if (func_84(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) < fVar40)
				{
					if (func_58() == 1)
					{
						iLocal_250 = 8;
			...
			case 8:
				...
				else if (iLocal_440 == 1)
				{
					...
					{
						func_52(Global_112860[iLocal_251], iLocal_297, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_240, &Local_372, &Local_356));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_61();
				bVar37 = func_62();
				func_51(Global_112860[iLocal_251]);
				if (!bVar37 && (!bVar36 || bLocal_437))
				{
					if (bLocal_507)
					{
						Global_112860[iLocal_251] = uLocal_506;
					}
					else
					{
		...
		if (((((((((((((iLocal_250 == 0 || iLocal_250 == 1) || iLocal_250 == 3) || iLocal_250 == 8) || iLocal_250 == 9) || iLocal_250 == 7) && func_84(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_436 == 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) && iVar30 == 0) && bLocal_439 == 1) && !Global_3) && func_7()) && bVar81)
		{
			if (iLocal_298 == -1)
			{
	...
	while (true)
	{
		...
		if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_240) && func_84(iLocal_240, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		{
			func_113(1);
		}
		SYSTEM::WAIT(0);
...
void func_1()
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_448) && !ENTITY::IS_ENTITY_DEAD(iLocal_448, false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_240, false))
	{
		if (!iLocal_449)
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_240, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), true) < 15f)
			{
				TASK::TASK_FLUSH_ROUTE();
				TASK::TASK_EXTEND_ROUTE(379,8408f, 152,3401f, 102,0718f);
				TASK::TASK_EXTEND_ROUTE(380,4872f, 158,653f, 102,1292f);
				TASK::TASK_EXTEND_ROUTE(388,7568f, 179,6577f, 102,1317f);
				TASK::TASK_FOLLOW_POINT_ROUTE(iLocal_448, 1f, 0);
				iLocal_449 = 1;
			}
		}
		else
		{
			...
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_448, true), 377,4565f, 154,6708f, 102,0838f, true) > 25f)
			{
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_448);
				iLocal_450 = 1;
			}
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_448, true), ENTITY::GET_ENTITY_COORDS(iLocal_240, true), true) < 3f && iLocal_451 == 0)
			{
				iLocal_451 = 1;
			}
		}
...
{
	func_9();
	if (func_102(iLocal_240) && func_102(PLAYER::PLAYER_PED_ID()))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_240, false);
...
void func_9()
{
	...
	{
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_240, 0f);
	}
}
...
void func_17()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_21(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_19(iVar0) && (!func_18(14) || Global_111866))
			{
...
void func_54()
{
	...
	func_57(Global_112860[iLocal_251] + 1, &sVar0, &Var8);
...
void func_57(int iParam0, char* sParam1, char* sParam2)
{
	...
	{
		case 1:
			StringCopy(sParam2, "pamela_ig_1_p1_letmetellyoumydarlings", 64);
			break;
		
		case 2:
			StringCopy(sParam2, "pamela_ig_1_p2_thingsweredifferent", 64);
			break;
		
		case 3:
			StringCopy(sParam2, "pamela_ig_1_p3_perhapsyouhaveseentheplay", 64);
			break;
		
		case 4:
			StringCopy(sParam2, "pamela_ig_1_p4_whathappenstothelonelyones", 64);
			break;
		
		case 5:
			StringCopy(sParam2, "IwasThatslut", 64);
			break;
		
		case 6:
			StringCopy(sParam2, "pamela_ig_1_p6_intheolddays", 64);
			break;
		
		case 7:
			StringCopy(sParam2, "pamela_ig_1_p7_ImJustAWiltedFlower", 64);
			break;
		
		case 8:
			StringCopy(sParam2, "pamela_ig_1_p8_WonderfulTimes", 64);
			break;
		
		case 9:
			StringCopy(sParam2, "vinewood_is_cruel", 64);
			break;
		
		case 10:
			StringCopy(sParam2, "you_dont_like_movies_you_dont_like_stars", 64);
			break;
		
		case 11:
			StringCopy(sParam2, "this_town_is_run_by_god_damn_accountants", 64);
			break;
		
		case 12:
			StringCopy(sParam2, "pamela_ig_1_p12_NoWonderThisPlaceIs", 64);
			break;
		
		case 13:
			StringCopy(sParam2, "pamela_ig_1_p13_TheWorldIsFor", 64);
			break;
		
		case 14:
			StringCopy(sParam2, "pamela_ig_1_p14_YourHereToSeeStars", 64);
			break;
	}
}
...
void func_97(int iParam0)
{
	...
	func_100(&(Global_112915.f_20117), iParam0);
...
void func_104()
{
	...
	iLocal_448 = PED::CREATE_PED(4, joaat("a_m_m_business_01"), 396,8498f, 143,3195f, 101,4659f, 360f, true, true);
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_448) && !ENTITY::IS_ENTITY_DEAD(iLocal_448, false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_240, false))
	{
		PED::SET_IK_TARGET(iLocal_448, 1, iLocal_240, 0, 0f, 0f, 0f, 0, -1, -1);
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_240, false))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_240, "MAG_2_PAM_PED_GROUP", 0f);
	}
}
...
{
	return func_111(Global_112915.f_20117, uParam0);
}
...
void func_113(int iParam0)
{
	...
	if (iLocal_241)
	{
		...
		if (MISC::ARE_STRINGS_EQUAL(&uVar0, &Local_502))
		{
			func_13();
		}
		if (iParam0 == 1)
