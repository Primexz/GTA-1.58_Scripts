...
int func_2()
{
	...
	fVar0 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_82);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
int func_6(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_7(Global_99695) && iParam1 != 0)
		{
			Global_99695 = 0;
		}
	}
...
void func_10()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_13(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_11(iVar0) && (!func_15(14) || Global_111866))
			{
...
void func_20()
{
	...
	while (iVar0 < iLocal_72)
	{
		if (iLocal_77[iVar0] != 0)
		{
			iLocal_72[iVar0] = PED::CREATE_PED(26, iLocal_77[iVar0], Local_82 + Local_86[iVar0 /*3*/], 0f, true, true);
			ENTITY::SET_ENTITY_ROTATION(iLocal_72[iVar0], Vector(uLocal_85, 0f, 0f) + Local_99[iVar0 /*3*/], 2, true);
	...
	while (iVar0 < iLocal_159)
	{
		if (iLocal_166[iVar0] > 0)
		{
			...
			fVar14 = 1f;
			fVar15 = -1f;
			iLocal_159[iVar0] = GRAPHICS::ADD_DECAL(iLocal_166[iVar0], Local_82 + Local_173[iVar0 /*3*/], Var3, Var6, fVar9, fVar10, fVar11, fVar12, fVar13, fVar14, fVar15, false, false, false);
			SYSTEM::WAIT(0);
		}
		iVar0++;
	}
...
void func_22()
{
	...
	func_26(iLocal_70, &Local_82, &uLocal_85, &cVar0);
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	switch (iLocal_70)
	{
		case 280:
			...
			Local_86[0 /*3*/] = { 14,613f, 8,4563f, 0,9751f };
			Local_86[1 /*3*/] = { 10,6489f, 8,6708f, 0,7701f };
			Local_86[2 /*3*/] = { 6,3982f, 1,4604f, 1,1f };
			Local_86[3 /*3*/] = { 4,2327f, 5,864f, (0,9f - 0,15f) };
			Local_99[0 /*3*/] = { 0f, 0f, 23,047f };
			Local_99[1 /*3*/] = { 0f, 0f, 97,2582f };
			Local_99[2 /*3*/] = { 0f, 0f, 34,2158f };
			Local_99[3 /*3*/] = { 0f, 0f, 61,2158f };
			...
			iLocal_166[2] = 1110;
			iLocal_166[3] = 1110;
			Local_173[0 /*3*/] = { Vector(0,37364f, -1445,534f, 2803,76f) - Local_82 + Vector(0,1f, 0f, 0f) };
			Local_173[1 /*3*/] = { Vector(0,28778f, -1444,863f, 2800,022f) - Local_82 + Vector(0,1f, 0f, 0f) };
			Local_173[2 /*3*/] = { Vector(0,6045f, -1452,404f, 2795,934f) - Local_82 + Vector(0,1f, 0f, 0f) };
			Local_173[3 /*3*/] = { Vector(0,28483f, -1448,033f, 2794,301f) - Local_82 + Vector(0,1f, 0f, 0f) };
			iLocal_166[4] = 1015;
			iLocal_166[5] = 1015;
			Local_173[4 /*3*/] = { Local_173[0 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0,5f, 0,5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0,5f, 0,5f)) };
			Local_173[5 /*3*/] = { Local_173[1 /*3*/] + Local_173[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0,5f, 0,5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0,5f, 0,5f)) };
			break;
		...
		default:
			...
			iLocal_77[0] = 0;
			Local_86[0 /*3*/] = { 0f, 0f, 0f };
			Local_99[0 /*3*/] = { 0f, 0f, 0f };
			iLocal_77[1] = 0;
			Local_86[1 /*3*/] = { 0f, 0f, 0f };
			Local_99[1 /*3*/] = { 0f, 0f, 0f };
			iLocal_77[2] = 0;
			Local_86[2 /*3*/] = { 0f, 0f, 0f };
			Local_99[2 /*3*/] = { 0f, 0f, 0f };
			iLocal_77[3] = 0;
			Local_86[3 /*3*/] = { 0f, 0f, 0f };
			Local_99[3 /*3*/] = { 0f, 0f, 0f };
			iLocal_158 = 0;
			iLocal_112[0] = -1;
			iLocal_112[1] = -1;
			iLocal_112[2] = -1;
	...
	switch (Param0.f_2)
	{
		...
		case 99:
			*uParam109 = { Param0 };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109, 15, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam109 = { Param0 };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_24(uParam109, 14, -982327190, 451360105, 0f, 0f, 0f, 0f);
			uParam109->f_118 = 2;
			return 1;
			break;
...
void func_24(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, float fParam7)
{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[0];
			StringCopy(sParam2, func_33(Global_112915.f_2363.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[1];
			StringCopy(sParam2, func_33(Global_112915.f_2363.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[2];
			StringCopy(sParam2, func_33(Global_112915.f_2363.f_539.f_2314[2]), 32);
			return 1;
			break;
