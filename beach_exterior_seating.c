...
void func_1(var uParam0)
{
	...
	if (((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
	{
		func_6(&(uParam0->f_6));
		func_4(uParam0, 1);
		if (uParam0->f_13 > 2)
...
void func_8(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_58(PLAYER::PLAYER_PED_ID(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_57(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				if (((((((((((func_56(uParam0) || func_52(uParam0)) || func_51(uParam0)) || !func_50(uParam0)) || func_48(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1946934.f_4, 2))
				{
					if (func_52(uParam0))
					{
						if (uParam0->f_6 == -1)
						{
							func_47(&(uParam0->f_6), 4, "POD_TOO_MANY", 0, 0, 0, 0);
						}
					}
					else
					{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						...
						{
							func_47(&(uParam0->f_6), 4, "MPJAC_SIT", 0, 0, 0, 0);
						}
					}
		...
		case 4:
			...
			Var20 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_39(uParam0), func_38(uParam0), 0f, 2) };
			Var23 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_39(uParam0), func_38(uParam0), 0f, 2) };
			fVar26 = Var23.f_2;
			fVar27 = 0,05f;
			...
			TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Var20, 1f, 20000, fVar26, fVar27);
			func_3(uParam0->f_9);
			func_2(uParam0, 5);
			break;
		...
		case 5:
			...
			Var29 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_39(uParam0), func_38(uParam0), 0f, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_25(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar32, 2f))
			{
				PAD::DISABLE_CONTROL_ACTION(0, 0, true);
				uParam0->f_8 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1,12f);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_8, &sVar0, &sVar16, 2f, -1000f, 9, 0, 1000f, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_8);
				uParam0->f_1 = MISC::GET_GAME_TIMER();
				func_24(&(uParam0->f_7), 8);
				func_2(uParam0, 6);
		...
		case 6:
			if (func_23(&(uParam0->f_7), 10) || func_22())
			{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar33))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar33) >= 1f)
				{
					...
					func_40(uParam0, &sVar16);
					uParam0->f_8 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1,12f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_8, &sVar0, &sVar16, 4f, -1,5f, 9, 0, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_8);
					func_24(&(uParam0->f_7), 8);
					func_24(&(uParam0->f_7), 11);
				}
				else
				{
		...
		case 8:
			...
			if (iVar35 == 0 || iVar35 == 1)
			{
				...
				{
					if ((PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar34) >= 0,7f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BREAKOUT_FINISH"))) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BREAK_OUT")))
					{
						NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
						func_3(-1);
						func_4(uParam0, 1);
...
int func_10(var uParam0)
{
	...
	iVar0 = (uParam0->f_1.f_2 + 1 % func_13(uParam0->f_1.f_1));
	if (func_11())
	{
		if (uParam0->f_1.f_1 == 1)
		{
...
bool func_11()
{
	return func_12(PLAYER::PLAYER_ID());
}
...
int func_14(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
...
void func_15(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_23(&(uParam0->f_7), 0)) && !func_23(&(uParam0->f_7), 4)) && !func_18()) && !func_16(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
					...
					{
						func_47(&(uParam0->f_6), 4, "MPOFSEAT_EXIT", 0, 0, 0, 0);
					}
				}
				if (uParam0->f_13 == 6)
				{
...
void func_20(var uParam0)
{
	...
	if (((func_10(uParam0) != uParam0->f_1.f_2 && uParam0->f_1.f_3 < 6) && uParam0->f_1.f_3 != 3) && uParam0->f_1.f_3 != 4)
	{
		func_9(uParam0, 1);
		func_41(uParam0, &sVar0);
		func_40(uParam0, &sVar16);
...
void func_42(int iParam0)
{
	...
	while (iVar0 < 3)
	{
		if (Global_2359296[func_43() /*5559*/].f_675.f_4239[iVar0 /*3*/] == iParam0)
		{
...
{
	uParam0->f_1.f_1 = func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13);
	uParam0->f_1.f_2 = func_45(uParam0);
	uParam0->f_1.f_3 = 3;
	uParam0->f_1.f_4 = 3;
}
...
int func_45(var uParam0)
{
	...
	switch (uParam0->f_1.f_1)
	{
		...
		default:
			iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, func_13(uParam0->f_1.f_1));
	}
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_11())
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
{
	return func_49(iParam0) == joaat("weapon_minigun");
}
...
{
	Stack.Push(!func_23(&(uParam0->f_7), 5));
...
int func_51(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar11]) && !PED::IS_PED_INJURED(uVar0[iVar11])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar11])) && func_58(uVar0[iVar11], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar11++;
...
int func_52(var uParam0)
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (iVar1 != PLAYER::PLAYER_ID() && func_55(iVar1, 1, 1))
			{
				if (func_58(PLAYER::GET_PLAYER_PED(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_53(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
int func_57(int iParam0, struct<3> Param1, int iParam4)
{
...
void func_63(var uParam0)
{
	...
	func_64(&(uParam0->f_7), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false));
	func_64(&(uParam0->f_7), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true));
	func_64(&(uParam0->f_7), 0, func_36(0));
...
{
	return func_23(&(Global_2689156[iParam0 /*453*/].f_435), 0);
}
...
void func_83()
{
	func_84(0, &uLocal_91, 0, 1);
	func_84(1, &uLocal_91, 1, 1);
	func_84(2, &uLocal_91, 2, 1);
	func_84(3, &uLocal_91, 3, 1);
	func_84(4, &uLocal_91, 4, 1);
	func_84(5, &uLocal_91, 5, 1);
	func_84(6, &uLocal_91, 6, 1);
	func_84(7, &uLocal_91, 7, 1);
	func_84(8, &uLocal_91, 8, 1);
	func_84(9, &uLocal_91, 9, 1);
	func_84(10, &uLocal_91, 10, 1);
	func_84(11, &uLocal_91, 11, 1);
	func_84(12, &uLocal_91, 12, 1);
	func_84(13, &uLocal_91, 13, 1);
	func_84(14, &uLocal_91, 14, 1);
	func_84(15, &uLocal_91, 15, 1);
	func_84(16, &uLocal_91, 16, 1);
	func_84(17, &uLocal_91, 17, 1);
	func_84(18, &uLocal_91, 18, 1);
	func_84(19, &uLocal_91, 19, 1);
	func_84(20, &uLocal_91, 20, 1);
}

void func_84(int iParam0, var uParam1, int iParam2, int iParam3)
{
	struct<3> Var0;
	float fVar3;
	
	func_86(iParam0, &Var0, &fVar3);
	uParam1->f_16[iParam2 /*14*/].f_13 = iParam3;
	uParam1->f_16[iParam2 /*14*/] = { Var0 };
	uParam1->f_16[iParam2 /*14*/].f_3 = { 0f, 0f, fVar3 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_85(-0,5f, -0,5f, 0f, fVar3) + Var0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_85(0,5f, -0,5f, 2f, fVar3) + Var0 };
...
void func_86(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		case 0:
