...
void __EntryFunction__()
{
	...
	while (iLocal_53)
	{
		...
		{
			func_36(&uLocal_113, &iLocal_114, &uLocal_117, &uLocal_118, Local_82, "v_franklinshouse");
			if (func_35(126))
			{
...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8)
{
	...
	while (iVar0 < 3)
	{
		...
		if (!func_31(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_97452[iVar0]))
			{
	...
	if (Global_94997 != 8)
	{
		if (Global_94998 == -1)
		{
			...
			if (func_7())
			{
				...
				{
					Global_94998 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
			else
...
void func_36(var uParam0, int* iParam1, var uParam2, var uParam3, struct<3> Param4, char* sParam7)
{
	int iVar0;
	struct<3> Var1;
	...
	if (INTERIOR::IS_VALID_INTERIOR(*uParam2) && INTERIOR::IS_INTERIOR_READY(*uParam2))
	{
		if (*uParam2 == *uParam3)
		{
			...
			{
				if (!Global_112915.f_18514.f_17)
				{
					func_37("FAM_WEAPDIS", -1);
					Global_112915.f_18514.f_17 = 1;
				}
				*uParam2 = INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
				if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam7))
				{
...
int func_45(int iParam0, struct<3> Param1, float fParam4)
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Param1, true) >= (100f * fParam4))
	{
		return 0;
	}
	if (Global_100024)
...
int func_46(int iParam0)
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_112905)
	{
		return 0;
	}
	if (!func_31(iParam0))
	...
	if (!MISC::IS_BIT_SET(Global_112915.f_9085.f_2[27 /*3*/], 1))
	{
		return 0;
	}
	return 1;
...
{
	return func_50(iParam0, Global_42596);
}
...
void func_54()
{
	...
	while (iVar0 < 1)
	{
		...
		if (iVar1 < 15)
		{
			if (Global_94980[iVar1] != 141)
			{
				func_58(iVar1);
				Global_94980[iVar1] = 141;
			}
			func_55(iVar1);
		}
		iVar0++;
...
void func_65(int iParam0)
{
	...
	while (iVar15 < Global_112915.f_7688.f_198)
	{
		...
		{
			func_66(Global_112915.f_7688.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_66(int iParam0)
{
	...
	{
		if (func_72(iParam0, Global_19954) == 1)
		{
			func_71(iParam0, Global_19954, 0);
			if (func_70(iParam0, Global_19954) == 0)
			{
				iVar0 = Global_19954;
...
{
	Global_31566[iParam0 /*11*/].f_10 = iParam1;
}
...
int func_78()
{
	...
	while (iVar23 < 11)
	{
		...
		{
			iVar24 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var1, 10f, iVar0, false, false, true);
			if (ENTITY::DOES_ENTITY_EXIST(iVar24))
			{
				if (iVar5 == 825812850)
				{
					ENTITY::SET_ENTITY_ROTATION(iVar24, 0f, 0f, 21f, 2, true);
				}
		...
		else if (!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iVar5))
		{
		}
		else
		{
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iVar5, 3, true, true);
			OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(iVar5, 0f, true, true);
			if (((iVar23 != 6 && iVar23 != 7) && iVar23 != 8) && iVar23 != 9)
			{
				OBJECT::REMOVE_DOOR_FROM_SYSTEM(iVar5, 0);
			}
		}
		iVar23++;
	}
...
int func_86(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_87() || MISC::GET_MISSION_FLAG())
	{
