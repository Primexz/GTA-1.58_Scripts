	...
	switch (iLocal_327)
	{
		...
		case 1:
			...
			if (func_206(Local_98.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
			{
				...
				{
					if (!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true))
					{
						PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, true);
						TASK::TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
					}
				}
				else
				{
					TASK::TASK_WANDER_STANDARD(Local_98.f_28[1], 40000f, 0);
				}
			}
...
void func_4(int iParam0, bool bParam1)
{
	...
	{
		func_172(&(Global_112002[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_8()
{
	...
	{
		func_10(13, SYSTEM::FLOOR(Global_112915.f_10194.f_3853));
	}
...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	Global_77663[1 /*14*/] = { func_84(iVar0, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_77663[1 /*14*/] = { func_84(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_76(iParam1), Global_77663[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, 0);
		}
	}
...
int func_34(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_149(iParam0, Global_112915.f_2363.f_539[iVar0 /*65*/].f_64, Global_112915.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_77663[1 /*14*/] = { func_84(iVar10, iParam1, iParam2, -1) };
		if (!func_74(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_77663[1 /*14*/] = { func_84(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77663[1 /*14*/] = { func_84(iVar10, 14, uVar28[iVar1], -1) };
							func_52(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
							func_67(14);
							if (Global_77661 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_77661 == 1)
						{
			...
			{
				Global_77663[1 /*14*/] = { func_84(iVar10, iVar0, func_42(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77663[1 /*14*/] = { func_84(iVar10, 14, uVar69[iVar1], -1) };
			func_52(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
			func_67(14);
			if (Global_77661 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, iParam4);
		}
		if (Global_77661 == 1)
		{
			iVar2 = 0;
...
{
	Global_77663[1 /*14*/] = { func_84(iParam0, iParam1, iParam2, -1) };
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar36 = (iParam1 - func_55(iParam0, func_76(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
...
void func_67(int iParam0)
{
	...
	{
		func_73(iParam0, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 2, Global_77663[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_149(iParam0, Global_112915.f_2363.f_539[iVar0 /*65*/].f_61, Global_112915.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_83(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[0], Global_112915.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_83(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[1], Global_112915.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_83(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[2], Global_112915.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_86(int iParam0)
{
	...
	func_87(&(Global_77663[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_71(func_90(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_71(func_89(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_71(iVar1, Global_77660, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_87(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_87(&(Global_77663[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_87(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			func_87(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_149(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_149(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_149(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_77663[2 /*14*/] = { func_84(iVar0, 14, iVar4, -1) };
									if (Global_77663[2 /*14*/].f_12 == iVar3)
									{
										if (func_149(iParam0, 14, iVar4))
										{
											if (!func_40(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77663[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_77663[2 /*14*/] = { func_84(iVar0, iVar2, iVar1, -1) };
						if (!func_40(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77663[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77663[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_76(iParam1)) && Global_77663[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_156()
{
	...
	{
		if (func_151(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_150(PLAYER::PLAYER_PED_ID());
			if (func_153(iVar0) && (!func_92(14) || Global_111866))
			{
				if (Global_112915.f_2363.f_539.f_4321 != iVar0 && func_153(Global_112915.f_2363.f_539.f_4321))
				{
...
void func_161(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_162(&sVar32, Var0.f_3, Global_100011, bParam1, bParam2);
	}
}
...
void func_167()
{
	...
	{
		func_156();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_168(Global_112915.f_2363.f_539.f_4321));
	}
	else
	{
...
{
	func_177(iParam0, 1);
	Global_112915.f_18574[iParam0 /*6*/].f_3 = func_176();
	...
	if ((func_206(Local_98.f_28[0]) && func_215(Local_98.f_35[0])) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
	{
		if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
		{
			if (TASK::GET_VEHICLE_WAYPOINT_PROGRESS(Local_98.f_35[0]) >= iLocal_482)
			{
				if (bLocal_407)
				{
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[0], Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 15f, 786468, 100f, 1f, true);
				}
				else
				{
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[0], Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 40f, 786468, 100f, 1f, true);
				}
			}
		}
	}
		...
		if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[1]))
		{
			if (TASK::GET_VEHICLE_WAYPOINT_PROGRESS(Local_98.f_35[1]) >= iLocal_483)
			{
				if (func_206(Local_98.f_28[0]))
				{
					if (bLocal_407)
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[1], Local_98.f_35[1], Local_98.f_28[0], 7, 15f, 786468, 100f, 1f, true);
					}
					else
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_98.f_28[1], Local_98.f_35[1], Local_98.f_28[0], 7, 40f, 786468, 100f, 1f, true);
					}
				}
				else
				{
...
void func_216()
{
	if ((iLocal_465 && func_206(Local_98.f_28[2])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		...
		{
			if ((!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], true) || (func_215(Local_98.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1], true))) || (func_215(Local_98.f_35[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], true)))
			{
				func_217(1);
				...
				TASK::TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 100f, -1, false, false);
			}
		}
	}
}
...
void func_217(bool bParam0)
{
	if (bParam0)
	{
		PATHFIND::SET_PED_PATHS_IN_AREA(Local_467, Local_470, true, 0);
	}
	else
	{
		PATHFIND::SET_PED_PATHS_IN_AREA(Local_467, Local_470, false, 0);
	}
}
...
void func_219()
{
	...
	{
		if ((((((!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true)) && !TASK::IS_PED_GETTING_UP(Local_98.f_28[1])) && !PED::IS_PED_PRONE(Local_98.f_28[1])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[1])) && !func_218(Local_98.f_28[1], 63541484)) && !func_218(Local_98.f_28[1], 242628503))
		{
			func_217(1);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, true);
			TASK::TASK_SMART_FLEE_PED(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
	...
	if (func_206(Local_98.f_28[1]) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 3))
		{
			if (PED::IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[1]))
			{
				...
				{
					ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[1], -4f, true);
			...
			else if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true))
			{
				AUDIO::STOP_SOUND(iLocal_488);
...
void func_231()
{
	...
	{
		if (((((((iLocal_344 < 4 && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !func_248()) && MISC::GET_GAME_TIMER() > iLocal_345) && func_226(Local_98.f_28[1], PLAYER::PLAYER_PED_ID()) < 10f) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true)) && !PED::IS_PED_FLEEING(Local_98.f_28[1]))
		{
...
int func_249()
{
	...
	{
		if (PED::IS_PED_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], false))
		{
			if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_98.f_35[0]))
			{
		...
		else if (!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], false))
		{
			if (!func_248())
			{
				iLocal_461 = 0;
...
bool func_256(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_257(&(Local_52[iVar4 /*4*/]), Var1, iParam1, &(Local_52[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_52[iVar4 /*4*/].f_3) < iParam4);
}

int func_257(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_260(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_262(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_262(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_261(Var3, Var0);
...
Vector3 func_262(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
int func_270(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_262(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_271(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_273()
{
	...
	{
		if (PED::IS_PED_IN_VEHICLE(Local_98.f_28[1], Local_98.f_35[1], false))
		{
			TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_98.f_28[1], Local_98.f_35[1], sLocal_481, 786597, 0, 8, -1, -1f, false, 2f);
		}
	}
}
...
void func_274()
{
	if ((func_215(Local_98.f_35[1]) && (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[1], PLAYER::PLAYER_PED_ID(), true))) && !bLocal_388)
	{
		...
		if (func_206(Local_98.f_28[0]))
		{
			if ((!PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0) && !PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0])) && !PED::IS_PED_FLEEING(Local_98.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
				{
					...
					TASK::TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
					func_224(&(Local_98.f_41[0]), 0);
				}
				else
				{
	...
	if (((func_206(Local_98.f_28[0]) && func_206(PLAYER::PLAYER_PED_ID())) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_FLEEING(Local_98.f_28[0]))
	{
		if (func_215(Local_98.f_35[0]))
		{
			if (iLocal_326 == 2)
			{
				if (iLocal_436 == 0)
				{
					if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], false) || PED::IS_PED_BEING_JACKED(Local_98.f_28[0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true)) || func_282(Local_98.f_35[0]))
					{
						iLocal_436 = 1;
						iLocal_326 = 2;
					}
			...
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true))
				{
					func_276();
				}
			}
...
void func_276()
{
	if (func_206(Local_98.f_28[0]))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], true))
		{
			if ((((!bLocal_386 && iLocal_385) && !func_277(Local_98.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
			{
				...
				func_224(&(Local_98.f_41[0]), 0);
				iLocal_389 = 1;
				TASK::TASK_SMART_FLEE_PED(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), 400f, -1, true, false);
				func_220();
				iLocal_460 = 3;
				iLocal_385 = 0;
				bLocal_386 = true;
...
void func_278()
{
	...
	switch (iLocal_436)
	{
		case 1:
			...
			bVar0 = false;
			func_220();
			if ((func_215(Local_98.f_35[0]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true)) && func_272(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 5f, 1))
			{
				bVar0 = func_250(&uLocal_160, "PAP4AUD", "PAP4_CARSHOT", 7, 0, 0, 0);
			}
			else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], false) || func_282(Local_98.f_35[0]))
			{
			...
			if (bVar0)
			{
				...
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], false))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_438, 2f, 20000, 0,25f, false, 40000f);
				}
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], false))
					{
				...
				if ((((func_206(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true))
					{
						TASK::TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
					}
					else if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], false))
					{
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_437)
			{
				if ((func_206(Local_98.f_28[0]) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && iLocal_385)
				{
					...
					if ((((func_206(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
					{
						...
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_441, 2f, 20000, 0,25f, false, 40000f);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
				...
				else if (iLocal_385 == 0 && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], true))
				{
		...
		case 3:
			if (func_226(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0]) > 20f)
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_438, 1f, 20000, 0,25f, false, 40000f);
...
void func_279()
{
	...
	{
		if (iLocal_445 || !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[0], false))
		{
			func_280();
		}
...
int func_282(int iParam0)
{
	...
	if ((func_206(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && func_215(iParam0))
	{
		...
		case 0:
			if (func_206(Local_98.f_28[0]) && func_206(Local_98.f_28[1]))
			{
				if (func_250(&uLocal_160, "PAP4AUD", "PAP4_TV_TALK", 7, 0, 0, 0))
				{
					...
					PED::SET_PED_DIES_WHEN_INJURED(Local_98.f_28[0], true);
					iLocal_372 = 0;
					iLocal_344 = 0;
					bLocal_407 = true;
					bLocal_408 = true;
...
void func_285()
{
	...
	{
		Var0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_98.f_28[0], 3f, 0f, 0f) };
		Var3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_98.f_28[0], -3f, 0f, 0f) };
		fVar6 = func_286(PLAYER::PLAYER_PED_ID(), Var0, 1);
		fVar7 = func_286(PLAYER::PLAYER_PED_ID(), Var3, 1);
		if (fVar6 < fVar7)
		{
			Var8 = { Var3 };
		}
		...
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var8, 3f, 20000, 0,25f, false, 40000f);
...
float func_286(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_287()
{
	...
	{
		if ((((((!TASK::IS_PED_GETTING_UP(Local_98.f_28[0]) && !PED::IS_PED_PRONE(Local_98.f_28[0])) && !PED::IS_PED_RAGDOLL(Local_98.f_28[0])) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], true)) && !func_218(Local_98.f_28[0], -1794415470)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) || PED::IS_PED_BEING_STEALTH_KILLED(Local_98.f_28[0]))
		{
			if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_377))
			{
				TASK::TASK_PLAY_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 4f, -8f, -1, 57, 0f, false, false, false);
			}
		}
		else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
		{
...
int func_290()
{
	...
	Var0 = { ENTITY::GET_ENTITY_COORDS(Local_98.f_28[0], true) + Vector(1f, 0f, 0f) };
	Var3 = { ENTITY::GET_ENTITY_COORDS(Local_98.f_28[1], true) - Vector(1f, 0f, 0f) };
...
void func_291(bool bParam0)
{
	...
	if (bLocal_391)
	{
		if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_390))
		{
			iLocal_390 = PED::CREATE_SYNCHRONIZED_SCENE(Local_401, Local_404, 2);
			PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_390, false);
			PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_390, false);
			...
			if (func_206(Local_98.f_28[0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], iLocal_390, sLocal_377, sVar1, fVar4, -4f, 1, 16, 1000f, 0);
			}
			if (func_206(Local_98.f_28[1]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], iLocal_390, sLocal_377, sVar2, 1000f, -2f, 1, 16, 1000f, 0);
			}
			if (func_206(Local_98.f_28[2]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], iLocal_390, sLocal_377, sVar3, fVar4, -4f, 1, 16, 1000f, 0);
			}
		}
	}
	else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_390))
	{
		ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[0], -4f, true);
		ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[1], -2f, true);
		...
		{
			TASK::TASK_PLAY_ANIM(Local_98.f_28[1], sLocal_377, sLocal_393, 1000f, -8f, -1, 57, 0f, false, false, false);
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_98.f_28[1], false, false);
		}
		ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_98.f_28[2], -4f, true);
		PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_390, 1f);
	}
}
...
void func_293()
{
	...
	if (func_206(PLAYER::PLAYER_PED_ID()))
	{
		if (bLocal_407)
		{
			if ((((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) && func_301()) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_484, fLocal_487)) || !func_206(Local_98.f_28[1])) || !func_206(Local_98.f_28[2]))
			{
				iLocal_461 = 1;
				iLocal_460 = 3;
				iLocal_436 = 5;
			...
			else if ((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), true)) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("object"))
			{
				func_276();
				iLocal_461 = 1;
				iLocal_460 = 3;
			...
			else if (((((func_254(Local_98.f_28[0], 1126825984) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), true)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), true)) || iLocal_387) && (func_298(PLAYER::PLAYER_PED_ID()) == joaat("weapon_unarmed") || func_298(PLAYER::PLAYER_PED_ID()) == joaat("object")))
			{
		...
		else
		{
			...
			else if ((func_206(Local_98.f_28[0]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && (((((((ENTITY::GET_ENTITY_HEALTH(Local_98.f_28[0]) < 150 || (func_267(Local_98.f_28[0], 0, 0, 0, 0) && func_301())) || (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[0], PLAYER::PLAYER_PED_ID(), true) && func_298(PLAYER::PLAYER_PED_ID()) == joaat("weapon_stungun"))) || !func_272(PLAYER::PLAYER_PED_ID(), Local_98.f_28[0], 20f, 1)) || (func_206(Local_98.f_28[1]) && PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0))) || (func_206(Local_98.f_28[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true))) || (func_206(Local_98.f_28[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), true))) || iLocal_384))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_98.f_28[0], sLocal_377, sLocal_378, 3))
				{
					iLocal_384 = 1;
				...
				switch (iLocal_383)
				{
					case 0:
						...
						{
							TASK::TASK_PLAY_ANIM(Local_98.f_28[0], sLocal_379, "flinch_additive_a", 4f, -8f, -1, 272, 0f, false, false, false);
						}
					...
					case 1:
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], false))
						{
							func_224(&(Local_98.f_41[0]), 0);
							iLocal_385 = 0;
							if (!PED::IS_PED_FLEEING(Local_98.f_28[0]))
		...
		if (func_206(Local_98.f_28[1]))
		{
			if (((((((((func_267(Local_98.f_28[1], 0, 0, 0, 0) && func_301()) || ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_28[1], PLAYER::PLAYER_PED_ID(), true) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || ((func_254(Local_98.f_28[1], 1126825984) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("weapon_unarmed")) && func_298(PLAYER::PLAYER_PED_ID()) != joaat("object"))) || !func_215(Local_98.f_35[1])) || PED::IS_PED_RAGDOLL(Local_98.f_28[1])) || func_295(Local_98.f_28[1])) || func_277(Local_98.f_28[0])) || func_277(Local_98.f_28[2])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_484, fLocal_487))
			{
				if (!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], false))
				{
					if (func_248())
					{
						Var28 = { func_300() };
...
void func_297()
{
	if (func_206(Local_98.f_28[0]))
	{
		if ((((((!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], true) && iLocal_385) && !bLocal_386) && !func_277(Local_98.f_28[0])) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[0])) && !PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID())) && iLocal_436 == 0)
		{
			if (PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0) || PED::IS_PED_IN_MELEE_COMBAT(Local_98.f_28[0]))
			{
				TASK::CLEAR_PED_TASKS(Local_98.f_28[0]);
...
int func_303()
{
	...
	if (!bVar0 && !bVar1)
	{
		...
		{
			TASK::TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
		}
		return 1;
	}
	return 0;
...
void func_304()
{
	if (func_206(Local_98.f_28[0]))
	{
		if (func_215(Local_98.f_35[0]) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_480))
		{
			...
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_473, Local_476, fLocal_479, false, true, true);
				TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_98.f_28[0], Local_98.f_35[0], sLocal_480, 786597, 0, 8, -1, -1f, false, 2f);
				if (HUD::DOES_BLIP_EXIST(iLocal_159))
				{
			...
			else if (PED::IS_PED_IN_VEHICLE(Local_98.f_28[0], Local_98.f_35[0], true))
			{
...
void func_305(bool bParam0, bool bParam1)
{
	...
	if ((((((func_215(Local_98.f_35[0]) && func_206(Local_98.f_28[0])) && bLocal_407) && iLocal_385) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[0], 0)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) && !iLocal_389)
	{
		...
		{
			if (((((iLocal_461 && !func_218(Local_98.f_28[0], -1794415470)) && !func_218(Local_98.f_28[0], 355471868)) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[0], -1, false)) && !PED::IS_PED_FLEEING(Local_98.f_28[0])) && !iLocal_389)
			{
				if (!func_303() && !func_249())
				{
					...
					if (bVar0 || bParam0)
					{
						...
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_98.f_28[0], false, false);
						if (bParam1)
						{
						...
						if ((((func_206(Local_98.f_28[2]) && !PED::IS_PED_FLEEING(Local_98.f_28[2])) && !iLocal_387) && !iLocal_465) && !PED::IS_PED_RAGDOLL(Local_98.f_28[2]))
						{
							if (bParam0 || (func_215(Local_98.f_35[1]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_98.f_35[1], true)))
							{
								if (ENTITY::DOES_ENTITY_EXIST(Local_98.f_35[0]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_98.f_35[0], PLAYER::PLAYER_PED_ID(), true))
								{
									TASK::TASK_SMART_FLEE_PED(Local_98.f_28[2], PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
								}
								else if (func_215(Local_98.f_35[0]))
								{
									...
									TASK::TASK_ENTER_VEHICLE(0, Local_98.f_35[0], 20000, 0, 2f, 1, 0);
									TASK::CLOSE_SEQUENCE_TASK(iVar2);
									TASK::TASK_PERFORM_SEQUENCE(Local_98.f_28[2], iVar2);
									TASK::CLEAR_SEQUENCE_TASK(&iVar2);
								}
							...
							else if (func_215(Local_98.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[1], 0, false))
							{
...
void func_306()
{
	...
	if (func_206(Local_98.f_28[1]))
	{
		if ((((!func_218(Local_98.f_28[1], 242628503) && !PED::IS_PED_FLEEING(Local_98.f_28[1])) && !PED::IS_PED_IN_COMBAT(Local_98.f_28[1], 0)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_481)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], false))
		{
			...
			if (func_215(Local_98.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_98.f_35[1], -1, false))
			{
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_473, Local_476, fLocal_479, false, true, true);
	...
	switch (iLocal_327)
	{
		case 0:
			...
			if (MISC::GET_GAME_TIMER() > iLocal_358)
			{
				...
				if (func_345(1, 1093140480, 0))
				{
					if (func_206(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_359, Local_362, fLocal_365, false, true, 0))
						{
							iLocal_366 = 1;
						}
					...
					{
						ENTITY::DETACH_ENTITY(Local_98.f_41[0], false, true);
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_98.f_41[0], "Beverlys_camera", 0, 0, 0);
					}
					if (ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
					{
						ENTITY::DETACH_ENTITY(Local_98.f_41[1], false, true);
					...
					if (func_215(Local_98.f_35[0]))
					{
						func_342(Local_98.f_35[0], Local_421, fLocal_430, 0, 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_98.f_35[0], 5f);
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_98.f_35[0], 1);
					}
					if (func_215(Local_98.f_35[1]))
					{
						func_342(Local_98.f_35[1], Local_424, fLocal_431, 0, 1);
						VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_98.f_35[1], 5f);
						VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_98.f_35[1], 1);
					}
					func_334(Local_328, Local_331, fLocal_334, -500,71f, 241,83f, 82,46f, 262,59f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			if ((((func_206(Local_98.f_28[0]) && func_206(Local_98.f_28[1])) && func_206(Local_98.f_28[2])) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[0])) && ENTITY::DOES_ENTITY_EXIST(Local_98.f_41[1]))
			{
				...
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_98.f_41[0], Local_98.f_28[0], PED::GET_PED_BONE_INDEX(Local_98.f_28[0], 28422), Local_346, Local_349, false, false, false, false, 2, true);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_98.f_41[1], Local_98.f_28[1], PED::GET_PED_BONE_INDEX(Local_98.f_28[1], 57005), Local_352, Local_355, false, false, false, false, 2, true);
					func_319();
				}
			}
...
void func_311(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_317(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_319()
{
	...
	if (func_206(Local_98.f_28[0]))
	{
		TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[0], iLocal_390, sLocal_377, sLocal_392, 1000f, -4f, 1, 16, 1000f, 0);
	}
	if (func_206(Local_98.f_28[1]))
	{
		TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[1], iLocal_390, sLocal_377, sLocal_393, 1000f, -4f, 1, 16, 1000f, 0);
	}
	if (func_206(Local_98.f_28[2]))
	{
		TASK::TASK_SYNCHRONIZED_SCENE(Local_98.f_28[2], iLocal_390, sLocal_377, sLocal_394, 1000f, -4f, 1, 16, 1000f, 0);
	}
	bLocal_391 = true;
}
...
void func_321()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_322(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10,5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_322(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_331(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
void func_333(bool bParam0)
{
	...
	func_311(1, 1, 0, 0, 0, 0, 0);
}

void func_334(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_335(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_335(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_342(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_345(int iParam0, float fParam1, int iParam2)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_322(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
void func_348()
{
	switch (iLocal_327)
	{
		...
		case 2:
			if (func_396())
			{
				func_359(Local_432, fLocal_435, 1, 0);
				func_349();
			}
			else
			{
				...
				{
					CAM::SET_GAMEPLAY_ENTITY_HINT(Local_98.f_28[0], 0f, 0f, 0f, true, -1, 3000, 2000, 0);
...
void func_349()
{
	...
	if (func_206(Local_98.f_28[1]))
	{
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(Local_98.f_28[1], Local_415, false, false, true);
		ENTITY::SET_ENTITY_HEADING(Local_98.f_28[1], fLocal_428);
	}
	if (func_206(PLAYER::PLAYER_PED_ID()) && !func_356())
	{
		func_354(PLAYER::PLAYER_PED_ID(), Local_432);
	...
	MISC::CLEAR_AREA_OF_VEHICLES(Local_412, 50f, false, false, false, false, false, false, 0);
	func_319();
	if (func_356())
	{
		func_353(0, -1, 1);
...
void func_351(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
Vector3 func_354(int iParam0, struct<3> Param1)
{
	var uVar0;
...
void func_359(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_396())
	{
...
void func_362(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_364(Global_78107, Global_78109, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
{
	if (((!func_375(0) || Global_78121) || Global_78110 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78106)
...
{
	return func_377(iParam0, Global_42596);
}
		...
		if (bParam2)
		{
			if (!Global_77852)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_380(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_380(iParam0) };
...
void func_387(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_223(iParam0);
...
void func_388(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_389(iParam0);
...
void func_390(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_391(iParam0);
...
int func_392(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_393(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_393(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_407()
{
	...
	if (func_206(Local_98.f_28[0]))
	{
		...
		if (!PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[0], false))
		{
			TASK::TASK_WANDER_STANDARD(Local_98.f_28[0], 40000f, 0);
		}
	}
	if (func_206(Local_98.f_28[1]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[1]))
	{
		if (func_206(PLAYER::PLAYER_PED_ID()))
		{
			...
			else if (!PED::IS_PED_FLEEING(Local_98.f_28[1]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[1], true))
			{
				func_294();
				PED::SET_PED_FLEE_ATTRIBUTES(Local_98.f_28[1], 128, true);
	...
	if (func_206(Local_98.f_28[2]) && !FIRE::IS_ENTITY_ON_FIRE(Local_98.f_28[2]))
	{
		...
		if (func_206(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_98.f_28[2], true))
			{
				iVar0 = PED::GET_VEHICLE_PED_IS_IN(Local_98.f_28[2], true);
				if (func_215(iVar0) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, true) || !func_206(Local_98.f_28[0])))
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar1);
		...
		{
			TASK::TASK_WANDER_STANDARD(Local_98.f_28[2], 40000f, 0);
		}
	}
	PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(Local_473, Local_476, fLocal_479, 1);
	func_210();
}
...
void func_408(var uParam0, int iParam1, int iParam2)
{
	...
	{
		TASK::TASK_PLAY_ANIM(0, sLocal_380, sLocal_382, 8f, -8f, -1, 8192, 0f, false, false, false);
		iLocal_466 = 0;
	}
	TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, false, false);
	TASK::CLOSE_SEQUENCE_TASK(iVar0);
...
int func_414()
{
	...
	iVar0 = func_415(&(Global_99974.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_418()
{
	...
	{
		if (func_413(&(Global_99974.f_3)) > -1)
		{
			return 1;
		}
	}
