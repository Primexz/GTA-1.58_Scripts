...
void func_9()
{
	...
	{
		PED::SET_PED_MOVEMENT_CLIPSET(iLocal_240, sLocal_448, 0,25f);
	}
}
...
void func_104()
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_448);
	while (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_448))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_449 = 1;
...
void func_105()
{
	...
	StringCopy(&Local_234, "PBJA", 8);
	StringCopy(&Local_236, "JANE", 16);
	StringCopy(&Local_202, "Special_Ped@jane", 64);
	StringCopy(&Local_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 7;
	sLocal_303 = "PBJA_INTERACT";
	StringCopy(&Local_312, "PBJA_CONV_GM", 16);
	StringCopy(&Local_316, "PBJA_CONV_GT", 16);
	StringCopy(&Local_320, "PBJA_CONV_GF", 16);
	StringCopy(&cLocal_324, "special_ped@jane@base", 64);
	StringCopy(&cLocal_340, "special_ped@jane@intro", 64);
	sLocal_448 = "move_f@hurry@b";
	iLocal_251 = 5;
	iLocal_255[0] = 5;
	iLocal_255[1] = 4;
	iLocal_255[2] = 5;
...
void func_118()
{
	if (iLocal_449 == 1)
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_448))
		{
			STREAMING::REMOVE_ANIM_DICT(sLocal_448);
		}
	}
}
