...
int func_2()
{
	...
	{
		if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(iLocal_87))
		{
			Var0 = { Vector(32,856f, 3819,65f, 1971,62f) - Local_83 };
			iLocal_87 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_90, Local_83 + Var0, 0f, 0f, 0f, 1f, false, false, false, false);
		}
	}
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sLocal_143, &cLocal_159, 2))
		{
			fVar3 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_97304);
			switch (iLocal_224)
			{
				case 0:
					if (fLocal_141 < 0f)
					...
					if (fVar3 > fLocal_141)
					{
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_72) || iLocal_89 != -1)
						{
							if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(&cLocal_106, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_89, 1f, false, false, false))
							{
								if (MISC::ARE_STRINGS_EQUAL(&cLocal_106, "scr_meth_pipe_smoke"))
								{
									func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0);
								}
								iLocal_223 = AUDIO::GET_SOUND_ID();
								AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_223, &cLocal_207, PLAYER::PLAYER_PED_ID(), &cLocal_191, false, 0);
								iLocal_224++;
							}
						}
						else if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&cLocal_106, iLocal_72, 0f, 0f, -1f, 0f, 0f, 0f, 1f, false, false, false))
						{
							if (MISC::ARE_STRINGS_EQUAL(&cLocal_106, "scr_meth_pipe_smoke"))
							{
								func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0);
				...
				case 2:
					...
					{
						if (GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(&cLocal_122, Local_83 + Local_138, 0f, 0f, 0f, 1f, false, false, false))
						{
							iLocal_224++;
						}
					}
			...
			{
				if (ENTITY::IS_ENTITY_ATTACHED(iLocal_72))
				{
					if (iLocal_82 != -1)
					{
						if (fVar3 > fLocal_81)
						{
							func_3(&iLocal_72, iLocal_82);
						}
					}
				}
			}
		...
		else
		{
			if (iLocal_88 != 0)
			{
				GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_88, false);
				iLocal_88 = 0;
				AUDIO::STOP_SOUND(iLocal_223);
				AUDIO::RELEASE_SOUND_ID(iLocal_223);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_72))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(iLocal_72))
	...
	switch (iParam1)
	{
		...
		case 9:
			...
			*iParam0 = OBJECT::CREATE_OBJECT(iVar34, Var27, true, true, false);
			...
			if (func_6(iVar0, &sVar35, &cVar51, &iVar67))
			{
				if (func_4(iVar0, &sVar68, &cVar84, &cVar100, &uVar116, &uVar117))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &sVar68, &sVar35, 2))
					{
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_97304, &sVar35, &sVar68, 1000f, -8f, iVar67, 1000f);
					}
				}
			}
...
void func_17(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (!func_34(iParam0))
	{
		...
		func_29(iVar0, iVar0, 0,3f, func_30(), iParam1, 0);
	...
	Global_43747 = 0,25f;
	StringCopy(&Global_43748, func_23(iParam3), 16);
	...
	func_18(1, iVar5, 4, iParam0, iParam2);
}
...
void func_29(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
int func_37()
{
	if (!iLocal_73 == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_72))
		{
			...
			{
				iLocal_72 = OBJECT::CREATE_OBJECT(iLocal_73, Local_83, true, true, false);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_80), Local_74, Local_77, false, false, false, false, 2, true);
			}
			else
			{
				iLocal_72 = OBJECT::CREATE_OBJECT(iLocal_73, Local_83 + Local_74, true, true, false);
				ENTITY::SET_ENTITY_COORDS(iLocal_72, Local_83 + Local_74, true, false, false, true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_72, Vector(uLocal_86, 0f, 0f) + Local_77, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_72, true);
			}
		}
	}
	if (!func_38())
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_72))
		{
			if (iLocal_80 != -1)
			{
				if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID()))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_80), Local_74, Local_77, false, false, false, false, 2, true);
				}
			}
...
void func_43()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(iVar0) && (!func_48(14) || Global_111866))
			{
...
void func_53()
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		{
			if (!AUDIO::REQUEST_AMBIENT_AUDIO_BANK(&cLocal_175, false, -1))
			{
				bVar1 = false;
			}
		}
...
void func_54()
{
	...
	func_58(iLocal_70, &Local_83, &uLocal_86, &cVar0);
	switch (iLocal_70)
	{
		case 273:
		case 274:
			...
			if (iLocal_70 == 273)
			{
				Local_138 = { Vector((34,97325f + 0,25f), -441,7662f, -118,3218f) - Local_83 };
			}
			else if (iLocal_70 == 274)
			{
				Local_138 = { 0,125f, -1,1486f, (0,0588f + 0,1f) };
			}
			else
			{
				Local_138 = { -0,125f, 1,1486f, -0,0588f };
			}
			break;
		...
		case 310:
			...
			StringCopy(&cLocal_122, "", 64);
			iLocal_73 = joaat("prop_tool_shovel");
			Local_74 = { 0f, 0f, -0,045f };
			Local_77 = { 0f, 180f, 0f };
			iLocal_80 = 28422;
			fLocal_81 = 0,7f;
			iLocal_82 = 0;
		...
		case 315:
			...
			StringCopy(&cLocal_122, "", 64);
			iLocal_73 = joaat("prop_cs_sink_filler_02");
			Local_74 = { -0,54f, 0,08f, -0,13f };
			Local_77 = { 0f, 0f, -12f };
			iLocal_80 = -1;
			fLocal_81 = 0,7f;
			iLocal_82 = -1;
		...
		case 124:
			...
			StringCopy(&cLocal_122, "", 64);
			iLocal_73 = joaat("prop_cs_sink_filler_03");
			Local_74 = { -0,72f, 0,9f, 0,21f };
			Local_77 = { 0f, 0f, 9f };
			iLocal_80 = -1;
			fLocal_81 = 0,7f;
			iLocal_82 = -1;
	...
	Var8.f_0 = 0;
	Var8.f_2 = iLocal_70;
	Var8.f_3 = Global_97452.f_45;
	func_55(Var8, &Var117);
	func_4(iLocal_70, &sLocal_143, &cVar237, &cLocal_159, &uVar253, &uVar254);
}

int func_55(struct<109> Param0, var uParam109)
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam109 = { Global_98085[0 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_57(uParam109);
			uParam109->f_118 = Global_99673[0];
			return 1;
			break;
		
		case 3:
			*uParam109 = { Global_98085[1 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_57(uParam109);
			uParam109->f_118 = Global_99673[1];
			return 1;
			break;
		
		case 4:
			*uParam109 = { Global_98085[2 /*109*/] };
			uParam109->f_109 = -982327190;
			uParam109->f_110 = -982327190;
			func_57(uParam109);
			uParam109->f_118 = Global_99673[2];
			return 1;
			break;
		...
		case 5:
			*uParam109 = { Param0 };
			...
			uParam109->f_110 = -982327190;
			func_57(uParam109);
			uParam109->f_118 = Global_99673[Param0.f_3];
			return 1;
			break;
		...
		case 80:
			*uParam109 = { Param0 };
			uParam109->f_109 = 1785177548;
			uParam109->f_110 = 1785177548;
			func_56(uParam109, 17, -2017877118, -2017877118, Vector(2,6407f, 8,164f, -14,1564f) + Vector(-1f, 0,03f, -2,16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_57(uParam109);
			}
...
void func_56(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, float fParam7)
{
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[0];
			StringCopy(sParam2, func_65(Global_112915.f_2363.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[1];
			StringCopy(sParam2, func_65(Global_112915.f_2363.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[2];
			StringCopy(sParam2, func_65(Global_112915.f_2363.f_539.f_2314[2]), 32);
			return 1;
			break;
