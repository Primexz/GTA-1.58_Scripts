...
int func_9(var uParam0)
{
	...
	while (iLocal_18 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97343[iLocal_18]) && !PED::IS_PED_INJURED(Global_97343[iLocal_18]))
		{
			if (Global_97343[iLocal_18] != PLAYER::PLAYER_PED_ID())
			{
				if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_97343[iLocal_18]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Global_97343[iLocal_18], false) || !ENTITY::IS_ENTITY_ATTACHED(Global_97343[iLocal_18]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Global_97343[iLocal_18], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), true) < 10f)
						{
							iLocal_19 = func_5(Global_97343[iLocal_18]);
							if ((iLocal_19 == 0 || iLocal_19 == 2) || iLocal_19 == 1)
							{
								if (iLocal_19 != func_10())
								{
									if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(Global_97343[iLocal_18], PLAYER::PLAYER_PED_ID(), 17))
									{
										if (PED::IS_PED_IN_ANY_VEHICLE(Global_97343[iLocal_18], false))
										{
											iVar0 = PED::GET_VEHICLE_PED_IS_IN(Global_97343[iLocal_18], false);
										}
										if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false)) || !ENTITY::DOES_ENTITY_EXIST(iVar0))
										{
											*uParam0 = Global_97343[iLocal_18];
											return 1;
										}
									}
								}
...
void func_11()
{
	...
	{
		if (func_6(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_5(PLAYER::PLAYER_PED_ID());
			if (func_8(iVar0) && (!func_12(14) || Global_111866))
			{
				if (Global_112915.f_2363.f_539.f_4321 != iVar0 && func_8(Global_112915.f_2363.f_539.f_4321))
				{
