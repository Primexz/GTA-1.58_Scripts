	...
	while (iLocal_261 && func_137(2, 0))
	{
		...
		switch (iLocal_70)
		{
			...
			case 2:
				if (func_133())
				{
					func_132(&uLocal_72, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_132(&uLocal_72, 2, Global_99695, "LAMAR", 0, 1);
					iLocal_70 = 3;
				}
				break;
...
int func_2()
{
	...
	{
		func_125(&(iLocal_262[iVar0]), iVar0);
		iVar0++;
	}
	func_125(&Global_99695, iLocal_262);
	func_3(Global_99695);
	return 0;
}
...
void func_3(int iParam0)
{
	...
	{
		if (!iLocal_517 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), true))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					if (!func_117(iVar2) || func_109(iVar2) == 6)
					{
						...
						if (func_41(Global_95708, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_517 = 1;
						}
					}
	...
	else
	{
		...
		if (iLocal_515 > 0)
		{
			if (iLocal_516 == 0)
			{
				if (iLocal_515 + 15000 < MISC::GET_GAME_TIMER())
				{
			...
			else if (iLocal_515 + 10000 < MISC::GET_GAME_TIMER())
			{
...
void func_39()
{
	...
	{
		if (func_34(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_40(PLAYER::PLAYER_PED_ID());
			if (func_36(iVar0) && (!func_24(14) || Global_111866))
			{
...
int func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iParam3 == 0)
	{
		if (func_105(iVar1, iParam2, -1, &iVar4, &iVar5))
		{
			...
			if (func_101(iParam5, iVar4, iVar5, iVar0, iVar2, iParam1, iVar3, 10000, iParam6, iParam4, iVar7, iVar6, 1))
			{
				return 1;
			}
			else
	...
	{
		if (func_82(iParam1, &sVar8, 1, 0, 0, 0, 0, 1, 0, 1))
		{
			if (iParam4 != 0)
			{
				switch (iParam4)
...
void func_47(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_112915.f_20564.f_471, iParam0) || MISC::IS_BIT_SET(Global_2359296[func_49() /*5559*/].f_675.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_112915.f_20564.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_49() /*5559*/].f_675.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_55(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2359296[func_49() /*5559*/].f_675.f_10, iParam0);
}
...
int func_60(int iParam0, int iParam1)
{
	...
	if (func_70(&Global_4535627))
	{
		if (func_68(&Global_4535627, iParam0))
		{
			return 0;
		}
		if (func_61(&Global_4535627, iParam0))
		{
			return 1;
		}
	}
...
void func_64(var uParam0)
{
	...
	func_66(uParam0, (Global_4535626 - 0,5f));
}
...
int func_82(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	sVar6 = "NULL";
	iVar7 = 3;
	if (func_84(iParam0, sParam1, iParam2, iVar0, sVar1, sVar3, iVar2, iParam3, iParam4, iParam5, bParam7, iParam8, iParam9, iVar4, sVar5, sVar6, iVar7) == 1)
	{
		if (bParam7 == 1)
		{
			Global_8531 = iParam6;
			Global_8434[3 /*6*/] = { func_83(iParam0) };
			Global_8511 = iParam0;
...
int func_84(int iParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)
{
	...
	if (!Global_20145)
	{
		...
		{
			func_90(Global_19935, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_87(1);
			func_90(Global_19935, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_19934), -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_85(int iParam0, char* sParam1, bool bParam2, int iParam3)
{
	if (!func_15())
	{
		return;
					...
					if (iVar0 == Global_7831[iVar1 /*15*/].f_4)
					{
						if (Global_8393[iVar0] == 0)
						{
							...
							if (Global_2725219)
							{
								if (iVar1 == 14)
								{
									func_88(Global_19935, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7831[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22348), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							Global_8393[iVar0] = 1;
						}
					...
					if (iVar0 == Global_7831[iVar1 /*15*/].f_4)
					{
						if (Global_8393[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_88(Global_19935, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7831[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22353), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_77852)
								{
									...
									func_88(Global_19935, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7831[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar4), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_19954)
									...
									func_88(Global_19935, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7831[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
							...
							else if (Global_7831[iVar1 /*15*/].f_10 == 57 && iVar1 == 23)
							{
								...
								func_88(Global_19935, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7831[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar9), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else
							{
								func_88(Global_19935, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_7831[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_7831[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_8393[iVar0] = 1;
						}
					}
...
void func_90(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
void func_94()
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_95(Global_112915.f_14141[iVar2 /*104*/].f_18, Global_112915.f_14141[Global_22352 /*104*/].f_18))
		{
			Global_22352 = iVar2;
		}
		iVar2++;
...
int func_95(struct<6> Param0, struct<6> Param6)
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_97(int iParam0, int iParam1, int iParam2, var uParam3)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			iVar13 = func_99(iParam0);
			if (func_98(&(Var4[0 /*4*/]), iVar13))
			{
				iParam2 = 1;
			}
			else if (func_98(&(Var4[1 /*4*/]), iVar13))
			{
				iParam2 = 0;
			}
			else
...
int func_105(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			{
				iVar9 = func_99(iParam0);
				if (func_98(&(Var0[0 /*4*/]), iVar9))
				{
					iParam2 = 1;
				}
				else if (func_98(&(Var0[1 /*4*/]), iVar9))
				{
					iParam2 = 0;
				}
				else
...
void func_108(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	if (iParam0 == iParam5)
	{
		return;
...
int func_110(int iParam0, int iParam1)
{
	...
	bVar10 = false;
	if (MISC::IS_BIT_SET(Var0.f_2, func_111()))
	{
		bVar10 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar10)
	{
		if (Var0.f_3 < Global_112915.f_7688.f_919[func_111()])
		{
			return 5;
		}
	}
...
int func_119(struct<3> Param0, bool bParam3)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_125(int* iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		...
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*iParam0, &cLocal_361, &(Local_442[iParam1 /*16*/]), 2))
				{
					fVar1 = fLocal_514;
					fVar2 = -1f;
					fVar3 = -1f;
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_361, &(Local_442[iParam1 /*16*/]), "WalkInterruptible", &fVar2, &fVar3))
					{
						fVar1 = fVar2;
					}
					else
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_97304) > fVar1)
					{
						if (func_131(Local_291[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							Var4 = { ENTITY::GET_ENTITY_COORDS(*iParam0, true) };
							Local_291[iParam1 /*3*/] = { Var4 - Local_277 * Vector(4f, 4f, 4f) };
							Local_291[iParam1 /*3*/].f_2 = 0f;
						}
						SYSTEM::WAIT(0);
						if (PED::IS_PED_INJURED(*iParam0))
						{
							TASK::CLEAR_PED_TASKS(*iParam0);
							TASK::TASK_GO_STRAIGHT_TO_COORD(*iParam0, Local_277 + Local_291[iParam1 /*3*/] * Vector(0,1f, 0,1f, 0,1f), 1f, -1, 40000f, 0,5f);
			...
			case 1:
				...
				fVar7 = SYSTEM::VMAG(Local_291[iParam1 /*3*/] * Vector(0,05f, 0,05f, 0,05f));
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), Local_277) >= fVar7)
				{
			...
			case 2:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 713668775) != 1)
				{
					...
					{
						fLocal_308[iParam1] = (SYSTEM::VMAG(Local_291[iParam1 /*3*/]) * 0,75f);
					}
					TASK::TASK_WANDER_IN_AREA(*iParam0, Local_277 + Local_291[iParam1 /*3*/], fLocal_308[iParam1], 3f, 6f);
			...
			case 3:
				...
				if (TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_513))
				{
					TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_513, false);
				}
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*iParam0, true), Local_277 + Local_291[iParam1 /*3*/]) < (fLocal_308[iParam1] * fLocal_308[iParam1]))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_277 + Local_291[iParam1 /*3*/], fLocal_308[iParam1], true))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*iParam0, Local_277 + Local_291[iParam1 /*3*/], fLocal_308[iParam1], 0);
			...
			case 4:
				...
				else
				{
					...
					Var8 = { func_126(Local_277 + Local_291[iParam1 /*3*/], func_129((fLocal_308[iParam1] * 0,9f), 10f, 100f), 0f) };
					if (TASK::GET_SCRIPT_TASK_STATUS(*iParam0, 1647992574) == 1)
					{
					}
					else if (PATHFIND::GET_SAFE_COORD_FOR_PED(Var8, false, &Var11, 14))
					{
			...
			case 10:
				...
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_275, joaat("player"));
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_275);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_275, Global_94978);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, Global_94978, iLocal_275);
...
Vector3 func_126(struct<3> Param0, float fParam3, float fParam4)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
	...
	return func_127(Param0, fParam3, fParam4);
}

Vector3 func_127(struct<3> Param0, float fParam3, float fParam4)
{
	struct<3> Var0;
	float fVar3;
	...
	fVar3 = (fParam4 / 2f);
	Var0 = { func_128(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
...
int func_133()
{
	...
	{
		func_125(&(iLocal_262[iVar1]), iVar1);
		iVar1++;
	}
	func_125(&Global_99695, iLocal_262);
	return 0;
	...
	if (!func_134())
	{
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97304))
		{
			...
			while (iVar0 < iLocal_262)
			{
				...
				{
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_262[iVar0], Global_97304, &cLocal_361, &(Local_442[iVar0 /*16*/]), 8f, -4f, 3, 0, 1000f, 0);
					iLocal_270[iVar0] = 0;
				}
				else
				{
...
int func_136()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_97303))
	{
		...
		while (iVar0 < iLocal_262)
		{
			if (!PED::IS_PED_INJURED(iLocal_262[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_262[iVar0], Global_97303, &cLocal_361, &(Local_377[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			iVar0++;
		}
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			func_132(&uLocal_72, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (!PED::IS_PED_INJURED(Global_99695))
		{
			func_132(&uLocal_72, 4, Global_99695, "LAMAR", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_262[0]))
		{
			func_132(&uLocal_72, 5, iLocal_262[0], "GangMember1", 0, 1);
		}
		if (!PED::IS_PED_INJURED(iLocal_262[1]))
		{
			func_132(&uLocal_72, 6, iLocal_262[1], "GangMember2", 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_137(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_138(Global_99695) && iParam1 != 0)
		{
			Global_99695 = 0;
		}
	}
...
void func_145()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_262)
		{
			...
			{
				STREAMING::REQUEST_MODEL(iLocal_266[iVar0]);
				if (!STREAMING::HAS_MODEL_LOADED(iLocal_266[iVar0]))
				{
					bVar2 = false;
					STREAMING::REQUEST_MODEL(iLocal_266[iVar0]);
				}
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_361))
		{
			STREAMING::REQUEST_ANIM_DICT(&cLocal_361);
			if (!STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_361))
			{
				bVar2 = false;
				STREAMING::REQUEST_ANIM_DICT(&cLocal_361);
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_99695))
	{
		if (func_37(19) == ENTITY::GET_ENTITY_MODEL(Global_99695))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_99695, true, true);
		}
		func_146(&Global_99695, Global_94978);
		PED::SET_PED_CONFIG_FLAG(Global_99695, 132, true);
		PED::SET_PED_CONFIG_FLAG(Global_99695, 317, true);
		func_146(&Global_99695, Global_94978);
	}
	PED::ADD_RELATIONSHIP_GROUP("TAUNTERS", &iLocal_275);
	iVar0 = 0;
	while (iVar0 < iLocal_262)
	{
		if (iLocal_266[iVar0] != 0)
		{
			iLocal_262[iVar0] = PED::CREATE_PED(iLocal_276, iLocal_266[iVar0], Local_277 + Local_281[iVar0 /*3*/], 0f, true, true);
			ENTITY::SET_ENTITY_HEADING(iLocal_262[iVar0], (fLocal_280 + fLocal_304[iVar0]));
			PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_262[iVar0], 0);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_262[iVar0], iLocal_275);
			TASK::TASK_PLAY_ANIM(iLocal_262[iVar0], &cLocal_361, &(Local_377[iVar0 /*16*/]), 8f, -8f, -1, 9, 0f, false, false, false);
			PED::SET_PED_CONFIG_FLAG(iLocal_262[iVar0], 317, true);
			if (iLocal_276 == 6)
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_262[iVar0], joaat("weapon_stungun"), 1000, false, true);
			}
		}
		iVar0++;
	}
...
void func_147()
{
	...
	func_151(iLocal_71, &Local_277, &fLocal_280, &cVar0);
	func_149(iLocal_71, &sLocal_313, &cLocal_329, &cLocal_345, &uVar8, &uVar9);
	switch (iLocal_71)
	{
		case 218:
			Local_281[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			Local_281[1 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			Local_291[0 /*3*/] = { -77,3f, -4,1f, 1f };
			Local_291[1 /*3*/] = { Local_291[0 /*3*/] };
			Local_291[iLocal_262 /*3*/] = { 66,7f, -7,299f, 1f };
			fLocal_304[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_304[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_308[0] = 30f;
		...
		case 219:
			Local_281[0 /*3*/] = { -0,2331f, 0,0497f, 0,0041f };
			Local_281[1 /*3*/] = { 0,6908f, -0,4534f, 0,0042f };
			Local_291[0 /*3*/] = { -0,6f, -144,3f, 0f };
			Local_291[1 /*3*/] = { Local_291[0 /*3*/] };
			Local_291[iLocal_262 /*3*/] = { 112,2308f, 43,129f, 3,188f };
			fLocal_304[0] = 180f;
			fLocal_304[1] = 180f;
			fLocal_308[0] = 40f;
			fLocal_308[1] = fLocal_308[0];
		...
		case 220:
			Local_281[0 /*3*/] = { 1,7097f, -1,8585f, -0,052f };
			Local_281[1 /*3*/] = { 2,7011f, -1,5f, -0,052f };
			Local_291[0 /*3*/] = { Vector(21,5656f, -1890,595f, 59,4395f) - Local_277 };
			Local_291[1 /*3*/] = { Local_291[0 /*3*/] };
			Local_291[iLocal_262 /*3*/] = { Vector(-4,6336f, -54,7307f, 67,5391f) * Vector(-1f, -1f, -1f) };
		...
		case 225:
			Local_281[0 /*3*/] = { 3,8209f, 1,0394f, 0f };
			Local_281[1 /*3*/] = { 4,0994f, -0,0922f, 0f };
			Local_291[0 /*3*/] = { Vector(27,9565f, -1650,517f, 278,2831f) - Local_277 };
			Local_291[1 /*3*/] = { Local_291[0 /*3*/] };
			Local_291[iLocal_262 /*3*/] = { -Vector(0f, 62,7f, 54,673f) };
			...
			Local_507 = { func_148("FRAS_IG_10", 3) };
			fLocal_511 = 0f;
			break;
		...
		default:
			Local_281[0 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			Local_281[1 /*3*/] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			Local_291[0 /*3*/] = { 0f, 0f, 0f };
			Local_291[1 /*3*/] = { 0f, 0f, 0f };
			Local_291[iLocal_262 /*3*/] = { 0f, 0f, 0f };
			fLocal_304[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_304[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_308[0] = 0f;
			fLocal_308[1] = 0f;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[0];
			StringCopy(sParam2, func_157(Global_112915.f_2363.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[1];
			StringCopy(sParam2, func_157(Global_112915.f_2363.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_112915.f_2363.f_539.f_2310[2];
			StringCopy(sParam2, func_157(Global_112915.f_2363.f_539.f_2314[2]), 32);
			return 1;
			break;
...
void func_158()
{
	...
	while (iVar0 < iLocal_266)
	{
		if (iLocal_266[iVar0] != 0)
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_266[iVar0]);
		}
		iVar0++;
	}
	PED::REMOVE_RELATIONSHIP_GROUP(iLocal_275);
	if (!TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_513))
	{
		TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_513, true);
	}
