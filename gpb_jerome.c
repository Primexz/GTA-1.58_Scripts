...
{
	StringCopy(sParam1, "Special_Ped@jerome", 32);
	switch (iParam0)
	{
		case 1:
			StringCopy(sParam2, "MyBrotherTaughtMe", 64);
			break;
		
		case 2:
			StringCopy(sParam2, "IAmYourTrueSalvation", 64);
			break;
		
		case 3:
			StringCopy(sParam2, "WhatIsParadise", 64);
			break;
		
		case 4:
			StringCopy(sParam2, "ListenToMe", 64);
			break;
		
		case 5:
			StringCopy(sParam2, "MyBrotherTold", 64);
			break;
		
		case 6:
			StringCopy(sParam2, "YouThinkYourHappy", 64);
			break;
		
		case 7:
			StringCopy(sParam2, "ListenListen", 64);
			break;
		
		case 8:
			StringCopy(sParam2, "IgnoreMeAtYourPeril", 64);
			break;
	}
}
...
void func_105()
{
	iLocal_36 = joaat("s_m_m_strpreach_01");
	StringCopy(&Local_234, "PBJE", 8);
	StringCopy(&Local_236, "JEROME", 16);
	StringCopy(&Local_202, "Special_Ped@jerome", 64);
	StringCopy(&Local_218, "Base", 64);
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBJS_INTERACT";
	StringCopy(&Local_312, "", 16);
	StringCopy(&Local_316, "", 16);
	StringCopy(&Local_320, "", 16);
	StringCopy(&cLocal_324, "special_ped@jerome@base", 64);
	StringCopy(&cLocal_340, "special_ped@jerome@intro", 64);
	bLocal_439 = false;
	iLocal_251 = 6;
	iLocal_255[0] = 9;
	iLocal_255[1] = 9;
