#region Local Var
	...
	int iLocal_206 = 0;
	int iLocal_207 = 0;
	char* sLocal_208[3] = { NULL, NULL, NULL };
...
void __EntryFunction__()
{
	...
	sLocal_188 = "FBIPRD";
	Local_194 = { 0f, 0f, 0f };
	Local_197 = { -1335,314f, -1277,943f, 3,8649f };
	Local_200 = { -1336,378f, -1279,056f, 3,855f };
	iLocal_205 = -1;
	sLocal_212 = "FBIPRAU";
	...
	if (func_269())
	{
		func_268(-1339,786f, -1277,51f, 3,8874f, 261,2839f, 1, 0);
	}
	if (func_267(0))
	{
		Global_112915.f_2363.f_539.f_2395[0] = -99;
		Global_112915.f_2363.f_539.f_2395[1] = -99;
		Global_112915.f_2363.f_539.f_2395[2] = -99;
		func_235();
	}
	while (true)
	{
		RECORDING::_0x208784099002BC30("M_MS", 0);
...
void func_1()
{
	switch (iLocal_81)
	{
		case 0:
			...
			HUD::CLEAR_HELP(true);
			func_21();
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_187))
			{
				if (MISC::ARE_STRINGS_EQUAL(sLocal_187, "PRE_FKICKOFF"))
				{
					while ((MISC::GET_GAME_TIMER() - iLocal_205) < 3000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_4(int iParam0)
{
	...
	if (Global_112915.f_9085 || func_267(0))
	{
		iVar0 = func_18();
		if (!func_5(iVar0))
		{
...
int func_5(int iParam0)
{
	...
	func_6(&(Global_112915.f_2363.f_539), iVar1);
...
void func_6(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_8(Global_112915.f_18533[iVar0], &Var2, &fVar5))
			{
...
void func_12()
{
	...
	{
		if (func_16(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_15(PLAYER::PLAYER_PED_ID());
			if (func_14(iVar0) && (!func_13(14) || Global_111866))
			{
				if (Global_112915.f_2363.f_539.f_4321 != iVar0 && func_14(Global_112915.f_2363.f_539.f_4321))
				{
...
void func_23()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (func_93(PLAYER::PLAYER_PED_ID(), Local_200, 2f) && func_87(21))
			{
			...
			{
				if ((func_86("PRD_BUYM", 0, 0) || func_86("PRD_BUYT", 0, 0)) || func_86("PRD_BUYF", 0, 0))
				{
					HUD::CLEAR_PRINTS();
				}
				if (bLocal_190)
				...
				else if (!func_93(PLAYER::PLAYER_PED_ID(), Local_197, 75f))
				{
					if (!iLocal_207)
					{
						func_22(&iLocal_192);
					...
					func_84(&iLocal_192, Local_200, 1, 1, "PRD_SHOP");
				}
				else if (func_93(PLAYER::PLAYER_PED_ID(), Local_200, 12f))
				{
					if (iLocal_207)
					{
						func_22(&iLocal_192);
					...
					func_84(&iLocal_192, Local_200, 1, 1, "PRD_BLIP");
					if (HUD::DOES_BLIP_EXIST(iLocal_192))
					{
						HUD::SET_BLIP_COLOUR(iLocal_192, 2);
						HUD::SET_BLIP_ROUTE_COLOUR(iLocal_192, 2);
					}
				}
			}
			break;
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_204) > 2000)
			{
				func_22(&iLocal_192);
				if (func_43(&uLocal_382, &cLocal_378, &uLocal_213))
				{
					func_42(0, -1);
					if ((Global_112915.f_2363.f_539.f_2395[0] == 38 && Global_112915.f_2363.f_539.f_2395[1] == 33) && Global_112915.f_2363.f_539.f_2395[2] == 54)
					{
						func_41(821);
					}
					func_38();
		...
		case 3:
			Global_112915.f_2363.f_539.f_2395[0] = 38;
			Global_112915.f_2363.f_539.f_2395[1] = 33;
			Global_112915.f_2363.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_81 = 2;
			break;
	}
...
void func_39(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_267(0) && Global_78098.f_1 == 1) && func_40(Global_78098))
		{
		}
		else
		{
...
int func_43(var uParam0, char* sParam1, var uParam2)
{
	switch (*uParam0)
	{
		case 0:
			if (func_82())
			{
				if ((func_81(74) || func_81(75)) && func_80())
				{
					if (func_11() == 0)
					{
						func_79(1);
					...
					{
						func_77(uParam2, 0, 0, "MICHAEL", 0, 1);
						if (func_60(uParam2, func_76(), func_11(), "FBIPRAU", func_75(), 9, 1, 0, 0, 0))
						{
							*sParam1 = { func_59(1) };
							func_78(46, 1);
							*uParam0 = 1;
...
void func_48(char* sParam0, char* sParam1)
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_21342 = 1;
...
void func_50()
{
	...
	func_51(func_54(), 0, func_11(), func_76(), 9, 6000, 6000, -1, 0, -1, 0);
}

int func_51(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<15> Var0;
	int iVar15;
...
int func_57(int iParam0)
{
	...
	return Global_97452[func_58(iParam0)];
}
...
bool func_60(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	func_74(uParam0, uParam1, sParam3, iParam7, iParam8, 0);
	Global_7142 = iParam2;
	Global_21333 = 0;
	Global_21292 = 1;
	Global_21299 = 0;
	...
	Global_2883585 = 0;
	return func_61(sParam4, iParam5, bParam9);
}
...
void func_74(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_77(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
void func_79(bool bParam0)
{
	if (bParam0)
	{
		func_51(1527885205, 0, func_11(), 23, 3, 6000, 6000, -1, 0, -1, 0);
	}
	else if (!func_81(3))
	{
		func_51(-224691627, 0, func_11(), 23, 3, 6000, 6000, -1, 50, -1, 0);
	}
	else
	{
		func_51(-224691627, 0, func_11(), 23, 3, 6000, 6000, -1, 0, -1, 0);
	}
}

int func_80()
{
	if ((func_81(41) && func_81(3)) && func_81(21))
	{
		return 1;
	}
	return 0;
...
void func_84(int* iParam0, struct<3> Param1, bool bParam4, bool bParam5, char* sParam6)
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
		*iParam0 = func_85(Param1, 5, bParam4);
		if (bParam5)
		{
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*iParam0, sParam6);
		}
	}
}

int func_85(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
...
bool func_86(char* sParam0, int iParam1, char* sParam2)
{
...
int func_88(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_92() == 0)
		{
			return MISC::IS_BIT_SET(func_89(func_91(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_94(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_95(PLAYER::PLAYER_PED_ID(), -1339,786f, -1277,51f, 3,8874f, 261,2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
		...
		case 2:
			if (bParam1)
			{
				func_95(PLAYER::PLAYER_PED_ID(), Local_200, 261,2839f);
				bLocal_28 = false;
				func_24(1, 1, 1);
			}
			else
...
void func_95(int iParam0, struct<3> Param1, float fParam4)
{
	if (func_234(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_96(iParam0, Param1, fParam4, 0, 1);
}

int func_96(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
int func_97(int iParam0, struct<3> Param1, float fParam4)
{
	switch (iParam0)
	{
		case 0:
			if (func_98(Param1, Local_194, 1056964608, 0) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_188, 0);
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_212, 6);
...
void func_100(var uParam0)
{
	...
	func_77(uParam0, iVar0, PLAYER::PLAYER_PED_ID(), sVar1, 0, 1);
}
...
void func_101()
{
	switch (iLocal_81)
	{
		...
		case 1:
			if (!iLocal_203)
			{
				if (func_93(PLAYER::PLAYER_PED_ID(), Local_197, 60f))
				{
					func_106("PRD_GCLOTH", &iLocal_189);
					func_22(&iLocal_192);
					func_84(&iLocal_192, Local_200, 1, 1, "PRD_BLIP");
					if (HUD::DOES_BLIP_EXIST(iLocal_192))
					{
		...
		case 3:
			func_95(PLAYER::PLAYER_PED_ID(), Local_200, 0f);
			func_24(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
{
	func_103(iLocal_80);
	iLocal_186 = iLocal_80;
	if (!bParam0)
	{
		iLocal_80 = iLocal_186 + 1;
	}
	else if (iLocal_186 > 0)
	{
		iLocal_80 = (iLocal_186 - 1);
	}
	iLocal_189 = 0;
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_94(iLocal_80, 0))
			{
				...
				if (func_269())
				{
					func_114(&iVar1, -1327,175f, -1290,811f, 3,8472f, 291,8355f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
					func_111(0, -1, 1);
					iVar0 = MISC::GET_GAME_TIMER();
					while (!func_110(21) && (MISC::GET_GAME_TIMER() - iVar0) < 2000)
					{
						SYSTEM::WAIT(0);
					}
					func_25(500, 1);
...
void func_114(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_269() || !func_218())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_215(iParam6, iParam7, iParam8, iParam13))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_194(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_193(Param1, 0f, 0f, 0f, 0))
		{
			Param1 = { Global_106464.f_2890 };
			fParam4 = Global_106464.f_2890.f_6;
		}
		MISC::CLEAR_AREA(Param1, 5f, true, false, false, false);
		func_184(Param1, 5f, 0);
		if (func_14(iParam12))
		{
			func_182(iParam12, 0);
			while (!func_115(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_115(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
		...
		if (Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_176(iParam0, &(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_176(iParam0, &(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5.f_0))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5.f_0, Param2, fParam5, true, true, false);
				...
				func_176(iParam0, &(Var5.f_31), &(Var5.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 1)
				{
...
void func_116(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_121(*iParam1, 0, &uVar0))
		{
			func_120(iParam1, &(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_112915.f_20118[iParam0 /*43*/].f_31 = func_119(*iParam1);
				...
				func_117(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_112915.f_20118[iParam0 /*43*/].f_1));
				...
				func_117(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_112915.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_117(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_118(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_118(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_121(int iParam0, bool bParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
	...
	*uParam2 = 0;
	...
	if ((!func_149(iVar0, bParam1, uParam2) && !func_148(PLAYER::PLAYER_ID())) && !func_131(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_129(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_127(iParam0)) && !bVar1) && !(func_126(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_123(PLAYER::PLAYER_ID())))
	{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_122(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_123(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			...
			{
				return func_124(Global_2689156[iParam0 /*453*/].f_319.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_128(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_124(Global_2689156[iParam0 /*453*/].f_319.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_129(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_124(Global_2689156[iParam0 /*453*/].f_319.f_6) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_147(PLAYER::PLAYER_ID()) || func_146(PLAYER::PLAYER_ID()))
	{
		if (func_132(iParam0))
		{
			return 1;
...
int func_133(int iParam0)
{
	...
	if (func_134(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
	{
		return 1;
	}
	return 0;
...
int func_135(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_137(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
				if (Global_2810287.f_303 == iParam0)
				{
					return 1;
				}
				else if (func_136(iParam0) != -1 && !bParam1)
				{
					return 1;
				}
			}
...
int func_146(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			...
			{
				return func_124(Global_2689156[iParam0 /*453*/].f_319.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_147(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1 && Global_2689156[iParam0 /*453*/].f_319.f_9 != func_66())
			{
				return func_124(Global_2689156[iParam0 /*453*/].f_319.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_148(int iParam0)
{
	if (iParam0 != func_66())
	{
		if (func_125(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_124(Global_2689156[iParam0 /*453*/].f_319.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_149(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_129(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
void func_151(int iParam0, int iParam1)
{
	...
	func_152(iParam0, &(Global_112915.f_32749.f_5510));
}
...
void func_152(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		if (uParam1->f_65 == -1 && !func_154(uParam1->f_66))
		{
			uParam1->f_65 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_153(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_171(iParam0, 0, 0)) || func_171(iParam0, 1, 0)) || func_171(iParam0, 2, 0)) || func_170(iParam0) != 145) || func_169(iParam0)) || func_168(iParam0)) || func_122(iParam0)) || func_167(iParam0)) || !func_157(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_168(iParam0))
		{
		}
		...
		if (func_171(iParam0, 0, 0))
		{
		}
		if (func_171(iParam0, 1, 0))
		{
		}
		if (func_171(iParam0, 2, 0))
		{
		}
...
int func_171(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_172(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_172(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
int func_176(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_145(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_179(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_179(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_178(iParam0);
	if (func_177(*iParam0))
	{
...
void func_182(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97305[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97305[iVar0]) == func_183(iParam0, iParam1))
				{
...
void func_184(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_192(&(Global_76670.f_555[0 /*21*/]), iVar0))
		{
...
void func_185(int iParam0)
{
	...
	if (func_192(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_191(iParam0, 0)) && Global_77579.f_66 == 0) && Global_112915.f_32749.f_1958[Global_76670.f_555[0 /*21*/].f_14] != 0) && Global_112915.f_32749.f_1958[Global_76670.f_555[0 /*21*/].f_14] > 3) && (!func_189(0, Global_76670.f_555[0 /*21*/].f_12) || !func_189(1, Global_76670.f_555[0 /*21*/].f_12)))
			{
				func_188(&(Global_112915.f_32749.f_69[Global_76670.f_555[0 /*21*/].f_14 /*78*/]), &Global_77579);
...
int func_189(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_190(&(Global_112915.f_32749.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_158(Global_112915.f_32749.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0);
}
...
{
	return func_195(&(Global_106464.f_2890), Param0, fParam3, 0);
}
	...
	if (func_211(uParam0))
	{
		...
		if (func_210(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_199(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
					{
						...
						{
							func_182(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_182(uParam0->f_11, 2);
						}
					}
				...
				else if ((!func_197(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_196(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_197(int iParam0, struct<3> Param1, bool bParam4)
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_198(iParam0, Global_76670.f_139[38], 0))
			{
				func_185(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_198(iParam0, Global_76670.f_139[43], 1))
			{
				func_185(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_198(iParam0, uVar1[iVar6], 1) && func_98(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
					if ((!bParam4 || func_193(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
void func_199(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_153(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_153(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_153(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_153(iVar4));
					}
				}
				iVar4++;
			}
		...
		{
			if (MISC::IS_BIT_SET(uParam1->f_77, func_153(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_153(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_153(1));
		}
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_202(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_201())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_153(iVar5 + 1)))
				{
...
int func_203(int iParam0)
{
	...
	{
		if (!func_209(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_205(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
int func_211(var uParam0)
{
	...
	if (!func_158(uParam0->f_12.f_66, 0))
	{
		return 0;
	}
	if (uParam0->f_12.f_66 == joaat("stunt") && func_98(*uParam0, 1694,62f, 3276,27f, 41,31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_212()
{
	return func_210(&(Global_106464.f_2890));
}

void func_213()
{
	func_214(&(Global_106464.f_2890));
}
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_217(Global_106464.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_218()
{
	return func_211(&(Global_106464.f_2890));
}
...
void func_221()
{
	if (!bLocal_28 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_190)
			{
				if (!func_93(PLAYER::PLAYER_PED_ID(), Local_197, 150f))
				{
					func_227(2);
				}
				else if (!func_93(PLAYER::PLAYER_PED_ID(), Local_197, 75f))
...
int func_222()
{
	...
	if (!func_223(bLocal_190, iVar0) && !bLocal_190)
	{
		return 0;
	}
	return 1;
...
void func_227(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			sLocal_187 = "PRD_FKICKOFF";
			break;
		
		case 2:
			sLocal_187 = "PRD_FLEFT";
			break;
...
void func_230()
{
	if (func_232())
	{
		...
		{
			case 0:
				if (Global_112915.f_2363.f_539.f_2395[0] == -99)
				{
					func_231(sLocal_208[0], sLocal_208[1], sLocal_208[2]);
				}
				else if (Global_112915.f_2363.f_539.f_2395[1] == -99)
				{
					func_231(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
				}
				else if (Global_112915.f_2363.f_539.f_2395[2] == -99)
				{
					func_231(sLocal_208[2], sLocal_208[1], sLocal_208[0]);
				}
				break;
			
			case 1:
				if (Global_112915.f_2363.f_539.f_2395[1] == -99)
				{
					func_231(sLocal_208[1], sLocal_208[0], sLocal_208[2]);
				}
				else if (Global_112915.f_2363.f_539.f_2395[0] == -99)
				{
					func_231(sLocal_208[0], sLocal_208[1], sLocal_208[2]);
				}
				else if (Global_112915.f_2363.f_539.f_2395[2] == -99)
			...
			case 2:
				if (Global_112915.f_2363.f_539.f_2395[2] == -99)
				{
					func_231(sLocal_208[2], sLocal_208[1], sLocal_208[0]);
				}
				else if (Global_112915.f_2363.f_539.f_2395[0] == -99)
...
void func_231(char* sParam0, char* sParam1, char* sParam2)
{
	if (func_86(sParam1, 0, 0) || func_86(sParam2, 0, 0))
	{
		HUD::CLEAR_PRINTS();
	}
	if (!func_86(sParam0, 0, 0))
	{
		func_107(sParam0, 60000, 0);
	}
}
...
int func_233()
{
	...
	while (iVar1 <= 2)
	{
		if (Global_112915.f_2363.f_539.f_2395[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
void func_235()
{
	...
	if (func_225(iVar0) < 1500)
	{
		func_236(func_11(), 96, 1500, 0, 0);
	}
}

void func_236(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	
	if (func_266(iParam0) == 3)
	{
		return;
	}
	...
	func_237(func_266(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				...
				case 1:
					func_263(joaat("sp1_money_total_spent"), iParam3);
					break;
				
				case 2:
					func_263(joaat("sp2_money_total_spent"), iParam3);
					break;
			}
			func_248(0);
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_263(joaat("sp0_money_spent_on_tattoos"), iParam3);
							break;
						
						case 1:
							func_263(joaat("sp1_money_spent_on_tattoos"), iParam3);
							break;
						
						case 2:
							func_263(joaat("sp2_money_spent_on_tattoos"), iParam3);
							break;
					}
					if (func_246(1))
					{
				...
				case 21:
					...
					{
						case 0:
							func_263(joaat("sp0_money_spent_on_taxis"), iParam3);
							break;
						
						case 1:
							func_263(joaat("sp1_money_spent_on_taxis"), iParam3);
							break;
						
						case 2:
							func_263(joaat("sp2_money_spent_on_taxis"), iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_263(joaat("sp0_money_spent_in_strip_clubs"), iParam3);
							break;
						
						case 1:
							func_263(joaat("sp1_money_spent_in_strip_clubs"), iParam3);
							break;
						
						case 2:
							func_263(joaat("sp2_money_spent_in_strip_clubs"), iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_263(joaat("sp0_money_spent_property"), iParam3);
							break;
						
						case 1:
							func_263(joaat("sp1_money_spent_property"), iParam3);
							break;
						
						case 2:
							func_263(joaat("sp2_money_spent_property"), iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_263(joaat("sp0_money_spent_in_clothes"), iParam3);
									break;
								
								case 1:
									func_263(joaat("sp1_money_spent_in_clothes"), iParam3);
									break;
								
								case 2:
									func_263(joaat("sp2_money_spent_in_clothes"), iParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_263(joaat("sp0_money_spent_on_hairdos"), iParam3);
									break;
								
								case 1:
									func_263(joaat("sp1_money_spent_on_hairdos"), iParam3);
									break;
								
								case 2:
									func_263(joaat("sp2_money_spent_on_hairdos"), iParam3);
									break;
							}
							if (func_246(0))
							{
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_263(joaat("sp0_money_spent_in_buying_guns"), iParam3);
									break;
								
								case 1:
									func_263(joaat("sp1_money_spent_in_buying_guns"), iParam3);
									break;
								
								case 2:
									func_263(joaat("sp2_money_spent_in_buying_guns"), iParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_263(joaat("sp0_money_spent_car_mods"), iParam3);
									break;
								
								case 1:
									func_263(joaat("sp1_money_spent_car_mods"), iParam3);
									break;
								
								case 2:
									func_263(joaat("sp2_money_spent_car_mods"), iParam3);
									break;
							}
							func_245(iParam3);
							break;
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_263(joaat("sp0_total_cash_earned"), iParam3);
					break;
				
				case 1:
					func_263(joaat("sp1_total_cash_earned"), iParam3);
					break;
				
				case 2:
					func_263(joaat("sp2_total_cash_earned"), iParam3);
					break;
			}
			break;
...
void func_240(int iParam0)
{
	...
	if (iParam0 == 12)
	{
		func_243(8271, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 13)
	{
		func_243(8272, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 14)
	{
		func_243(8273, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 15)
	{
		func_243(8274, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 16)
	{
		func_243(8275, 0, -1, 1, 0);
		return;
	}
	if (iParam0 == 17)
	{
		func_243(8276, 0, -1, 1, 0);
		return;
	}
	bVar0 = false;
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	...
	else if (MISC::IS_BIT_SET(Global_112915.f_20564.f_471, iParam0) || MISC::IS_BIT_SET(Global_2359296[func_242() /*5559*/].f_675.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_112915.f_20564.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_242() /*5559*/].f_675.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_246(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		return func_247(129, -1);
	}
	if (iParam0 == 9)
	{
		return func_247(135, -1);
	}
	if (iParam0 == 10)
	{
		return func_247(136, -1);
	}
	if (iParam0 == 11)
	{
		return func_247(137, -1);
	}
	if (iParam0 == 12)
	{
	...
	return MISC::IS_BIT_SET(Global_2359296[func_242() /*5559*/].f_675.f_10, iParam0);
}
...
{
	if (func_13(14) && !func_261(iParam0))
	{
		return 0;
	}
	...
	if (func_260(&Global_4535627))
	{
		if (func_258(&Global_4535627, iParam0))
		{
			return 0;
		}
		if (func_251(&Global_4535627, iParam0))
		{
			return 1;
		}
	}
...
int func_251(var uParam0, int iParam1)
{
	...
	if (func_13(14) && !func_261(iParam1))
	{
		return 0;
	}
...
void func_254(var uParam0)
{
	...
	func_256(uParam0, (Global_4535626 - 0,5f));
}
...
void func_270()
{
	func_271(joaat("player_zero"), 14, 31, 1);
	func_271(joaat("player_zero"), 14, 32, 1);
	func_271(joaat("player_zero"), 14, 33, 1);
	func_271(joaat("player_zero"), 14, 34, 1);
	func_271(joaat("player_zero"), 14, 35, 1);
	func_271(joaat("player_zero"), 14, 36, 1);
	func_271(joaat("player_zero"), 14, 37, 1);
	func_271(joaat("player_zero"), 14, 38, 1);
	func_271(joaat("player_zero"), 14, 39, 1);
	func_271(joaat("player_zero"), 14, 40, 1);
	func_271(joaat("player_zero"), 14, 41, 1);
	func_271(joaat("player_zero"), 14, 42, 1);
	func_271(joaat("player_zero"), 14, 43, 1);
	func_271(joaat("player_zero"), 14, 44, 1);
	func_271(joaat("player_zero"), 9, 9, 1);
	func_271(joaat("player_zero"), 9, 10, 1);
	func_271(joaat("player_zero"), 9, 11, 1);
	func_271(joaat("player_zero"), 9, 12, 1);
	func_271(joaat("player_zero"), 9, 13, 1);
	func_271(joaat("player_zero"), 9, 14, 1);
	func_271(joaat("player_one"), 14, 26, 1);
	func_271(joaat("player_one"), 14, 27, 1);
	func_271(joaat("player_one"), 14, 28, 1);
	func_271(joaat("player_one"), 14, 29, 1);
	func_271(joaat("player_one"), 14, 30, 1);
	func_271(joaat("player_one"), 14, 31, 1);
	func_271(joaat("player_one"), 14, 32, 1);
	func_271(joaat("player_one"), 14, 33, 1);
	func_271(joaat("player_one"), 14, 34, 1);
	func_271(joaat("player_one"), 14, 35, 1);
	func_271(joaat("player_one"), 14, 36, 1);
	func_271(joaat("player_one"), 14, 37, 1);
	func_271(joaat("player_one"), 14, 38, 1);
	func_271(joaat("player_one"), 14, 39, 1);
	func_271(joaat("player_one"), 9, 5, 1);
	func_271(joaat("player_one"), 9, 6, 1);
	func_271(joaat("player_one"), 9, 7, 1);
	func_271(joaat("player_one"), 9, 8, 1);
	func_271(joaat("player_one"), 9, 9, 1);
	func_271(joaat("player_one"), 9, 10, 1);
	func_271(joaat("player_two"), 14, 49, 1);
	func_271(joaat("player_two"), 14, 50, 1);
	func_271(joaat("player_two"), 14, 51, 1);
	func_271(joaat("player_two"), 14, 52, 1);
	func_271(joaat("player_two"), 14, 53, 1);
	func_271(joaat("player_two"), 14, 54, 1);
	func_271(joaat("player_two"), 14, 55, 1);
	func_271(joaat("player_two"), 14, 56, 1);
	func_271(joaat("player_two"), 14, 57, 1);
	func_271(joaat("player_two"), 14, 58, 1);
	func_271(joaat("player_two"), 14, 59, 1);
	func_271(joaat("player_two"), 14, 60, 1);
	func_271(joaat("player_two"), 9, 9, 1);
	func_271(joaat("player_two"), 9, 10, 1);
	func_271(joaat("player_two"), 9, 11, 1);
	func_271(joaat("player_two"), 9, 12, 1);
	func_271(joaat("player_two"), 9, 13, 1);
	func_271(joaat("player_two"), 9, 14, 1);
	func_271(joaat("player_two"), 9, 15, 1);
	func_271(joaat("player_two"), 9, 16, 1);
}

int func_271(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	Global_77663[1 /*14*/] = { func_273(iParam0, iParam1, iParam2, -1) };
	if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_272(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 0, Global_77663[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_272(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 0, Global_77663[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_273(int iParam0, int iParam1, int iParam2, int iParam3)
{
	func_338();
...
void func_275(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_283(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_276(&(Global_77663[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_276(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_280(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_280(Global_2883588, 2, 1, 1, -1))
			{
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_272(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_272(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_272(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_89(func_279(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_89(func_278(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			if (func_277(iParam1, uParam0->f_2, &iVar1))
			{
				iVar0 = func_89(iVar1, Global_77660, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
bool func_277(int iParam0, int iParam1, var uParam2)
{
	*uParam2 = 979;
	switch (iParam1)
	{
...
int func_280(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_281(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
...
bool func_281(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_283(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_276(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_276(&(Global_77663[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_276(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			func_276(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_284(iParam0));
			if (iVar57 > iVar56)
			{
...
void func_341(var uParam0, int iParam1)
{
	...
	{
		func_345(&uLocal_82, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_344(&uLocal_82);
	func_342(&uLocal_134, &uLocal_82, 50f);
}

void func_342(var uParam0, var uParam1, float fParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_343(uParam1, *(uParam1[iVar1 /*3*/]) + Var9))
		{
			Var9 = { -Var9 };
		}
...
bool func_343(var uParam0, struct<2> Param1, Vector3 vParam3)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_347()
{
	sLocal_208[0] = "PRD_BUYM";
	sLocal_208[1] = "PRD_BUYF";
	sLocal_208[2] = "PRD_BUYT";
}
