...
void __EntryFunction__()
{
	...
	if (func_112(func_114(SCRIPT::GET_THIS_SCRIPT_NAME())))
	{
		func_115(0);
	}
	if (!func_110())
	...
	while (iVar0 == 1)
	{
		...
		{
			func_97(func_114(SCRIPT::GET_THIS_SCRIPT_NAME()));
			func_115(0);
		}
...
void func_24(char* sParam0)
{
	...
	if (iVar0 == 2)
	{
		StringCopy(sParam0, "CONVO_TREVOR_WHAT_ARE_YOU_ON", 64);
	}
	else if (iVar0 == 0)
	{
		StringCopy(sParam0, "CONVO_MICHAEL_LET_ME_ASK_YOU_SOMTHING", 64);
	}
}
...
{
	StringCopy(sParam1, "Special_Ped@Tonya", 32);
	switch (iParam0)
	{
		case 1:
			StringCopy(sParam2, "CMON_LET_OLE_TONYA", 64);
			break;
		
		case 2:
			StringCopy(sParam2, "COME_OVER_HERE", 64);
			break;
		
		case 3:
			StringCopy(sParam2, "HEY_HEY", 64);
			break;
		
		case 4:
			StringCopy(sParam2, "HEY_CRACKA", 64);
			break;
		
		case 5:
			StringCopy(sParam2, "WHAT_CHU_DOIN", 64);
			break;
		
		case 6:
			StringCopy(sParam2, "ANYBODY_WANNA", 64);
			break;
	}
}
...
void func_105()
{
	iLocal_36 = joaat("ig_tonya");
	StringCopy(&Local_234, "TOW", 8);
	StringCopy(&Local_236, "TONYA", 16);
	StringCopy(&Local_202, "special_ped@tonya", 64);
	...
	{
		sLocal_303 = "PBTS_INTERACT";
	}
	StringCopy(&Local_312, "TONYA_MIC", 16);
	StringCopy(&Local_316, "TONYA_TRE", 16);
	StringCopy(&Local_320, "", 16);
	StringCopy(&cLocal_324, "special_ped@tonya@base", 64);
	StringCopy(&cLocal_340, "special_ped@tonya@intro", 64);
	bLocal_441 = true;
	iLocal_251 = 13;
	iLocal_447 = 0;
	iLocal_255[0] = 4;
...
int func_106()
{
	if (MISC::IS_BIT_SET(Global_112915.f_18574[58 /*6*/], 0) && !MISC::IS_BIT_SET(Global_112915.f_18574[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_111()
{
	if (MISC::IS_BIT_SET(Global_112915.f_18574[60 /*6*/], 0) && !MISC::IS_BIT_SET(Global_112915.f_18574[60 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_112915.f_18574[61 /*6*/], 0) && !MISC::IS_BIT_SET(Global_112915.f_18574[61 /*6*/], 3))
	{
		return 0;
	}
	if (MISC::IS_BIT_SET(Global_112915.f_18574[62 /*6*/], 3))
	{
		return 0;
	}
	if ((MISC::IS_BIT_SET(Global_112915.f_18574[58 /*6*/], 2) || MISC::IS_BIT_SET(Global_112915.f_18574[59 /*6*/], 2)) || MISC::IS_BIT_SET(Global_112915.f_18574[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_113(Global_112915.f_20117, uParam0);
}
