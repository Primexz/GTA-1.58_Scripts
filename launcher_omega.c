...
void __EntryFunction__()
{
	...
	{
		func_284("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112002[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_284("Relinquishing candidate id...");
				func_283(&(Global_112002[Var0.f_0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
	...
	while (!func_243(&Var0))
	{
		...
		{
			func_284("Player out of range [TERMINATING]");
			func_267(&Var0, 1);
		}
	}
	...
	while (true)
	{
		...
		func_202(Var0.f_0);
		func_195(&iLocal_93, &(Var0.f_9), Var61);
		if (Var0.f_0 == 44)
		{
			func_187(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_94);
			func_186();
		}
		else if (Var0.f_0 == 45)
		{
			func_187(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_95);
			func_184(&Var0);
		}
		if (func_169(&Var0, 0))
		{
...
int func_2(int iParam0)
{
	...
	if (!func_168())
	{
		while (!func_159(*iParam0))
		{
			...
			if (!func_203(iParam0, *iParam0 != 2))
			{
				func_284("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_113(iParam0))
	{
		func_284("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_113(int iParam0)
{
	...
	if (func_143(&(iParam0->f_1)))
	{
		...
		func_114(*iParam0);
		iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&(iParam0->f_1), iParam0, 61, 44500);
		SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&(iParam0->f_1));
		if (CUTSCENE::HAS_CUTSCENE_LOADED())
		{
			func_284("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
		}
		else
		{
			func_284("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_134(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_140(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
int func_143(char* sParam0)
{
	...
	func_284("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}
...
void func_148()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_149(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10,5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_149(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_159(int iParam0)
{
	...
	iVar0 = func_161(&(Global_112002[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
int func_166()
{
	return func_167(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}
	...
	switch (iParam0->f_16)
	{
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_175(2))
							{
								if (func_173(iParam0->f_27))
								{
									...
									func_284("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_127(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245,8885f, 371,9034f, 103,9884f, 241,5898f, 359,6458f, 107,3461f, 1,25f, false, true, 0))
					{
						if (func_175(2))
						{
							...
							{
								func_172(iParam0->f_27, *iParam0);
								func_284("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*iParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728,948f, 4143,44f, 42,29295f, 2722,213f, 4144,521f, 45,43182f, 10f, false, true, 0))
				{
					if (func_175(2))
					{
						...
						{
							func_172(1, *iParam0);
							func_284("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983,5426f, 369,1104f, 68,46017f, -1028,566f, 395,4613f, 94,57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983,875f, 346,7556f, 68,02096f, -1021,451f, 336,3458f, 93,18714f, 14,5f, false, true, 0))
						{
							if (func_175(2))
							{
								...
								{
									func_172(iParam0->f_27, *iParam0);
									func_284("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_172(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_284("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_284("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_183()) || Global_111962) || Global_31508) || func_182()) || func_181(8, -1)) || func_93()) || func_180()) || func_179()) || func_178()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_183()) || Global_31508) || func_182()) || func_181(8, -1)) || func_179()) || func_93()) || func_180()) || func_178()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_183()) || Global_111962) || Global_31508) || func_182()) || func_181(8, -1)) || func_179()) || func_93()) || func_180()) || func_178()) || Global_112915.f_7688.f_919[iVar0] == 5) || Global_43143 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_183()) || Global_111962) || Global_31508) || func_182()) || func_181(8, -1)) || func_93()) || func_180()) || func_178()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_183() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_181(8, -1)) || func_178()) || func_177()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_183()) || Global_31508) || func_182()) || func_181(8, -1)) || func_180()) || func_179()) || func_178()) || Global_112915.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_183()) || func_180()) || Global_111962) || Global_31508) || func_182()) || Global_43774) || func_181(8, -1)) || func_179()) || func_177()) || func_178()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_183()) || Global_111962) || Global_31508) || func_182()) || func_181(8, -1)) || func_179()) || func_177()) || func_93()) || func_180()) || func_178())
						{
							return 0;
						}
						break;
...
void func_184(int iParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_98) > 1250)
	{
		if (func_127(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_127(PLAYER::PLAYER_PED_ID()) && !func_185(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true) };
				Var3 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				fVar7 = (Var3.f_0 - Var0.f_0);
...
bool func_185(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_186()
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_96, "SET_COLOUR");
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_96, "SET_DISTANCE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	HUD::SET_TEXT_RENDER_ID(iLocal_97);
	fVar0 = 0,1f;
	fVar1 = 0,24f;
	fVar2 = 0,21f;
	fVar3 = 0,51f;
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_96, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((MISC::GET_GAME_TIMER() - iLocal_98) > 1250)
	{
		AUDIO::PLAY_SOUND_FROM_COORD(iLocal_99, "IDLE_BEEP", 2468,51f, 3437,39f, 49,9f, "EPSILONISM_04_SOUNDSET", false, 0, false);
		iLocal_98 = MISC::GET_GAME_TIMER();
	}
}

int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_175(2))
		{
			if (!func_146())
			{
				if ((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					func_284("start conversation");
					uVar0 = 16;
					if (*uParam8 == 0)
					{
						func_193(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_191(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
					{
						func_284("conversation ended");
						*uParam8 = 3;
						return 1;
					}
				}
			}
			else if (func_189(sParam5))
			{
				if (!*uParam8 == 1)
				{
					if (func_127(PLAYER::PLAYER_PED_ID()))
					{
						if (func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
						{
							func_284("pause conversation");
							func_188(1);
							*uParam8 = 1;
						}
					}
			...
			if (func_194(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8 == 1)
			{
				func_284("unpause conversation");
				func_188(0);
				*uParam8 = 2;
			}
		}
...
void func_191(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_192(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_192(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
float func_194(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_195(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_194(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_198(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_194(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_200(iParam0);
				}
			}
...
int func_203(int iParam0, bool bParam1)
{
	...
	if (Global_77852)
	{
		func_284("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_110(*iParam0, &Var0);
	if ((func_240(*iParam0) || func_238(*iParam0)) || Global_78097 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_284("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_234(*iParam0))
	{
		if (*iParam0 == 19)
		{
			func_233(iParam0->f_28[0]);
		}
		func_284("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (iParam0->f_25 == 1)
	{
	...
	if (*iParam0 == 10)
	{
		...
		{
			func_284("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_284("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_207(&(iParam0->f_48)) && bParam1)
	{
		func_204(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}
...
void func_204(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_206(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_205(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_206(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_205(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
void func_208(var uParam0)
{
	...
	if (*uParam0 == 52)
	{
		func_209(&(uParam0->f_41[1]));
		func_209(&(uParam0->f_41[2]));
	}
	if (func_127(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
	...
	if (func_126(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_174(iVar2))
						{
							...
							{
								if (func_174(uParam0->f_35[iVar0]))
								{
									if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar2, uParam0->f_35[iVar0]))
									{
										func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_174(iVar3))
						{
							...
							{
								func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_212(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
								func_284("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
	...
	if (func_126(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_284("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_284("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_284("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_232(*uParam0))
					{
						if (!func_158(*uParam0))
						{
							if (func_227(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_208(uParam0);
								...
								func_284("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_284("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_215(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_208(uParam0);
							...
							func_284("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_214(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_284("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_284("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_127(uParam0->f_41[0]))
						{
...
int func_215(int iParam0, float fParam1)
{
	...
	{
		if (func_226(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
{
	return func_217(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
	
	iVar4 = func_225(iParam0, iParam1);
	if (!func_127(iParam0) || !func_127(iParam1))
	{
		if (iVar4 != -1)
		{
			func_224(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	if (!func_221(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar4 == -1)
	...
	uVar0 = func_218(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_218(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_223(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_223(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_222(Var3, Var0);
...
float func_222(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_223(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_231(iParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_228(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_228(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_229(int iParam0, float fParam1)
{
	...
	{
		if (func_230(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_230(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_223(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
{
	if ((func_239() && Global_99974.f_11 == 6) && iParam0 == func_167(&(Global_99974.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_242()
{
	iLocal_96 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_96))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
		iLocal_97 = HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
	}
	iLocal_99 = AUDIO::GET_SOUND_ID();
	iLocal_98 = MISC::GET_GAME_TIMER();
}
...
int func_243(int iParam0)
{
	...
	func_284("Created initial scene");
	return 1;
}
...
int func_244(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_252(&(uParam0->f_48), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_251(&iVar0) || !func_250(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			{
				if (!func_247(&(uParam0->f_28[0]), 69, 2319,443f, 2583,588f, 46,7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
			...
			{
				func_245(&(uParam0->f_35[0]), iVar0[1], 2331,08f, 2573,53f, 46,13f, 358,61f);
			}
			if (bVar4)
			{
				iLocal_91 = 3;
		...
		case 3:
			VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314,546f, 2576,33f, 44,7f, 2326,446f, 2579,608f, 47,6645f, false, true);
			MISC::CLEAR_AREA_OF_VEHICLES(2321,252f, 2578,851f, 46,7f, 10f, false, false, false, false, false, false, 0);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
...
void func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_246(iParam0);
...
int func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_248(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_252(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_252(&(uParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_247(&(uParam0->f_28[0]), 69, 2468,51f, 3437,39f, 49,9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			if ((func_127(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
int func_255(int iParam0)
{
	...
	if (Global_77852)
	{
		func_284("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_112915.f_9085 && !func_108(1))
	{
		func_284("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_256(iParam0))
	{
		Global_112002[iParam0 /*10*/].f_1 = 1;
		func_284("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_99974.f_11 == 6)
	{
		if (Global_99974 < 9)
		{
			...
			{
				func_284("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112002[iParam0 /*10*/].f_1 = 1;
		func_284("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
int func_264(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	...
	func_284("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}
...
void func_267(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 45)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(2314,546f, 2576,33f, 44,7f, 2326,446f, 2579,608f, 47,6645f, true, true);
	}
	if (bParam1)
	{
		func_284("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		if (*iParam0 == 44 && ENTITY::DOES_ENTITY_EXIST(iParam0->f_41[1]))
		{
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iParam0->f_41[1]));
		}
		func_272(iParam0, 0, 0, 0);
	}
	func_271(&(iParam0->f_48));
	if (iLocal_93 != -1)
	{
		func_284("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_201(&iLocal_93);
	}
	switch (*iParam0)
	{
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_279(uParam0, iParam1);
	func_276(uParam0, bParam2);
	func_273(uParam0, bParam3);
}

void func_273(var uParam0, bool bParam1)
{
	func_274(&(uParam0->f_41), bParam1);
}
...
void func_280(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_281(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_281(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_286()
{
	func_284("Running start routines.");
	Global_112633++;
}
