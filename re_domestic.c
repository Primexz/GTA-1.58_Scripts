	...
	switch (iLocal_70)
	{
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_58))
			{
				if (!PED::IS_PED_INJURED(iLocal_58))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_58, Local_112, Global_19, true, true, 0) && func_115(1, 0, 1))
					{
	...
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 8f, 8f, 8f, false, true, 0) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID()))
		{
			...
			else
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_100))
				{
					iLocal_100 = func_121(Local_112, 1);
				}
				if (func_54() == 2 && !func_47())
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_101))
					{
						iLocal_101 = func_121(Local_118, 0);
...
int func_121(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_127()
{
	if (!PED::IS_PED_INJURED(iLocal_58))
	{
		...
		{
			PED::SET_PED_AS_GROUP_MEMBER(iLocal_58, func_128());
	...
	switch (iLocal_69)
	{
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_58) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_121[8], true) + Vector(0f, 0,39f, 0,35f), 1f, -1, 0f, 512, func_133(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_121[8], true)));
...
int func_143()
{
	switch (func_144(&Global_31565, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_156()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_58))
	{
		if (func_159(iLocal_58) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), true))
		{
			func_157();
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_57))
	{
		if (func_159(iLocal_57) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), true))
		{
			func_157();
		}
	}
...
int func_183(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_219(Global_112915.f_24995.f_43[iParam3]))
		{
			return 0;
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_197(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_217()) || Global_31508) || func_216()) || func_77(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_111962) || Global_31508) || func_216()) || func_77(8, -1)) || func_215()) || func_214()) || func_212()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_217() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_77(8, -1)) || func_212()) || func_211()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_217()) || func_214()) || Global_111962) || Global_31508) || func_216()) || Global_43774) || func_77(8, -1)) || func_213()) || func_211()) || func_212()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
