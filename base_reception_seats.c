...
bool func_5(var uParam0)
{
	...
	func_7(uParam0, uParam0->f_85.f_2, &sVar0);
	func_7(uParam0, uParam0->f_85.f_2, &sVar4);
...
{
	if (func_8(&(uParam0->f_85), 7))
	{
		Stack.Push(uParam0[iParam1 /*14*/]);
		Stack.Push(iParam1);
		Stack.Push(sParam2);
		Call_Loc(uParam0->f_85.f_14);
	}
	else
	{
...
void func_11(var uParam0)
{
	...
	Var20 = { *(uParam0[uParam0->f_85.f_2 /*14*/]) };
	switch (uParam0->f_85.f_4)
	{
		case 0:
			func_53(&(uParam0->f_85), 11);
			func_52(uParam0, 1);
			break;
		...
		case 1:
			if (func_51(uParam0))
			{
				uParam0->f_85.f_6 = MISC::GET_GAME_TIMER();
				func_52(uParam0, 2);
			}
			break;
		
		case 2:
			if (func_50(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				...
				else if (uParam0->f_85.f_5 == -1)
				{
					if ((MISC::GET_GAME_TIMER() - uParam0->f_85.f_6) > 150)
					{
						func_45(&(uParam0->f_85.f_5), 4, "MPJAC_SIT", 0, 0, 0, 0);
					}
				}
		...
		case 5:
			...
			{
				uParam0->f_85.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_85.f_1, &sVar0, &sVar16, 2f, -1000f, 13, 16, 1,5f, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
				uParam0->f_85.f_8.f_4 = MISC::GET_GAME_TIMER();
				func_25(&(uParam0->f_85), 8);
				func_52(uParam0, 6);
			}
			break;
		
		case 6:
			if (func_8(&(uParam0->f_85), 10))
			{
				func_53(&(uParam0->f_85), 10);
				func_24(uParam0);
			}
			func_26(uParam0);
			func_18(uParam0);
			iVar42 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar42))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar42) >= 1f)
				{
					...
					func_40(uParam0, &sVar16);
					uParam0->f_85.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_85.f_1, &sVar0, &sVar16, 4f, -1,5f, 13, 16, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
					func_25(&(uParam0->f_85), 8);
					func_25(&(uParam0->f_85), 11);
				}
				else
				{
					func_53(&(uParam0->f_85), 8);
				}
			}
			else if (!func_8(&(uParam0->f_85), 8))
			{
				func_52(uParam0, 8);
			}
			break;
		...
		case 7:
			NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
			func_52(uParam0, 8);
			break;
		
		case 8:
			iVar43 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
...
void func_12(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (iVar1 != uParam0->f_85.f_8.f_1)
		{
			if (iVar1 == 0)
			{
				iVar0 = (11 + uParam0->f_85.f_8.f_1);
			}
			else
			{
				iVar0 = (6 + iVar1);
		...
		{
			iVar0 = uParam0->f_85.f_8.f_2;
		}
		iVar1 = uParam0->f_85.f_8.f_1;
	}
	else if (uParam0->f_85.f_8.f_2 == 5)
	{
		iVar1 = uParam0->f_85.f_8.f_1;
		iVar2 = 3;
		iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, iVar2);
		if (iVar0 == uParam0->f_85.f_8.f_3)
		{
			iVar0 = (iVar0 + 1 % iVar2);
		}
	}
	else
	{
		...
		if ((MISC::GET_GAME_TIMER() - uParam0->f_85.f_8.f_4) >= 90000)
		{
			iVar1 = func_13(uParam0);
			if (iVar1 != uParam0->f_85.f_8.f_1)
			{
	...
	uParam0->f_85.f_8.f_3 = uParam0->f_85.f_8.f_2;
	uParam0->f_85.f_8.f_2 = iVar0;
	uParam0->f_85.f_8.f_1 = iVar1;
}

int func_13(var uParam0)
{
	if (uParam0->f_85.f_8 == 2)
	{
		return uParam0->f_85.f_8.f_1;
	}
	return (uParam0->f_85.f_8.f_1 + 1 % func_14(uParam0->f_85.f_8));
}
...
void func_18(var uParam0)
{
	...
	if (uParam0->f_85.f_4 == 6)
	{
		Var0 = { PAD::GET_CONTROL_NORMAL(0, 218), PAD::GET_CONTROL_NORMAL(0, 219), 0f };
		fVar3 = SYSTEM::VMAG(Var0);
		if ((uParam0->f_85.f_4 == 6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -1322051853)) && !func_8(&(uParam0->f_85), 12))
		{
			if (fVar3 >= 0,35f)
			{
				func_23(uParam0);
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_8(&(uParam0->f_85), 0)) && !func_8(&(uParam0->f_85), 4)) && !func_21()) && !func_19(1)) && uParam0->f_85.f_8.f_2 != 3)
			{
				if (uParam0->f_85.f_5 == -1)
				{
					func_45(&(uParam0->f_85.f_5), 4, "MPJAC_EXIT", 0, 0, 0, 0);
				}
				if (uParam0->f_85.f_4 == 6)
				{
...
void func_23(var uParam0)
{
	...
	if (((func_13(uParam0) != uParam0->f_85.f_8.f_1 && uParam0->f_85.f_8.f_2 < 6) && uParam0->f_85.f_8.f_2 != 3) && uParam0->f_85.f_8.f_2 != 4)
	{
		func_12(uParam0, 1);
		func_41(uParam0, &sVar0);
		func_40(uParam0, &sVar16);
...
void func_24(var uParam0)
{
	...
	uParam0->f_85.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
	func_41(uParam0, &sVar0);
	NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_85.f_1, &sVar0, "exit", 4f, -4f, 13, 16, 1000f, 0);
	NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_85.f_1);
	func_9(&(uParam0->f_85.f_5));
	func_52(uParam0, 8);
}
...
Vector3 func_38(var uParam0)
{
	...
	Var0 = { (uParam0[uParam0->f_85.f_2 /*14*/])->f_8.f_3 };
	if (func_16() && uParam0->f_85.f_8 == 0)
	{
...
{
	return (uParam0[uParam0->f_85.f_2 /*14*/])->f_8;
}

void func_40(var uParam0, char* sParam1)
{
	switch (uParam0->f_85.f_8.f_2)
	{
		case 0:
...
{
	uParam0->f_85.f_8 = func_44((*uParam0)[uParam0->f_85.f_2 /*14*/]);
	uParam0->f_85.f_8.f_1 = func_43(uParam0);
	uParam0->f_85.f_8.f_2 = 3;
	uParam0->f_85.f_8.f_3 = 3;
}
...
int func_43(var uParam0)
{
	...
	switch (uParam0->f_85.f_8)
	{
		...
		default:
			iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, func_14(uParam0->f_85.f_8));
	}
	return iVar0;
}
...
{
	Stack.Push(!func_8(&(uParam0->f_85), 5));
	Stack.Push(uParam0[uParam0->f_85.f_2 /*14*/]);
	Stack.Push(uParam0->f_85.f_2);
	Call_Loc(uParam0->f_85.f_13);
...
int func_47(var uParam0)
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if ((iVar1 != PLAYER::PLAYER_ID() && func_48(iVar1, 1, 1)) && func_50(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_85.f_2 /*14*/]))
			{
				return 1;
			}
		}
...
int func_51(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		{
			uParam0->f_85.f_2 = (uParam0->f_85.f_2 + 1 % 6);
		}
		iVar0++;
	}
	return 0;
...
void func_54(var uParam0)
{
	...
	else if (uParam0->f_85.f_4 > 1)
	{
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_55(uParam0));
		uParam0->f_85.f_7 = MISC::GET_FRAME_COUNT();
	}
	else if ((MISC::GET_FRAME_COUNT() - uParam0->f_85.f_7) < 5)
	{
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_55(uParam0));
	}
}
...
{
	switch ((*uParam0)[uParam0->f_85.f_2 /*14*/])
	{
		case 12:
		case 10:
		case 6:
...
{
	func_57(&(uParam0->f_85), 4, func_58());
	func_57(&(uParam0->f_85), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false));
	func_57(&(uParam0->f_85), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true));
	func_57(&(uParam0->f_85), 0, func_36(0));
	func_57(&(uParam0->f_85), 2, TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, 416,2457f, 4826,312f, -59,9997f, 376,9388f, 4827,659f, -56,95424f, 15f, false, true, 0);
}
...
int func_73()
{
	if (Global_1852971 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1852971, true, 0))
		{
			return 0;
		}
		NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, Global_1852971);
		func_85(0, -1, 0);
...
void func_74()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_77(2, &uLocal_91, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_77(3, &uLocal_91, &iVar0);
	iVar0[0] = 4;
	iVar0[1] = 5;
	func_77(4, &uLocal_91, &iVar0);
	func_75(&uLocal_91, 6662);
}

void func_75(var uParam0, int iParam1)
{
	uParam0->f_85.f_13 = iParam1;
	func_25(&(uParam0->f_85), 5);
}

int func_76(var uParam0, int iParam1)
{
	if ((iParam1 == 0 || iParam1 == 1) && (TASK::IS_SCENARIO_GROUP_ENABLED("FACILITY_MAIN_3") || TASK::IS_SCENARIO_GROUP_ENABLED("FACILITY_MAIN_2")))
	{
		return 0;
	}
	return 1;
...
void func_77(int iParam0, var uParam1, int iParam2)
{
	...
	func_84(iParam0, &Var0, &fVar3);
	iVar4 = 0;
	while (iVar4 < 2)
	{
		(*uParam1)[(*iParam2)[iVar4] /*14*/] = 2;
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8 = { func_80(func_81(iVar4), fVar3) + Var0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1 = { func_80(func_79(iVar4), fVar3) + Var0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3 = { func_80(func_78(iVar4), fVar3) + Var0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_6 = 1,42f;
		iVar4++;
	}
}
...
Vector3 func_81(int iParam0)
{
	...
	{
		case 0:
			return Vector(-59,42f, 4832,75f, 391,558f) - func_82();
		
		case 1:
			return Vector(-59,42f, 4832,75f, 392,858f) - func_82();
...
Vector3 func_82()
{
	return func_83() + Vector(0f, -8,946f, 47,215f);
}
