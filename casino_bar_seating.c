...
void func_1(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
			...
			if (func_57(PLAYER::PLAYER_PED_ID(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_56(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						...
						{
							if (func_41(uParam0->f_9) && !Global_262145.f_26719)
							{
		...
		case 4:
			...
			Var20 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0f, 2) };
			Var23 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar26 = Var23.f_2;
			fVar27 = 0,05f;
		...
		case 5:
			...
			Var29 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_31(uParam0), func_30(uParam0), 0f, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_16(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar32, 5f))
			{
				...
				PAD::DISABLE_CONTROL_ACTION(0, 0, true);
				uParam0->f_8 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_31(uParam0), func_30(uParam0), 2, true, false, 1f, 0f, 1,12f);
...
void func_36(int iParam0)
{
	...
	while (iVar0 < 3)
	{
		if (Global_2359296[func_37() /*5559*/].f_675.f_4239[iVar0 /*3*/] == iParam0)
		{
...
{
	uParam0->f_1.f_1 = func_40(uParam0->f_16[uParam0->f_9 /*14*/].f_13);
...
{
	return func_48(iParam0) == joaat("weapon_minigun");
}
...
int func_50(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar11]) && !PED::IS_PED_INJURED(uVar0[iVar11])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar11])) && func_57(uVar0[iVar11], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar11++;
...
int func_51(var uParam0)
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_57(PLAYER::GET_PLAYER_PED(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_52(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
int func_56(int iParam0, struct<3> Param1, int iParam4)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (iParam4 == 3 || iParam4 == 4)
		{
			if (func_16(ENTITY::GET_ENTITY_HEADING(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_16(ENTITY::GET_ENTITY_HEADING(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
int func_66()
{
	...
	if (func_80(PLAYER::PLAYER_ID()) && CAM::IS_SCREEN_FADED_OUT())
	{
		return 1;
	}
	if (func_69())
...
int func_80(int iParam0)
{
	...
	{
		if (func_82(iParam0) && !func_81(iParam0))
		{
			return 1;
		}
	}
...
void func_102()
{
	func_103(0, &uLocal_128, 0, 1);
	func_103(1, &uLocal_128, 1, 1);
	func_103(2, &uLocal_128, 2, 1);
	func_103(3, &uLocal_128, 3, 1);
	func_103(4, &uLocal_128, 4, 1);
	func_103(5, &uLocal_128, 5, 1);
	func_103(6, &uLocal_128, 6, 1);
	func_103(7, &uLocal_128, 7, 1);
	func_103(8, &uLocal_128, 8, 1);
	func_103(9, &uLocal_128, 9, 1);
	func_103(10, &uLocal_128, 10, 1);
	func_103(11, &uLocal_128, 11, 1);
	func_103(12, &uLocal_128, 12, 1);
	func_103(13, &uLocal_128, 13, 1);
	func_103(14, &uLocal_128, 14, 1);
	func_103(15, &uLocal_128, 15, 1);
	func_103(16, &uLocal_128, 16, 1);
	func_103(17, &uLocal_128, 17, 1);
	func_103(18, &uLocal_128, 18, 1);
	func_103(19, &uLocal_128, 19, 1);
	func_103(20, &uLocal_128, 20, 1);
	func_103(21, &uLocal_128, 21, 1);
	func_103(22, &uLocal_128, 22, 1);
	func_103(23, &uLocal_128, 23, 1);
	func_103(24, &uLocal_128, 24, 1);
	func_103(25, &uLocal_128, 25, 1);
	func_103(26, &uLocal_128, 26, 1);
	func_103(27, &uLocal_128, 27, 1);
	func_103(28, &uLocal_128, 28, 1);
	func_103(29, &uLocal_128, 29, 1);
	func_103(30, &uLocal_128, 30, 1);
}
...
void func_103(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_108(iParam0, &Var0, &fVar3);
	uParam1->f_16[iParam2 /*14*/].f_13 = iParam3;
	uParam1->f_16[iParam2 /*14*/] = { Var0 };
	uParam1->f_16[iParam2 /*14*/].f_3 = { 0f, 0f, fVar3 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_105(func_107(), func_106(iParam3, fVar3)) + Var0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_105(func_104(), func_106(iParam3, fVar3)) + Var0 };
...
Vector3 func_105(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_106(int iParam0, float fParam1)
{
	switch (iParam0)
	{
		case 1:
...
void func_108(int iParam0, var uParam1, var uParam2)
{
	if (func_4())
	{
		...
		{
			case 0:
				*uParam1 = { 1120,862f, 212,423f, -50,4401f };
				*uParam2 = -124,25f;
				break;
			
			case 1:
				*uParam1 = { 1120,2f, 211,123f, -50,4401f };
				*uParam2 = -115,25f;
				break;
			
			case 2:
				*uParam1 = { 1119,816f, 209,848f, -50,4401f };
				*uParam2 = -106,5f;
				break;
			
			case 3:
				*uParam1 = { 1119,618f, 208,511f, -50,4401f };
				*uParam2 = -96,25f;
				break;
			
			case 4:
				*uParam1 = { 1119,54f, 207,185f, -50,4401f };
				*uParam2 = -99,5f;
				break;
			
			case 5:
				*uParam1 = { 1118,818f, 204,723f, -50,4401f };
				*uParam2 = -117,25f;
				break;
			
			case 6:
				*uParam1 = { 1118,193f, 203,635f, -50,4401f };
				*uParam2 = -127,75f;
				break;
			
			case 7:
				*uParam1 = { 1117,355f, 202,623f, -50,4401f };
				*uParam2 = -137,25f;
				break;
			
			case 8:
				*uParam1 = { 1116,384f, 201,823f, -50,4401f };
				*uParam2 = -147,5f;
				break;
			
			case 9:
				*uParam1 = { 1115,254f, 201,136f, -50,4401f };
				*uParam2 = -157,75f;
				break;
			
			case 10:
				*uParam1 = { 1114,046f, 200,698f, -50,4401f };
				*uParam2 = -167,75f;
				break;
			
			case 11:
				*uParam1 = { 1112,791f, 200,235f, -50,4401f };
				*uParam2 = -158f;
				break;
			
			case 12:
				*uParam1 = { 1111,561f, 199,51f, -50,4401f };
				*uParam2 = -148f;
				break;
			
			case 13:
				*uParam1 = { 1130,482f, 239,144f, -51,0408f };
				*uParam2 = 152,93f;
				break;
			
			case 14:
				*uParam1 = { 1129,412f, 239,844f, -51,0408f };
				*uParam2 = 130,68f;
				break;
			
			case 15:
				*uParam1 = { 1128,693f, 240,931f, -51,0408f };
				*uParam2 = 109,18f;
				break;
			
			case 16:
				*uParam1 = { 1128,732f, 243,531f, -51,0408f };
				*uParam2 = 66,43f;
				break;
			
			case 17:
				*uParam1 = { 1129,494f, 244,656f, -51,0408f };
				*uParam2 = 44,43f;
				break;
			
			case 18:
				*uParam1 = { 1130,592f, 245,344f, -51,0408f };
				*uParam2 = 20,43f;
				break;
			
			case 19:
				*uParam1 = { 1133,189f, 245,344f, -51,0408f };
				*uParam2 = -25,32f;
				break;
			
			case 20:
				*uParam1 = { 1134,295f, 244,606f, -51,0408f };
				*uParam2 = -48,07f;
				break;
			
			case 21:
				*uParam1 = { 1135,011f, 243,469f, -51,0408f };
				*uParam2 = -68,32f;
				break;
			
			case 22:
				*uParam1 = { 1125,608f, 252,885f, -51,0408f };
				*uParam2 = -27,82f;
				break;
			
			case 23:
				*uParam1 = { 1126,656f, 252,185f, -51,0408f };
				*uParam2 = -48,32f;
				break;
			
			case 24:
				*uParam1 = { 1127,391f, 251,06f, -51,0408f };
				*uParam2 = -69,57f;
				break;
			
			case 25:
				*uParam1 = { 1127,354f, 248,448f, -51,0408f };
				*uParam2 = -116,07f;
				break;
			
			case 26:
				*uParam1 = { 1126,609f, 247,36f, -51,0408f };
				*uParam2 = -136,82f;
				break;
			
			case 27:
				*uParam1 = { 1125,499f, 246,623f, -51,0408f };
				*uParam2 = -159,32f;
				break;
			
			case 28:
				*uParam1 = { 1122,905f, 246,673f, -51,0408f };
				*uParam2 = 153,5f;
				break;
			
			case 29:
				*uParam1 = { 1121,809f, 247,398f, -51,0408f };
				*uParam2 = 131,75f;
				break;
			
			case 30:
				*uParam1 = { 1121,087f, 248,548f, -51,0408f };
				*uParam2 = 111,75f;
				break;
		}
	}
