...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112002[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_259(&(Global_112002[Var0.f_0 /*10*/].f_9));
			}
		}
		func_246(&Var0, 1);
	}
	iVar64[0] = 35;
	if (!func_243(&iVar64, &Var0, Var61, 1f))
	{
		func_242();
		func_260("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (!func_234(Var0.f_0))
	{
		func_242();
		func_260("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (func_233(Var0.f_0))
	{
		func_242();
		func_260("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	...
	func_231(&Var0);
	iLocal_92 = PED::ADD_SCENARIO_BLOCKING_AREA(Var61 - Vector(20f, 20f, 20f), Var61 + Vector(20f, 20f, 20f), false, true, true, true);
	...
	while (true)
	{
		...
		func_192(Var0.f_0);
		func_184(&iLocal_91, &(Var0.f_9), Var61);
		if (func_169(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
{
	iParam0->f_16 = 5;
	iParam0->f_17[0 /*3*/] = { 1973,324f, 3815,594f, 31,42936f };
	iParam0->f_17[1 /*3*/] = { 1974,936f, 3812,747f, 34,438f };
	iParam0->f_24 = 6,5f;
	iParam0->f_27 = 0;
...
int func_243(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_244((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_244((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_244(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_245(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_245(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
