...
void func_11(var uParam0)
{
	...
	Var20 = { *(uParam0[uParam0->f_57.f_2 /*14*/]) };
	switch (uParam0->f_57.f_4)
	{
		...
		case 5:
			...
			{
				uParam0->f_57.f_1 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_39(uParam0), func_38(uParam0), 2, true, false, 1f, 0f, 1f);
		...
		case 6:
			...
			func_26(uParam0);
			func_18(uParam0);
			iVar42 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_57.f_1);
		...
		case 8:
			iVar43 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_57.f_1);
...
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, 451,6327f, 4829,453f, -54,97165f, 499,981f, 4842,034f, -50,67961f, 30,75f, false, true, 0);
}
...
int func_73()
{
	if (Global_1852971 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_entrance_seats", Global_1852971, true, 0))
		{
			return 0;
		}
...
void func_74()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_75(0, &uLocal_91, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_75(1, &uLocal_91, &iVar0);
}
...
void func_75(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar4 < 2)
	{
		...
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8 = { func_78(func_79(iVar4), fVar3) + Var0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_8.f_3 = { 0f, 0f, (fVar3 + 174f) };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1 = { func_78(func_77(iVar4), fVar3) + Var0 };
		(uParam1[(*iParam2)[iVar4] /*14*/])->f_1.f_3 = { func_78(func_76(iVar4), fVar3) + Var0 };
