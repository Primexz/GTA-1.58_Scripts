...
void func_24(char* sParam0)
{
	...
	if (iVar0 == 2)
	{
		StringCopy(sParam0, "dadwhatthefuck", 64);
	}
	else if (iVar0 == 0)
	{
		StringCopy(sParam0, "jessie_ig_2_yeahyeahyeah", 64);
	}
	else if (iVar0 == 1)
	{
		StringCopy(sParam0, "its_all_good_my_dads_really_happy_with_me", 64);
	}
}
...
{
	StringCopy(sParam1, "Special_Ped@jessie", 32);
	switch (iParam0)
	{
		case 1:
			StringCopy(sParam2, "jessie_ig_1_p1_heydudes", 64);
			break;
		
		case 2:
			StringCopy(sParam2, "jessie_ig_1_p2_gottahavefaith", 64);
			break;
		
		case 3:
			StringCopy(sParam2, "jessie_ig_1_p3_lifeiscoolbutsoisdeath", 64);
			break;
		
		case 4:
			StringCopy(sParam2, "jessie_ig_1_p4_sentheretoclearthingsup", 64);
			break;
		
		case 5:
			StringCopy(sParam2, "jessie_ig_1_p5_heressomthinginteresting", 64);
			break;
		
		case 6:
			StringCopy(sParam2, "jessie_ig_1_p6_haveyoueverwondered", 64);
			break;
		
		case 7:
			StringCopy(sParam2, "jessie_ig_1_p7_importanttomakethingsclear", 64);
			break;
		
		case 8:
			StringCopy(sParam2, "jessie_ig_1_p8_thingsareallreallycool", 64);
			break;
		
		case 9:
			StringCopy(sParam2, "jessie_ig_1_p9_whothehellwalks", 64);
			break;
		
		case 10:
			StringCopy(sParam2, "jessie_ig_1_p10_theresthiskidiknow", 64);
			break;
		
		case 11:
			StringCopy(sParam2, "jessie_ig_1_p11_canyouimagine", 64);
			break;
		
		case 12:
			StringCopy(sParam2, "jessie_ig_1_p12_likeiusedtobe", 64);
			break;
		
		case 13:
			StringCopy(sParam2, "jessie_ig_1_p13_likeispoketomydad", 64);
			break;
		
		case 14:
			StringCopy(sParam2, "if_you_want_to_get_baked", 64);
			break;
		
		case 15:
			StringCopy(sParam2, "i_love_chill_people", 64);
			break;
	}
}
...
void func_105()
{
	iLocal_36 = joaat("u_m_m_jesus_01");
	StringCopy(&Local_234, "PBJS", 8);
	StringCopy(&Local_236, "JESSE", 16);
	StringCopy(&Local_202, "Special_Ped@jessie", 64);
	StringCopy(&Local_218, "Base", 64);
	bLocal_436 = true;
	iLocal_252 = 15;
	sLocal_303 = "PBJS_INTERACT";
	StringCopy(&Local_312, "PBJS_CONV_GM", 16);
	StringCopy(&Local_316, "PBJS_CONV_GT", 16);
	StringCopy(&Local_320, "PBJS_CONV_GF", 16);
	StringCopy(&cLocal_324, "special_ped@jessie@base", 64);
	StringCopy(&cLocal_340, "special_ped@jessie@intro", 64);
	iLocal_251 = 7;
	iLocal_255[0] = 8;
	iLocal_255[1] = 6;
	iLocal_255[2] = 6;
