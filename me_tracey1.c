...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (iLocal_626 > MISC::GET_GAME_TIMER())
		{
...
int func_2()
{
	switch (iLocal_94)
	{
		...
		case 4:
			if ((MISC::GET_GAME_TIMER() - iLocal_308) > 15000)
			{
				func_28(&uLocal_96, 3);
...
int func_30(int iParam0)
{
	...
	if (CLOCK::GET_CLOCK_DAY_OF_MONTH() != iLocal_301)
	{
		iVar0 = (60 * ((24 - iLocal_302) + CLOCK::GET_CLOCK_HOURS()));
		iVar0 = ((iVar0 - iLocal_303) + CLOCK::GET_CLOCK_MINUTES());
	}
	else
	{
		iVar0 = (((60 * CLOCK::GET_CLOCK_HOURS()) + CLOCK::GET_CLOCK_MINUTES()) - (iLocal_303 + (60 * iLocal_302)));
	}
	if (iVar0 >= (60 * iParam0))
	{
		return 1;
...
{
	HUD::CLEAR_THIS_PRINT(Local_341[iParam0 /*3*/].f_2);
}
...
void func_40()
{
	...
	{
		case 0:
			if (VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_273) < 1f)
			{
				VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(iLocal_273, 10f);
			}
			if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_273) < 1f)
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(iLocal_273, 10f);
			}
			if (func_185(iLocal_273, 5f, 5, 1056964608, 0, 1, 0))
			{
				if (bLocal_533)
				{
					...
					TASK::TASK_LEAVE_VEHICLE(0, iLocal_273, 0);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_530, 1f, 20000, 0,25f, false, 40000f);
				...
				TASK::TASK_PERFORM_SEQUENCE(iLocal_289, iVar0);
				...
				MISC::CLEAR_AREA_OF_VEHICLES(Local_527, 8f, true, false, false, false, false, false, 0);
				if (!bLocal_533)
				{
					MISC::CLEAR_AREA_OF_VEHICLES(-820,2315f, 176,7027f, 70,6122f, 8f, true, false, false, false, false, false, 0);
				}
				if (bLocal_533)
				{
					iLocal_474 = MISC::GET_GAME_TIMER() + 10000;
					iLocal_473 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1315,612f, 402,8979f, 76,0077f, -26,827f, 0f, 175,0236f, 48,4f, false, 2);
				}
				else
				{
					iLocal_474 = MISC::GET_GAME_TIMER() + 5000;
					iLocal_473 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -840,7f, 185,3f, 78,4f, -14f, 0f, -110,4f, 48,4f, false, 2);
				}
				CAM::SET_CAM_ACTIVE(iLocal_473, true);
		...
		case 1:
			...
			if (!iLocal_472)
			{
				if (func_3(&uLocal_96, "MET1AUD", "MET1_ATHOME", 7, 0, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_474)
				{
					iLocal_472 = 1;
				}
			}
			...
			else if ((func_62(iLocal_289, Local_530, 2f) || (MISC::GET_GAME_TIMER() - iLocal_474) > 5000) || bLocal_475)
			{
				if (bLocal_476)
				{
					...
					iLocal_477 = 1;
					iLocal_478 = MISC::GET_GAME_TIMER() + 300;
				}
				else
				{
					iLocal_93 = 2;
			...
			if (!bLocal_533)
			{
				PED::SET_PED_RESET_FLAG(iLocal_289, 247, true);
			}
			break;
		...
		case 2:
			...
			else
			{
				if (bLocal_475)
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_289);
					ENTITY::SET_ENTITY_COORDS(iLocal_289, -813,7761f, 179,4943f, 71,1592f, false, false, false, true);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_289, false, false);
				}
				if (func_29())
				{
					func_60();
				}
				VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_273, 1, true);
				func_57(iLocal_289);
			}
			CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
			func_46(1, 1, 1, 1);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
			CAM::DESTROY_CAM(iLocal_473, false);
			func_41(0);
			break;
	}
}
...
void func_42(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_45(0) && Global_78098.f_1 == 1) && func_44(Global_78098))
		{
		}
		else
		{
	...
	if (Global_112915.f_9085 || func_45(0))
	{
		iVar0 = func_43();
...
void func_48(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_55(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_77663[1 /*14*/] = { func_118(iVar10, iParam1, iParam2, -1) };
		if (!func_117(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_77663[1 /*14*/] = { func_118(iVar10, iVar0, uVar11[iVar0], -1) };
				if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_77663[1 /*14*/] = { func_118(iVar10, 14, uVar28[iVar1], -1) };
							func_88(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
							func_110(14);
							if (Global_77661 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iVar0), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_78(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iVar0), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, iParam4);
						}
						func_110(iVar0);
						if (Global_77661 == 1)
						{
			...
			{
				Global_77663[1 /*14*/] = { func_118(iVar10, iVar0, func_77(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_77663[1 /*14*/] = { func_118(iVar10, 14, uVar69[iVar1], -1) };
			func_88(iParam0, Global_77663[1 /*14*/].f_12, Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4);
			func_110(14);
			if (Global_77661 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iParam1), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_78(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_78(iParam1), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, iParam4);
		}
		if (Global_77661 == 1)
		{
			iVar2 = 0;
...
int func_69(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_182(iParam0, Global_112915.f_2363.f_539[iVar0 /*65*/].f_64, Global_112915.f_2363.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_77663[1 /*14*/] = { func_118(iParam0, iParam1, iParam2, -1) };
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_182(iParam0, Global_112915.f_2363.f_539[iVar0 /*65*/].f_61, Global_112915.f_2363.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_89(ENTITY::GET_ENTITY_MODEL(iParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3)))
			{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_95(iParam1, Var16.f_0, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_103(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[0], Global_112915.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_103(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[1], Global_112915.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_103(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[2], Global_112915.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_102(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_102(Var16.f_2)] = func_95(iParam1, Var16.f_0, func_102(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_110(int iParam0)
{
	...
	{
		func_116(iParam0, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 2, Global_77663[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_111(Global_2883588, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_111(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_115(iParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		...
		func_112(iVar2, iVar3, iVar0, 1, 0);
	}
}

void func_112(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	iVar0 = Global_2821895[iParam0 /*3*/][func_113(iParam2)];
	if (iVar0 != 0)
	{
...
int func_114(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12597)
	{
		...
		iVar0 = Global_2821895[iParam0 /*3*/][func_113(iParam1)];
...
void func_120(int iParam0)
{
	...
	func_121(&(Global_77663[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_121(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_125(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_125(Global_2883588, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_114(func_124(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_114(func_123(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_114(iVar1, Global_77660, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_127(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_121(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_121(&(Global_77663[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_121(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			func_121(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_182(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_77663[1 /*14*/] = { func_118(iVar0, iParam1, iParam2, -1) };
	if (!MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_182(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_182(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_77663[2 /*14*/] = { func_118(iVar0, 14, iVar4, -1) };
									if (Global_77663[2 /*14*/].f_12 == iVar3)
									{
										if (func_182(iParam0, 14, iVar4))
										{
											if (!func_74(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_77663[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_77663[2 /*14*/] = { func_118(iVar0, iVar2, iVar1, -1) };
						if (!func_74(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_77663[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_77663[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_78(iParam1)) && Global_77663[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_78(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_185(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_187()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 0)
				{
					iLocal_297 = func_288(Local_527, 5, 1);
					iLocal_309 = 0;
					iLocal_310 = 0;
				}
				else
			...
			else
			{
				...
				{
					iLocal_298 = func_202(iLocal_273, 1, 5);
				}
				func_34(5);
				iLocal_305 = 1;
			}
		...
		case 1:
			...
			if (iLocal_305)
			{
				if (func_200(5))
				{
					if (MISC::GET_PROFILE_SETTING(203) == 0 || !func_29())
					{
						func_34(5);
					}
				}
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
				{
					...
					func_33(&iLocal_298);
					HUD::CLEAR_PRINTS();
					if (!PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
					{
						iLocal_306 = 1;
						iLocal_307 = 0;
						iLocal_298 = func_199(iLocal_289, 1, 1, 5);
					}
					else
					{
						iLocal_306 = 0;
				...
				else if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_289, 160f, 1))
				{
					sLocal_573 = "MET1ABANDON";
					iLocal_92 = 11;
					iLocal_93 = 0;
				}
				else if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_289, 60f, 1))
				{
					func_34(6);
				}
			}
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
			{
				iLocal_305 = 1;
				HUD::CLEAR_PRINTS();
				func_33(&iLocal_297);
			...
			{
				if (func_200(2) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_29()))
				{
					func_34(2);
				}
				...
				{
					iLocal_307 = 1;
					TASK::TASK_ENTER_VEHICLE(iLocal_289, iLocal_273, 20000, 0, 2f, 1, 0);
				}
				if (PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
				{
					iLocal_306 = 0;
				...
				{
					if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_289, 60f, 1))
					{
						func_34(6);
					}
				}
			...
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
			{
				iLocal_306 = 1;
				iLocal_307 = 0;
				HUD::CLEAR_PRINTS();
			...
			else if (iLocal_309)
			{
				if (iLocal_310)
				{
					if (MISC::GET_PROFILE_SETTING(203) == 0 || (iLocal_466 >= 4 && !func_29()))
					{
						func_34(3);
						iLocal_310 = 0;
					}
...
void func_188(int iParam0)
{
	if (iLocal_574 != iParam0)
	{
		...
		while (iLocal_572 <= 7)
		{
			...
			{
				if (!MISC::ARE_STRINGS_EQUAL(sLocal_575[iLocal_572], "NONE"))
				{
					AUDIO::START_AUDIO_SCENE(sLocal_575[iLocal_572]);
				}
				iLocal_574 = iParam0;
			}
			else if (AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_575[iLocal_572]))
			{
				AUDIO::STOP_AUDIO_SCENE(sLocal_575[iLocal_572]);
			}
			iLocal_572++;
		}
	}
...
int func_189()
{
	if (bLocal_533)
	{
		if (func_62(PLAYER::PLAYER_PED_ID(), Local_524, 30f))
		{
			return 1;
		}
	}
	else if (func_62(PLAYER::PLAYER_PED_ID(), -842,5665f, 159,2974f, 65,9426f, 11f))
	{
		return 1;
	}
	return 0;
...
int func_190()
{
	if (bLocal_533)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_527, 3,5f, 3,5f, 2f, true, true, 0))
		{
			return 1;
		}
	}
	else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_527, 4,5f, 4,5f, 2f, true, true, 0) && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -828,7069f, 176,6418f, 69,66212f, -824,0747f, 184,5666f, 72,91872f, 5,75f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -827,9308f, 182,0454f, 70,08909f, -820,2387f, 180,1781f, 72,71543f, 6,5f, false, true, 0)))
	{
		return 1;
	}
	return 0;
...
void func_191()
{
	...
	if (iLocal_466 == 0)
	{
		if (bLocal_336)
		{
			if (bLocal_337)
			{
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_PLAY_ANIM(0, sLocal_296, "react_intro", 8f, -8f, 4900, 8, 0f, false, false, false);
					TASK::TASK_PLAY_ANIM(0, sLocal_296, "react_loop", 8f, -4f, 12400, 8, 0f, false, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					TASK::CLEAR_PED_TASKS(iLocal_289);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_289, iVar0);
					iLocal_466 += 4;
	...
	else
	{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[3 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
				if (func_3(&uLocal_96, Local_438[3 /*3*/].f_1, Local_438[3 /*3*/].f_2, 7, 0, 0, 0))
				{
					if (!bLocal_337)
					{
						...
						TASK::CLEAR_PED_TASKS(iLocal_289);
						TASK::TASK_PERFORM_SEQUENCE(iLocal_289, iVar1);
					}
					iLocal_466++;
				}
			}
		...
		if (iLocal_466 == 8)
		{
			...
			{
				if ((ENTITY::GET_ENTITY_HEALTH(iLocal_273) < 900 || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_273) < 900f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_273) < 900f)
				{
					iLocal_466++;
					iLocal_467 = MISC::GET_GAME_TIMER();
				}
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[4 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[5 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[6 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
		...
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_467) > Local_438[7 /*3*/] && !func_62(PLAYER::PLAYER_PED_ID(), Local_527, 50f))
			{
...
int func_194()
{
	if (iLocal_274 && VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_273))
	{
		return 1;
	}
	return 0;
...
bool func_197(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
int func_199(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_201()
{
	if (bLocal_312 == 0)
	{
		if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false)) && ENTITY::GET_ENTITY_SPEED(iLocal_273) > 30f)
		{
			fLocal_315 = (fLocal_315 + (1f * SYSTEM::TIMESTEP()));
		}
		if (MISC::GET_GAME_TIMER() > iLocal_314 && PLAYER::HAS_PLAYER_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID()))
		{
			iLocal_313++;
			PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
			iLocal_314 = MISC::GET_GAME_TIMER() + 2000;
		}
...
void func_204(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_285(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
			Global_112915.f_9085.f_330[iVar1 /*6*/].f_1 = 0;
			iVar2 = func_283(iVar1);
		...
		{
			iVar5 = func_278(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_276(&(Global_99974.f_3));
				if (iVar10 > -1)
				{
...
{
	func_206(&Global_106464, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_206(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_15();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_229())
		{
			func_225(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97305[iVar0]))
		{
			if (Global_97305[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_215(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_77), func_218(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_226(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2860375[iParam0 /*3*/][func_113(iParam1)];
...
void func_230(int iParam0, bool bParam1)
{
	...
	if (func_17(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_231(iParam0, &(Global_112915.f_2363.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_231(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_236(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_233(Var11.f_1)) && iVar72 < 51)
			{
...
int func_242(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_264())
		{
			*uParam0 = func_248(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
...
int func_244(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_246() == 0)
		{
			return MISC::IS_BIT_SET(func_114(func_245(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_248(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	...
	while (iVar0 <= 57)
	{
		if (iParam3 == 6 || iParam3 == func_263(iVar0))
		{
			...
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_249(iVar0, 0), true);
...
Vector3 func_249(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 45:
			return func_259(Global_102098);
			break;
		
		case 46:
			if (Global_1852965 != func_9())
			{
				if (func_258(Global_1852965))
				{
					return func_251(2, 2);
				}
				else if (func_250(Global_1852965))
				{
...
int func_260()
{
	return func_261(PLAYER::PLAYER_ID());
}
...
var func_265()
{
	...
	func_275(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_274(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_273(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_268(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_267(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_266(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_271(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_283(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_284(Global_112915.f_9085.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_284(Global_112915.f_9085.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_284(Global_112915.f_9085.f_99.f_205[11]);
			break;
		
		case 90:
			return func_284(Global_112915.f_9085.f_99.f_205[7]);
			break;
		
		case 93:
			return func_284(Global_112915.f_9085.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
int func_288(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_289()
{
	...
	{
		case 0:
			STREAMING::REQUEST_ANIM_DICT(sLocal_296);
			if (func_32(iLocal_290))
			{
				TASK::CLEAR_PED_TASKS(iLocal_290);
				PED::SET_PED_FLEE_ATTRIBUTES(iLocal_290, 2, false);
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false))
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 257);
					TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2000f, -1, false, false);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_290, iVar0);
					TASK::CLEAR_SEQUENCE_TASK(&iVar0);
				}
				else
				{
					TASK::TASK_SMART_FLEE_COORD(iLocal_290, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2000f, -1, false, false);
				}
				iLocal_413 = 0;
				bLocal_414 = false;
				iLocal_415 = 0;
				...
				bLocal_605 = false;
				func_343();
				uLocal_606[0] = MISC::GET_GAME_TIMER() + 10000;
				uLocal_606[1] = MISC::GET_GAME_TIMER() + 10000;
				func_33(&iLocal_297);
				iLocal_297 = func_199(iLocal_290, 1, 0, 5);
				func_342(&iLocal_297, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_299, &iLocal_300, 1, 1);
				ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_290, true, 0f);
		...
		case 1:
			func_300(&iLocal_297, "MET1KSTKRED", "MET1KSTKBLU", &uLocal_299, iLocal_300, 1);
			if (func_32(iLocal_290))
			{
				if (!func_197(iLocal_290, PLAYER::PLAYER_PED_ID(), 80f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_290))
				{
					func_39(&iLocal_290);
					bLocal_337 = func_301();
					iLocal_93 = 2;
				...
				else
				{
					...
					else if ((((PED::IS_PED_ON_FOOT(iLocal_290) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290)) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_290)) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_290))
					{
					...
					func_313(&uLocal_261, iLocal_290, 0, 0, 1, 1, 1);
					func_292();
					PED::SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_290, 2,2f);
					func_312();
				}
			}
			else
...
void func_292()
{
	if (!bLocal_604)
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_603) > 3000)
		{
			func_295(1);
			if (((func_294(Local_584[0 /*3*/], Local_584[2 /*3*/], 1f) && !PED::IS_PED_IN_MELEE_COMBAT(iLocal_290)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290))
			{
				TASK::TASK_COWER(iLocal_290, -1);
				bLocal_604 = true;
			}
		}
		if (!bLocal_604)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false))
			{
				if (((MISC::GET_GAME_TIMER() > uLocal_606[0] && func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290))
				{
					func_293(0, 0);
				}
				else if (MISC::GET_GAME_TIMER() > uLocal_606[1])
				{
					if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_290, 0f, 1f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_290, 0f, 7f, 5f), 5f, false, true, 0) && !PED::IS_PED_RAGDOLL(iLocal_290)) && !TASK::IS_PED_GETTING_UP(iLocal_290))
					{
						func_293(0, 1);
					}
					else
					{
						uLocal_606[1] = MISC::GET_GAME_TIMER() + 2000;
					}
				}
			}
			else if (!bLocal_605 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false))
			{
				func_293(1, 1);
			}
		}
...
void func_293(int iParam0, bool bParam1)
{
	...
	{
		TASK::TASK_SMART_FLEE_PED(iLocal_290, PLAYER::PLAYER_PED_ID(), 2000f, -1, false, false);
		uLocal_606[0] = MISC::GET_GAME_TIMER() + 10000;
		if (bParam1)
		{
			uLocal_606[1] = MISC::GET_GAME_TIMER() + 10000;
...
void func_295(bool bParam0)
{
	...
	if (bParam0)
	{
		Local_584[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(iLocal_290, true) };
	}
	else
	{
		Local_584[5 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_277.f_0, true) };
	}
}
...
void func_296()
{
	...
	if (func_299() && MISC::GET_GAME_TIMER() > iLocal_412)
	{
		if (iLocal_380 == 0 || iLocal_380 == 1)
		{
			if (func_32(iLocal_273) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false) || func_197(PLAYER::PLAYER_PED_ID(), iLocal_273, 15f, 1)))
			{
				iLocal_380 = 4;
			}
		}
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_374) > 4000)
			{
		...
		case 1:
			if (func_32(iLocal_273) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
			{
				bVar0 = true;
			}
			else
			...
			if (func_32(iLocal_290))
			{
				if (func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 25f, 1))
				{
				...
				{
					if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, (80f * 0,75f), 1))
					{
						if (!bLocal_414)
						{
							iLocal_417 = 8;
				...
				else if ((!bLocal_414 && !func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, (80f * 0,5f), 1)) && func_197(PLAYER::PLAYER_PED_ID(), iLocal_289, 15f, 1))
				{
					iLocal_417 = 8;
				}
			}
		...
		case 10:
			if (!func_29())
			{
				...
				if (bLocal_410)
				{
					iLocal_412 = MISC::GET_GAME_TIMER() + 15000;
				}
				iLocal_374 = MISC::GET_GAME_TIMER();
				iLocal_417 = 0;
			}
			else if (bLocal_375 && func_32(iLocal_290))
			{
				...
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_290, PLAYER::PLAYER_PED_ID(), true))
				{
					if (func_297() == 4)
					{
						func_60();
					}
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_290);
				}
			}
			else if (bLocal_376 && func_32(iLocal_273))
			{
				if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, true) && !func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 25f, 1))
				{
					func_195();
				}
			}
...
int func_297()
{
	...
	if (Global_21285 == 4)
	{
		...
		iVar0 = (iVar0 + Global_22295);
		if (iVar0 > -1)
		{
			if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_20153[iVar0 /*6*/])))
			{
				cVar1 = { Global_20904 };
...
int func_299()
{
	...
	{
		iVar0 = (MISC::GET_GAME_TIMER() - iLocal_411);
...
void func_300(int* iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, int iParam5)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if ((MISC::GET_GAME_TIMER() - *uParam3) > 500)
		{
			if (HUD::GET_BLIP_COLOUR(*iParam0) == 1)
			{
				...
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_193(sParam1, 0, 0))
					{
			...
			else
			{
				...
				if ((MISC::GET_GAME_TIMER() - iParam4) < 7500 && iParam5)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || func_193(sParam2, 0, 0))
					{
...
int func_301()
{
	if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
	{
		return 1;
	}
	else if (bLocal_336)
	{
		if (func_197(PLAYER::PLAYER_PED_ID(), iLocal_289, 10f, 1))
		{
			return 1;
		}
		else if (func_62(iLocal_289, ENTITY::GET_ENTITY_COORDS(iLocal_290, false), 10f))
		{
			return 1;
		}
		else if (func_302(iLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7))
		{
			return 1;
		}
...
int func_306(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_308(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_308(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
void func_312()
{
	func_302(iLocal_289, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7);
...
int func_322(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_329() || func_328(Global_4718592.f_138117)) || func_327())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_323(int iParam0)
{
	if (iParam0 != func_9())
	{
		...
		else if ((Global_1575046 && iParam0 == PLAYER::PLAYER_ID()) && func_324(iParam0, 1, 0))
		{
			return Global_2689156[iParam0 /*453*/].f_319.f_6 != -1;
		}
	}
...
bool func_333()
{
	return func_334(PLAYER::PLAYER_ID());
}
...
int func_335(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (uParam0->f_5)
	{
		...
		case 2:
			...
			{
				if (!func_338(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
				{
					uParam0->f_5 = 0;
				}
			}
		...
		case 3:
			if ((MISC::GET_GAME_TIMER() - uParam0->f_4) > 500)
			{
				...
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || func_336(bParam1, bParam2, bParam3))
					{
						uParam0->f_5 = 0;
					}
				}
...
void func_342(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
...
void func_343()
{
	...
	Var0 = { ENTITY::GET_ENTITY_COORDS(iLocal_290, true) };
...
void func_344()
{
	switch (iLocal_93)
	{
		case 0:
			...
			{
				func_313(&uLocal_261, iLocal_290, 0, 0, 1, 1, 1);
				if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 220f, 1))
				{
					func_33(&iLocal_297);
				...
				{
					if (func_200(4) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_29()))
					{
						func_34(4);
					}
					iLocal_374 = MISC::GET_GAME_TIMER();
					iLocal_412 = MISC::GET_GAME_TIMER();
					iLocal_411 = (MISC::GET_GAME_TIMER() - 4500);
					iLocal_380 = 0;
					iLocal_372 = 0;
					iLocal_373 = 0;
					bLocal_375 = false;
					...
					iLocal_377 = 0;
					bLocal_410 = false;
					iLocal_378 = (MISC::GET_GAME_TIMER() - 1000);
					...
					if (!iLocal_333)
					{
						iLocal_333 = 1;
						TASK::CLEAR_PED_TASKS(iLocal_290);
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_290, Local_277.f_0, PLAYER::PLAYER_PED_ID(), 8, 25f, 786477, 100f, 1f, true);
					}
					iLocal_603 = MISC::GET_GAME_TIMER();
					if (func_32(Local_277.f_0))
					{
						Local_584[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Local_277.f_0, true) };
					...
					{
						func_359(iLocal_297, iLocal_290, 220f, 0,75f, 0);
					}
					iLocal_93 = 1;
				}
				if (iLocal_305)
		...
		case 1:
			if (func_32(iLocal_290))
			{
				...
				else if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false))
				{
					iLocal_93 = 0;
					iLocal_92 = 6;
				}
				else if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 220f, 1))
				{
					func_33(&iLocal_297);
					sLocal_573 = "MET1ESCAPE";
					iLocal_92 = 11;
				...
				if ((HUD::DOES_BLIP_EXIST(iLocal_297) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false)) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
				{
					func_359(iLocal_297, iLocal_290, 220f, 0,75f, 0);
				}
				func_313(&uLocal_261, iLocal_290, 0, 0, 1, 1, 1);
...
void func_345()
{
	...
	iLocal_379 = (MISC::GET_GAME_TIMER() - iLocal_378);
	if ((((iLocal_379 > 0 && iLocal_379 < 250) && (iLocal_380 == 0 || iLocal_380 == 1)) && ENTITY::GET_ENTITY_SPEED(iLocal_273) < 1,5f) && ENTITY::GET_ENTITY_SPEED(Local_277.f_0) > 3f)
	{
		iLocal_380 = 8;
	}
	if (func_347())
	...
	{
		case 0:
			if ((((MISC::GET_GAME_TIMER() - iLocal_374) > 4000 && func_32(iLocal_290)) && !func_192()) && !func_29())
			{
				func_27(&uLocal_96, 4, iLocal_290, "Stalker", 0, 1);
				iLocal_380 = 1;
			}
		...
		case 1:
			if (func_32(iLocal_290))
			{
				if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, (220f * 0,75f), 1))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_290, false))
					{
						iLocal_380 = 8;
				...
				else if (func_346() && (MISC::GET_GAME_TIMER() - iLocal_331) > 6000)
				{
					iLocal_380 = 7;
				}
				else if (func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 50f, 1))
				{
...
int func_347()
{
	if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_273))
	{
		if (func_32(Local_277.f_0) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_273, Local_277.f_0))
		{
			return 0;
		}
		return 1;
...
void func_348()
{
	if ((MISC::GET_GAME_TIMER() - iLocal_330) > 3000)
	{
		Local_320[0 /*3*/] = { Local_320[1 /*3*/] };
		Local_320[1 /*3*/] = { Local_320[2 /*3*/] };
		Local_320[2 /*3*/] = { ENTITY::GET_ENTITY_COORDS(iLocal_273, true) };
		iLocal_330 = MISC::GET_GAME_TIMER();
	}
}
...
int func_350()
{
	...
	if (func_32(Local_277.f_0))
	{
		fVar0 = func_351(ENTITY::GET_ENTITY_ROLL(Local_277.f_0), 0f, 360f);
...
int func_353()
{
	if (func_62(iLocal_273, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, 3,2f, 0,5f), 3f) || func_62(iLocal_273, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, -3,2f, 0,5f), 3f))
	{
		return 1;
	}
	return 0;
...
void func_354()
{
	if (iLocal_617 == 0)
	{
		if (bLocal_609 && (MISC::GET_GAME_TIMER() - iLocal_613) > iLocal_615)
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
			iLocal_617 = 2;
		}
		else if ((MISC::GET_GAME_TIMER() - iLocal_613) > iLocal_616 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, -0,5f, -1,5f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_277.f_0, 0f, 6f, 2f), 12f, false, true, 0))
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
			iLocal_617 = 1;
		}
	...
	if (iLocal_617 == 1)
	{
		...
		else if ((MISC::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_355(1))
		{
			PED::SET_IK_TARGET(iLocal_290, 1, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 0, 300, 300);
		}
		else
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
	...
	if (iLocal_617 == 2)
	{
		if ((MISC::GET_GAME_TIMER() - iLocal_613) < iLocal_614 && func_355(0))
		{
			PED::SET_IK_TARGET(iLocal_290, 1, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 0, 150, 400);
		}
		else
		{
			iLocal_613 = MISC::GET_GAME_TIMER();
...
int func_356()
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_277.f_0))
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_277.f_0, false) || !VEHICLE::IS_VEHICLE_DRIVEABLE(Local_277.f_0, false))
		{
			return 1;
		}
		if (func_358(Local_277.f_0, &bLocal_609, &uLocal_610, &uLocal_611, &uLocal_612, 6, 1082130432))
		{
			return 1;
		}
		if (bLocal_609)
		...
		if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_277.f_0))
		{
			if (iLocal_318)
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_319) > 7000)
				{
					return 1;
				}
			}
...
{
	if (((VEHICLE::IS_VEHICLE_TYRE_BURST(iParam0, 0, false) || VEHICLE::IS_VEHICLE_TYRE_BURST(iParam0, 1, false)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iParam0, 4, false)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iParam0, 5, false))
	{
		return 1;
	}
	return 0;
...
int func_358(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		Var1 = { func_308(ENTITY::GET_ENTITY_COORDS(iVar0, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
void func_359(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
		...
		case 0:
			if (!func_366())
			{
				...
				if (func_362(Local_277.f_6, Local_277.f_9, 0))
				{
					...
					iLocal_333 = 0;
					iLocal_335 = 0;
					VEHICLE::SET_VEHICLE_FORWARD_SPEED(Local_277.f_0, Local_277.f_10);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_277.f_0, ENTITY::GET_ENTITY_COORDS(iLocal_273, true), 4, 35f, 2883621, 10f, 12f, true);
					TASK::TASK_VEHICLE_ESCORT(0, Local_277.f_0, iLocal_273, -1, 25f, 2883621, -1f, 20, 20f);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_290, iVar0);
					TASK::CLEAR_SEQUENCE_TASK(&iVar0);
		...
		case 1:
			...
			if (func_32(iLocal_290))
			{
				if (func_32(Local_277.f_0))
				{
					if (!iLocal_335)
					{
						if (STREAMING::HAS_ANIM_DICT_LOADED("missmichael_event@tracy") && func_3(&uLocal_96, "MET1AUD", "MET1_TENDb", 7, 0, 0, 0))
						{
							TASK::TASK_PLAY_ANIM(iLocal_289, "missmichael_event@tracy", "base", 8f, -8f, -1, 0, 0f, false, false, false);
							STREAMING::REMOVE_ANIM_DICT("missmichael_event@tracy");
							if (!HUD::DOES_BLIP_EXIST(iLocal_297))
							{
								iLocal_297 = func_202(Local_277.f_0, 0, 5);
								HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_297, "MET1LBSTALK");
								func_188(4);
							}
							iLocal_335 = 1;
						}
					...
					else
					{
						...
						if (!iLocal_332)
						{
							if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_277.f_0, PLAYER::PLAYER_PED_ID(), true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_290, PLAYER::PLAYER_PED_ID(), true))
							{
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_290);
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_277.f_0);
								iLocal_332 = 1;
							}
							else if (func_197(PLAYER::PLAYER_PED_ID(), iLocal_290, 15f, 1))
							{
								iLocal_332 = 1;
							}
						}
...
int func_362(struct<3> Param0, float fParam3, int iParam4)
{
	...
	if (func_32(Local_277.f_0) && func_32(iLocal_290))
	{
		return 1;
	}
	else if (iLocal_292)
	{
		...
		{
			MISC::CLEAR_AREA_OF_VEHICLES(Local_277.f_6, 5f, false, false, false, false, false, false, 0);
			Local_277.f_0 = VEHICLE::CREATE_VEHICLE(Local_277.f_1, Param0, fParam3, true, true, false);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_277.f_1);
			VEHICLE::SET_VEHICLE_COLOURS(Local_277.f_0, 145, 111);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_277.f_0, 5f);
			VEHICLE::LOWER_CONVERTIBLE_ROOF(Local_277.f_0, true);
			VEHICLE::SET_CONVERTIBLE_ROOF_LATCH_STATE(Local_277.f_0, true);
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_277.f_0, true, true, false);
			ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_277.f_0, true, 1);
			VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_277.f_0);
			func_363(Local_277.f_0, 0);
			AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_277.f_0, "M_E_TRACEY_STALKERS_CAR_GROUP", 0f);
			iLocal_317 = 1;
			iLocal_290 = PED::CREATE_PED_INSIDE_VEHICLE(Local_277.f_0, 26, iLocal_291, -1, true, true);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_290, 9, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_290, 8, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_290, 0, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_290, 2, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_290, 3, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_290, 4, 1, 0, 0);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_291);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_290, true);
			PED::SET_PED_KEEP_TASK(iLocal_290, true);
			func_27(&uLocal_96, 4, iLocal_290, "Stalker", 0, 1);
			PED::SET_PED_CONFIG_FLAG(iLocal_290, 281, true);
			iLocal_292 = 0;
			iLocal_626 = MISC::GET_GAME_TIMER() + 1000;
			return 1;
		}
	}
	else
...
void func_364()
{
	...
	if (func_62(PLAYER::PLAYER_PED_ID(), Local_487[3 /*8*/], Local_487[3 /*8*/].f_3))
	{
		if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, Local_546[0 /*3*/], false))
		{
			iVar0 = 0;
		}
		else
	...
	else
	{
		if (func_365())
		{
			if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, Local_546[2 /*3*/], false))
			{
				iVar0 = 2;
			}
			else
		...
		else if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_277.f_1, Local_546[4 /*3*/], false))
		{
			iVar0 = 4;
		}
		else
...
void func_367()
{
	if (iLocal_625 == 1 && MISC::GET_GAME_TIMER() > iLocal_624)
	{
	...
	switch (iLocal_93)
	{
		case 0:
			if (func_32(iLocal_273))
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, true))
				{
					iLocal_305 = 0;
				}
				else
				...
				if (PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, true))
				{
					iLocal_306 = 0;
				}
				else
			...
			if (!func_366())
			{
				...
				if (iLocal_305)
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
					{
						...
						{
							iLocal_306 = 0;
							if (iLocal_316 == 5 && !func_62(PLAYER::PLAYER_PED_ID(), Local_487[iLocal_520 /*8*/], Local_487[iLocal_520 /*8*/].f_3))
							{
								iLocal_297 = func_288(Local_487[iLocal_520 /*8*/], 5, 1);
							}
					...
					{
						TASK::CLEAR_PED_TASKS(iLocal_289);
						TASK::TASK_SMART_FLEE_PED(iLocal_289, PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
						if (func_29())
						{
							if (func_297() == 3)
							{
				...
				else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
				{
					iLocal_305 = 1;
					func_33(&iLocal_297);
					iLocal_297 = func_202(iLocal_273, 1, 5);
					func_34(5);
					if (func_29())
					{
						func_195();
				...
				else if (!PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false))
				{
					...
					iLocal_307 = 0;
					func_33(&iLocal_297);
					iLocal_297 = func_199(iLocal_289, 1, 1, 5);
					func_34(2);
					if (func_29())
					{
						func_60();
				...
				else
				{
					switch (iLocal_316)
					{
						...
						case 2:
							if (func_29())
							{
								if (AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() >= Local_487[iLocal_520 /*8*/].f_7)
								{
									iLocal_297 = func_288(Local_487[iLocal_520 /*8*/], 5, 1);
									iLocal_316 = 3;
								}
						...
						case 3:
							...
							if (func_62(PLAYER::PLAYER_PED_ID(), Local_487[iLocal_520 /*8*/], Local_487[iLocal_520 /*8*/].f_3))
							{
								iLocal_316 = 5;
							}
							else if (!func_29())
							{
								iLocal_543 = MISC::GET_GAME_TIMER() + 2000;
								iLocal_316 = 4;
							}
							break;
						...
						case 4:
							...
							else if (!func_29() && MISC::GET_GAME_TIMER() > iLocal_543)
							{
								if (!func_194())
								{
									if (bLocal_312 && !MISC::ARE_STRINGS_EQUAL(Local_487[iLocal_520 /*8*/].f_6, "NULL"))
									{
						...
						case 6:
							...
							{
								iLocal_545 = 1;
								iLocal_543 = (MISC::GET_GAME_TIMER() + iLocal_544);
								iLocal_316 = 7;
							}
							break;
						...
						case 7:
							if (iLocal_545)
							{
								if (MISC::GET_GAME_TIMER() > iLocal_543)
								{
									iLocal_545 = 0;
								}
							}
...
void func_368()
{
	if (((!func_29() && !func_194()) && PED::IS_PED_IN_VEHICLE(iLocal_289, iLocal_273, false)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
	{
		if (func_346() && (MISC::GET_GAME_TIMER() - iLocal_331) > 18000)
		{
...
void func_369()
{
	...
	Var27.f_1 = 3;
	Var27.f_1.f_4 = 3;
	Var3[0 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, -8f, 2f, 0f) };
	Var3[1 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, -8f, 8f, 0f) };
	Var3[2 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 8f, 2f, 0f) };
	Var3[3 /*3*/] = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 8f, 8f, 0f) };
	...
	TASK::TASK_PERFORM_SEQUENCE(iLocal_289, uVar0[0]);
...
int func_370(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_32(PLAYER::PLAYER_PED_ID()) && func_32(iParam0))
	{
		...
		if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					return func_374(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_371(int iParam0, float fParam1)
{
	...
	if (func_32(PLAYER::PLAYER_PED_ID()) && func_32(iParam0))
	{
		if (func_373(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				fVar0 = 40f;
...
{
	return func_302(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_378(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_308(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	switch (iLocal_93)
	{
		case 0:
			...
			if (!func_366())
			{
				if (!func_2())
				{
					if (((func_393(&iLocal_289, Local_483, fLocal_486, 1) && func_383(&iLocal_273, 15, Local_479, fLocal_482, 1, 0)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_296)) && func_32(iLocal_273))
					{
						iLocal_293 = 1;
						...
						func_382();
						TASK::TASK_PLAY_ANIM(iLocal_289, sLocal_296, "nervous_loop", 8f, -8f, -1, 1, 0f, false, false, false);
						PED::SET_PED_KEEP_TASK(iLocal_289, true);
						ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_273, true, 1);
						VEHICLE::SET_VEHICLE_STRONG(iLocal_273, true);
						VEHICLE::LOWER_CONVERTIBLE_ROOF(iLocal_273, true);
						VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_273);
						VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_273, true);
		...
		case 1:
			if (iLocal_95 == 0)
			{
				if (func_62(PLAYER::PLAYER_PED_ID(), Local_479, 200f))
				{
					iLocal_95 = 1;
				}
			}
			else if (!func_62(PLAYER::PLAYER_PED_ID(), Local_479, 300f))
			{
				iLocal_95 = 0;
			}
			if (!func_2())
			{
				if (!func_366())
				{
					...
					{
						case 0:
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 246,1479f, -39,21085f, 67,89664f, 202,6635f, -23,77725f, 72,90416f, 22f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 233,7891f, -45,51515f, 67,57388f, 229,9916f, -55,96275f, 72,28979f, 12,5f, false, true, 0))
							{
								if (func_29())
								{
									func_60();
								...
								TASK::OPEN_SEQUENCE_TASK(&iVar0);
								TASK::TASK_PLAY_ANIM(0, sLocal_296, "breakout", 8f, -4f, -1, 0, 0f, false, false, false);
								TASK::TASK_ENTER_VEHICLE(0, iLocal_273, 60000, 0, 2f, 1, 0);
								TASK::CLOSE_SEQUENCE_TASK(iVar0);
								TASK::CLEAR_PED_TASKS(iLocal_289);
								TASK::TASK_LOOK_AT_ENTITY(iLocal_289, PLAYER::PLAYER_PED_ID(), 4000, 0, 3);
								TASK::TASK_PERFORM_SEQUENCE(iLocal_289, iVar0);
								TASK::CLEAR_SEQUENCE_TASK(&iVar0);
								PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 170, true);
								RECORDING::_0x48621C9FCA3EBD28(3);
								iLocal_624 = MISC::GET_GAME_TIMER() + 10000;
								iLocal_625 = 1;
								iLocal_304 = 1;
							}
							else
						...
						case 1:
							if (func_3(&uLocal_96, "MET1AUD", "MET1_SEES", 7, 1, 0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
							{
							...
							TASK::TASK_LOOK_AT_ENTITY(iLocal_289, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
							break;
						
						case 2:
							if (((!iLocal_311 && !func_29()) && !func_193("MET1TCAR", 0, 0)) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
							{
							...
							if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
							{
								...
								else if (func_200(2))
								{
									func_33(&iLocal_297);
									iLocal_297 = func_199(iLocal_289, 1, 1, 5);
									HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_297, "MET1LBTRAC");
									func_34(2);
								}
							}
							TASK::TASK_LOOK_AT_ENTITY(iLocal_289, PLAYER::PLAYER_PED_ID(), 2000, 2048, 4);
					...
					if (iLocal_304 != 0)
					{
						if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_289, 100f, 1))
						{
							sLocal_573 = "MET1ABANDON";
							iLocal_92 = 11;
							iLocal_93 = 0;
						}
						else if (!func_197(PLAYER::PLAYER_PED_ID(), iLocal_289, 50f, 1))
						{
							func_34(6);
						}
					}
...
void func_381()
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_369) > 5000 && func_197(iLocal_289, PLAYER::PLAYER_PED_ID(), 25f, 1))
			{
				iLocal_371 = 9;
			}
			break;
...
void func_382()
{
	if (!iLocal_294)
	{
		PED::ADD_RELATIONSHIP_GROUP("FRIENDLIES", &iLocal_295);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_295, joaat("player"));
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("player"), iLocal_295);
		iLocal_294 = 1;
	}
	if (PED::IS_PED_IN_GROUP(iLocal_289))
	{
		PED::REMOVE_PED_FROM_GROUP(iLocal_289);
	}
...
int func_383(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)
{
	...
	if (!func_17(iParam1))
	{
		...
		if ((iParam1 == 17 && Global_112915.f_2363.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0.f_0) || (iParam1 == 15 && Global_112915.f_2363.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0.f_0))
		{
			if (iParam1 == 17)
			{
				iVar98 = 0;
			...
			STREAMING::REQUEST_MODEL(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/]);
			if (STREAMING::HAS_MODEL_LOADED(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/], Param2, fParam5, false, false, false);
				...
				Var0.f_3 = 1250;
				VEHICLE::SET_VEHICLE_COLOURS(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_5, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_6);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_7, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_8);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(*iParam0, Var0.f_2);
				iVar99 = 0;
				while (iVar99 < 12)
				{
					VEHICLE::SET_VEHICLE_EXTRA(*iParam0, iVar99 + 1, !Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_11[iVar99]);
					iVar99++;
				}
				if (Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_24)
				{
					if (VEHICLE::IS_VEHICLE_A_CONVERTIBLE(*iParam0, false))
					{
						if (Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_24)
				...
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(*iParam0, &(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_27));
				if (Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_26 >= 0 && Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_26 < VEHICLE::GET_NUMBER_OF_VEHICLE_NUMBER_PLATES())
				{
					VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_26);
				}
				VEHICLE::SET_VEHICLE_TYRE_SMOKE_COLOR(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_84, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_85, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_86);
				VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_88);
				VEHICLE::SET_VEHICLE_WINDOW_TINT(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_87);
				VEHICLE::_SET_VEHICLE_NEON_LIGHTS_COLOUR(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_93, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_94, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_95);
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 2, MISC::IS_BIT_SET(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 28));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 3, MISC::IS_BIT_SET(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 29));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 0, MISC::IS_BIT_SET(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 30));
				VEHICLE::_SET_VEHICLE_NEON_LIGHT_ENABLED(*iParam0, 1, MISC::IS_BIT_SET(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_92, 31));
				if (VEHICLE::GET_VEHICLE_LIVERY_COUNT(*iParam0) > 1 && Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_89 >= 0)
				{
					VEHICLE::SET_VEHICLE_LIVERY(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_89);
				}
				if (Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90 > -1)
				{
					if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(*iParam0)))
					{
						if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(*iParam0)))
						{
							if (Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90 == 6)
							{
								VEHICLE::SET_VEHICLE_WHEEL_TYPE(*iParam0, Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_90);
							}
						}
						else
						{
				...
				func_387(iParam0, &(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var0.f_96);
				if (bParam6)
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Global_112915.f_2363.f_539.f_3618[0 /*197*/][iVar98 /*98*/]);
				}
				func_386(*iParam0);
				return 1;
			}
		...
		else
		{
			...
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var0.f_0, Param2, fParam5, false, false, false);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(*iParam0, 5f);
				VEHICLE::_0xAB04325045427AAE(*iParam0, false);
				VEHICLE::SET_VEHICLE_CAN_SAVE_IN_GARAGE(*iParam0, false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(*iParam0, true);
...
void func_384(int iParam0, struct<98> Param1)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (func_385(&uVar2, &iVar1) && Param1.f_97)
	{
	...
	func_387(iParam0, &(Param1.f_31), &(Param1.f_81));
...
int func_387(int iParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	...
	if (func_391(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_390(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_390(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_389(iParam0);
	if (func_388(*iParam0))
	{
...
int func_393(int* iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	int iVar0;
...
void func_394()
{
	switch (iLocal_93)
	{
		case 0:
			...
			if (!HUD::DOES_BLIP_EXIST(iLocal_297))
			{
				iLocal_297 = func_396(Local_483, 1);
				func_395(&iLocal_297, 237,2897f, -60,5704f, 68,4345f, 70,9753f);
			}
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				iLocal_305 = 0;
		...
		case 1:
			if (!func_2())
			{
				if (iLocal_305 && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					iLocal_305 = 0;
					func_188(1);
				}
				...
				else if (func_62(PLAYER::PLAYER_PED_ID(), Local_479, 200f))
				{
					iLocal_93 = 2;
				}
			}
		...
		case 2:
			...
			{
				STREAMING::REQUEST_ANIM_DICT(sLocal_296);
				PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_534[0 /*3*/], Local_534[1 /*3*/], Local_534.f_7, false, false, true);
				iLocal_542 = PED::ADD_SCENARIO_BLOCKING_AREA(227,4f, -66,5f, 67,5f, 249f, -30,8f, 72,5f, false, true, true, true);
				MISC::CLEAR_AREA(Local_479, 30f, false, false, false, false);
				MISC::CLEAR_AREA_OF_VEHICLES(Local_479, 30f, false, false, false, false, false, false, 0);
				iLocal_93 = 0;
				iLocal_92 = 2;
			}
			break;
...
void func_395(int* iParam0, struct<3> Param1, float fParam4)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_396(struct<3> Param0, bool bParam3)
{
	int iVar0;
	
	iVar0 = HUD::ADD_BLIP_FOR_COORD(Param0);
	HUD::SET_BLIP_PRIORITY(iVar0, 7);
	HUD::SET_BLIP_SCALE(iVar0, 0,7f);
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103480.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103480.f_4, false))
		{
			if (func_428(24) != Global_103480.f_4)
			{
				...
				func_399(Global_103480.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_399(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_418(iParam5, &Var0, Param1, fParam4, func_213(iParam0));
...
void func_400(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_417(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_112915.f_32749.f_4801 = func_265();
			}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_223(iParam0, 0, 0)) || func_223(iParam0, 1, 0)) || func_223(iParam0, 2, 0)) || func_213(iParam0) != 145) || func_416(iParam0)) || func_415(iParam0)) || func_414(iParam0)) || func_413(iParam0)) || !func_403(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_415(iParam0))
		{
		}
...
int func_417(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_241(Global_112915.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_241(Global_112915.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_241(Global_112915.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_418(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_417(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_423(iParam0);
			func_422(uParam1, &(Global_112915.f_32749.f_69[Global_76670.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_429()
{
	...
	if (bLocal_337 && (MISC::GET_GAME_TIMER() - iLocal_340) > 8000)
	{
		RECORDING::_0x293220DA1B46CEBC((2,5f + 8f), 2f, 3);
		iLocal_339 = 1;
	}
	if (!bLocal_337 && (MISC::GET_GAME_TIMER() - iLocal_340) > 2000)
	{
		RECORDING::_0x293220DA1B46CEBC((2,5f + 2f), 2f, 3);
		iLocal_339 = 1;
	}
}
...
int func_431()
{
	...
	else if (iLocal_293)
	{
		...
		{
			PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_289, false);
		}
	}
	return 0;
}
...
int func_432()
{
	if (VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_273))
	{
		if (iLocal_275)
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_276) > 7000)
			{
				return 1;
			}
		}
...
void func_435()
{
	switch (iLocal_93)
	{
		case 0:
			func_33(&iLocal_297);
			if (MISC::IS_STRING_NULL_OR_EMPTY(sLocal_573))
			{
				sLocal_573 = "DEFAULT";
			}
			if (MISC::ARE_STRINGS_EQUAL(sLocal_573, "DEFAULT"))
			{
				func_439(0);
			}
			else
...
int func_440(int iParam0)
{
	...
	func_441(&(Global_112915.f_2363.f_539), iVar1);
...
void func_441(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_443(Global_112915.f_18533[iVar0], &Var2, &fVar5))
			{
...
void func_446(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		...
		Local_618 = { Var0[1 /*3*/] };
		fLocal_621 = fVar7;
		MISC::CLEAR_AREA_OF_VEHICLES(Local_618, 10f, false, false, false, false, false, false, 0);
	...
	else if ((((iLocal_92 == 3 || iLocal_92 == 4) || iLocal_92 == 5) && func_32(iLocal_273)) && func_32(iLocal_289))
	{
		if (func_32(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false))
			{
				func_459(PLAYER::PLAYER_PED_ID(), iLocal_273, -1, 0);
				Local_618 = { ENTITY::GET_ENTITY_COORDS(iLocal_273, true) };
			}
		}
	}
	else
	{
		...
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_618, true, false, false, true);
	...
	if (bParam0)
	{
		...
		if (!bParam1)
		{
			while (!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_296))
			{
				SYSTEM::WAIT(0);
			}
		}
...
void func_447(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
void func_460(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		while (!func_393(&iLocal_289, Param0.f_0, Param0.f_1, (Param0.f_2 + 5f), 0, 1))
		{
			SYSTEM::WAIT(0);
		}
		if (func_32(iLocal_289) && func_32(iLocal_273))
		{
			PED::SET_PED_INTO_VEHICLE(iLocal_289, iLocal_273, 0);
		}
	}
	else
	{
	...
	if (func_32(iLocal_273))
	{
		VEHICLE::LOWER_CONVERTIBLE_ROOF(iLocal_273, true);
		VEHICLE::SET_VEHICLE_STRONG(iLocal_273, true);
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_273, true, true, false);
		VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_273);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_273, true);
		func_363(iLocal_273, 1);
		iLocal_274 = 1;
...
void func_461()
{
	...
	if (iLocal_274)
	{
		VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(iLocal_273);
		iLocal_274 = 0;
	}
	func_37(&iLocal_273);
}
...
void func_465()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_277.f_0))
	{
		if (iLocal_317)
		{
			VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_277.f_0);
			iLocal_317 = 0;
		}
		AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(Local_277.f_0, 0f);
		func_37(&Local_277);
	}
}
...
void func_466(bool bParam0)
{
	...
	else
	{
		if (func_32(PLAYER::PLAYER_PED_ID()))
		{
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_487[3 /*8*/], Local_487[3 /*8*/].f_1, (Local_487[3 /*8*/].f_2 + 8f), true, false, false, true);
			func_460(Local_487[3 /*8*/], 71,4f, 1);
			func_459(PLAYER::PLAYER_PED_ID(), iLocal_273, -1, 0);
		}
		if (func_32(iLocal_273))
		{
			MISC::CLEAR_AREA_OF_VEHICLES(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_273, 0f, -8f, 0f), 6f, false, false, false, false, false, false, 0);
		}
	}
...
void func_467(bool bParam0)
{
	...
	if (func_32(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam0)
		{
			if (func_497())
			{
				...
				fLocal_621 = 251,1f;
				bLocal_622 = true;
				MISC::CLEAR_AREA_OF_VEHICLES(99,6208f, -21,0027f, 67,0114f, 7f, false, false, false, false, false, false, 0);
				func_495();
				while (!func_494())
				{
					SYSTEM::WAIT(0);
			...
			{
				MISC::CLEAR_AREA(181,2331f, -33,9939f, 67,2522f, 3f, true, false, false, false);
		...
		{
			if ((func_32(iLocal_273) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_273, false)) || (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false)))
			{
				MISC::CLEAR_AREA(181,2331f, -33,9939f, 67,2522f, 3f, true, false, false, false);
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 181,2331f, -33,9939f, 67,2522f, true, false, false, true);
			...
			{
				MISC::CLEAR_AREA_OF_VEHICLES(99,6208f, -21,0027f, 67,0114f, 7f, false, false, false, false, false, false, 0);
				iLocal_623 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
				ENTITY::SET_ENTITY_COORDS(iLocal_623, 99,6208f, -21,0027f, 67,0114f, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(iLocal_623, 251,1f);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_623, 5f);
				Local_618 = { 99,6208f, -21,0027f, 67,0114f };
				bLocal_622 = true;
			}
		}
	...
	iLocal_92 = 1;
	iLocal_93 = 0;
	if ((func_32(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) || bLocal_622)
	{
		func_188(1);
	}
	else
	...
	if (bLocal_622)
	{
		...
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_623, true, true, false);
			VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_623, 10f);
		}
		SYSTEM::WAIT(0);
	}
}
...
void func_468()
{
	iLocal_301 = CLOCK::GET_CLOCK_DAY_OF_MONTH();
	iLocal_302 = CLOCK::GET_CLOCK_HOURS();
	iLocal_303 = CLOCK::GET_CLOCK_MINUTES();
}

int func_469(struct<3> Param0, float fParam3)
{
	return func_470(&(Global_106464.f_2890), Param0, fParam3, 0);
}
	...
	if (func_493(uParam0))
	{
		...
		if (func_492(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_475(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
void func_471(int iParam0)
{
	...
	if (func_417(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_76670.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_421(iParam0, 0)) && Global_77579.f_66 == 0) && Global_112915.f_32749.f_1958[Global_76670.f_555[0 /*21*/].f_14] != 0) && Global_112915.f_32749.f_1958[Global_76670.f_555[0 /*21*/].f_14] > 3) && (!func_472(0, Global_76670.f_555[0 /*21*/].f_12) || !func_472(1, Global_76670.f_555[0 /*21*/].f_12)))
			{
				func_422(&(Global_112915.f_32749.f_69[Global_76670.f_555[0 /*21*/].f_14 /*78*/]), &Global_77579);
...
int func_472(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_473(&(Global_112915.f_32749.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
...
int func_475(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_477(iParam0, Global_76670.f_139[38], 0))
			{
				func_471(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_477(iParam0, Global_76670.f_139[43], 1))
			{
				func_471(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_477(iParam0, uVar1[iVar6], 1) && func_476(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
					if ((!bParam4 || func_241(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
void func_479(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97305[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_97305[iVar0]) == func_215(iParam0, iParam1))
				{
...
void func_480(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		{
			iVar0 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_218(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (MISC::IS_BIT_SET(uParam1->f_77, func_218(iVar1 + 1)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_218(iVar1 + 1));
			}
		}
		else if (uParam1->f_66 == joaat("formula") || uParam1->f_66 == joaat("formula2"))
		{
			...
			while (iVar2 <= 9)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_218(iVar2)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_218(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel1"))
		{
			...
			while (iVar3 <= 6)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_218(iVar3)))
				{
				}
				else
				{
					MISC::SET_BIT(&(uParam1->f_77), func_218(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_66 == joaat("openwheel2"))
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (MISC::IS_BIT_SET(uParam1->f_77, func_218(iVar4)))
					{
					}
					else
					{
						MISC::SET_BIT(&(uParam1->f_77), func_218(iVar4));
					}
				}
				iVar4++;
			}
		...
		{
			if (MISC::IS_BIT_SET(uParam1->f_77, func_218(4)))
			{
			}
			else
			{
				MISC::SET_BIT(&(uParam1->f_77), func_218(4));
			}
		}
		...
		{
			MISC::SET_BIT(&(uParam1->f_77), func_218(1));
		}
		...
		if (((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_483(iParam0)) || (((uParam1->f_62 == 0 && uParam1->f_63 == 0) && uParam1->f_64 == 0) && uParam1->f_9[20] > 0)) && func_482())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_66) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_66))
		{
			...
			while (iVar5 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_77, func_218(iVar5 + 1)))
				{
...
int func_484(int iParam0)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!func_490(PLAYER::PLAYER_ID(), -1))
		{
	...
	if (func_486(PLAYER::PLAYER_ID()) == 3)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
		{
...
void func_491(struct<3> Param0, float fParam3, bool bParam4)
{
	...
	while (iVar0 < 68)
	{
		if (func_417(&(Global_76670.f_555[0 /*21*/]), iVar0))
		{
...
bool func_494()
{
	return func_492(&(Global_106464.f_2890));
}

void func_495()
{
	func_496(&(Global_106464.f_2890));
}
...
bool func_497()
{
	return func_493(&(Global_106464.f_2890));
}
		...
		if (Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_387(iParam0, &(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_387(iParam0, &(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_505(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_17(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_509(*iParam1, 0, &uVar0))
		{
			func_219(iParam1, &(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_112915.f_20118[iParam0 /*43*/].f_31 = func_508(*iParam1);
				...
				func_506(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_112915.f_20118[iParam0 /*43*/].f_1));
				...
				func_506(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_112915.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_509(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_534(iVar0, bParam1, uParam2) && !func_533(PLAYER::PLAYER_ID())) && !func_517(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_515(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_513(iParam0)) && !bVar1) && !(func_512(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_510(PLAYER::PLAYER_ID())))
	{
		switch (ENTITY::GET_ENTITY_MODEL(iParam0))
		{
			case joaat("cerberus"):
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_414(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_510(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			...
			{
				return func_511(Global_2689156[iParam0 /*453*/].f_319.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_514(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_511(Global_2689156[iParam0 /*453*/].f_319.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_515(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_511(Global_2689156[iParam0 /*453*/].f_319.f_6) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_532(PLAYER::PLAYER_ID()) || func_531(PLAYER::PLAYER_ID()))
	{
		if (func_518(iParam0))
		{
			return 1;
...
int func_519(int iParam0)
{
	...
	if (func_520(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
	{
		return 1;
	}
	return 0;
...
int func_531(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			...
			{
				return func_511(Global_2689156[iParam0 /*453*/].f_319.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_532(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1 && Global_2689156[iParam0 /*453*/].f_319.f_9 != func_9())
			{
				return func_511(Global_2689156[iParam0 /*453*/].f_319.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_533(int iParam0)
{
	if (iParam0 != func_9())
	{
		if (func_324(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_511(Global_2689156[iParam0 /*453*/].f_319.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_534(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_515(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_538(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_540(Global_106464.f_2890.f_12.f_66))
	{
		return 0;
	}
...
void func_544()
{
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_277.f_1, true);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("issi2"), true);
	func_545(1);
	iLocal_317 = 0;
	iLocal_333 = 0;
	iLocal_293 = 0;
	func_27(&uLocal_96, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	sLocal_573 = "DEFAULT";
	func_468();
	iLocal_94 = 0;
	iLocal_95 = 0;
...
void func_545(bool bParam0)
{
	...
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("mixer2"), bParam0);
...
void func_557(bool bParam0, bool bParam1)
{
	...
	if (iLocal_294)
	{
		PED::REMOVE_RELATIONSHIP_GROUP(iLocal_295);
	}
	if (func_32(iLocal_273) && iLocal_274)
	{
		VEHICLE::REMOVE_VEHICLE_STUCK_CHECK(iLocal_273);
		iLocal_274 = 0;
	}
	if (bParam0)
	{
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(Local_534[0 /*3*/], Local_534[1 /*3*/], Local_534.f_7, 1);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_542, false);
	MISC::SET_INSTANCE_PRIORITY_HINT(0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_277.f_1, false);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("issi2"), false);
	func_545(0);
...
void func_558(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
