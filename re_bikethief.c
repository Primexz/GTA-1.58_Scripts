...
void __EntryFunction__()
{
	...
	if (iLocal_317 != 3)
	{
		if (func_185(Local_96, 26, iLocal_317, 0, 0))
		{
			func_182(26);
		}
		else
...
int func_30(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_36(&iVar20);
		iVar21 = func_35(Var10, Global_112915.f_7688.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_33(Global_112915.f_7688.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_31(Global_112915.f_7688.f_765[iVar20 /*10*/]))
				{
					Global_112915.f_7688.f_765[iVar20 /*10*/] = { Var10 };
					func_32(&Var10);
					return 1;
...
void func_103()
{
	...
	else
	{
		...
		if (((iLocal_317 == 2 && func_64(iLocal_91)) && func_73(iLocal_93)) && PED::IS_PED_IN_VEHICLE(iLocal_91, iLocal_93, false))
		{
			if (iLocal_312 == 0)
			{
...
int func_122(int iParam0)
{
	if (iParam0 != func_8())
	{
		...
		else if ((Global_1575046 && iParam0 == PLAYER::PLAYER_ID()) && func_123(iParam0, 1, 0))
		{
			return Global_2689156[iParam0 /*453*/].f_319.f_6 != -1;
		}
	}
...
int func_146()
{
	switch (func_147(&Global_31565, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_155()
{
	...
	if ((((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_strpunk_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_beachvesp_01"))) && STREAMING::HAS_MODEL_LOADED(iLocal_90)) && func_157()) && func_156())
	{
		...
		VEHICLE::_0x0AD9E8F87FF7C16F(iLocal_93, false);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_217()) || Global_31508) || func_216()) || func_22(8, -1)) || func_213()) || func_215()) || func_214()) || func_212()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_217()) || Global_111962) || Global_31508) || func_216()) || func_22(8, -1)) || func_215()) || func_214()) || func_212()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_217() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_22(8, -1)) || func_212()) || func_211()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
float func_225(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
int func_240()
{
	if ((Global_112904 == func_56() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_112905)
	{
		return 1;
	}
	return 0;
