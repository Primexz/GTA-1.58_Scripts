...
void __EntryFunction__()
{
	...
	{
		func_269("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112002[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_269("Relinquishing candidate id...");
				func_268(&(Global_112002[Var0.f_0 /*10*/].f_9));
			}
		}
		func_255(&Var0, 1);
	}
	...
	while (!func_237(&Var0))
	{
		...
		{
			func_269("Player out of range [TERMINATING]");
			func_255(&Var0, 1);
		}
	}
	...
	while (true)
	{
		...
		func_198(Var0.f_0);
		func_191(&iLocal_93, &uLocal_94, &(Var0.f_9), Var61, -1295,84f, 4641,98f, 105,33f, -1301,43f, 4641,21f, 105,62f);
		func_184(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_169(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_2(var* uParam0)
{
	...
	if (!func_168())
	{
		while (!func_159(*uParam0))
		{
			...
			if (!func_199(uParam0, *uParam0 != 2))
			{
				func_269("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_113(uParam0))
	{
		func_269("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_113(var* uParam0)
{
	...
	if (func_143(&(uParam0->f_1)))
	{
		...
		{
			func_269("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
		}
		else
		{
			func_269("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
int func_143(char* sParam0)
{
	...
	func_269("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_175(2))
							{
								if (func_173(uParam0->f_27))
								{
									...
									func_269("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245,8885f, 371,9034f, 103,9884f, 241,5898f, 359,6458f, 107,3461f, 1,25f, false, true, 0))
					{
						if (func_175(2))
						{
							...
							{
								func_172(uParam0->f_27, *uParam0);
								func_269("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728,948f, 4143,44f, 42,29295f, 2722,213f, 4144,521f, 45,43182f, 10f, false, true, 0))
				{
					if (func_175(2))
					{
						...
						{
							func_172(1, *uParam0);
							func_269("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983,5426f, 369,1104f, 68,46017f, -1028,566f, 395,4613f, 94,57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983,875f, 346,7556f, 68,02096f, -1021,451f, 336,3458f, 93,18714f, 14,5f, false, true, 0))
						{
							if (func_175(2))
							{
								...
								{
									func_172(uParam0->f_27, *uParam0);
									func_269("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_172(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_269("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_269("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_184(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(PLAYER::PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_190(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_189(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				func_187(&uVar0, cParam4, sParam5, 7, 0, 0);
				uParam0->f_60 = MISC::GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_185(sParam5))
		{
			if (func_127(PLAYER::PLAYER_PED_ID()))
			{
				if (func_190(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
				{
					func_144();
				}
			}
...
float func_190(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_191(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_190(PLAYER::PLAYER_PED_ID(), Param3, 1) <= 100f)
				{
					func_194(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_190(PLAYER::PLAYER_PED_ID(), Param6, 1);
					fVar1 = func_190(PLAYER::PLAYER_PED_ID(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_190(PLAYER::PLAYER_PED_ID(), Param3, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
int func_199(var uParam0, bool bParam1)
{
	...
	if (Global_77852)
	{
		func_269("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_110(*uParam0, &Var0);
	if ((func_236(*uParam0) || func_234(*uParam0)) || Global_78097 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_269("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_230(*uParam0))
	{
		if (*uParam0 == 19)
		{
			func_229(uParam0->f_28[0]);
		}
		func_269("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_269("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_269("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_203(&(uParam0->f_48)) && bParam1)
	{
		func_200(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}
...
void func_200(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_202(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_201(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_202(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_201(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
void func_204(var uParam0)
{
	...
	if (*uParam0 == 52)
	{
		func_205(&(uParam0->f_41[1]));
		func_205(&(uParam0->f_41[2]));
	}
	if (func_127(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
	...
	if (func_126(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_174(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_174(uParam0->f_35[iVar0]))
								{
									...
									{
										func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_174(iVar3))
						{
							...
							{
								func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_208(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
								func_269("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
	...
	if (func_126(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_269("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_269("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_269("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_228(*uParam0))
					{
						if (!func_158(*uParam0))
						{
							if (func_223(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_269("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_269("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_211(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_269("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_210(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_269("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_269("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_127(uParam0->f_41[0]))
						{
...
int func_211(int iParam0, float fParam1)
{
	...
	{
		if (func_222(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
{
	return func_213(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
int func_217(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_219(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_219(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_225(int iParam0, float fParam1)
{
	...
	{
		if (func_226(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_226(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	...
	Var0 = { func_219(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_235() && Global_99974.f_11 == 6) && iParam0 == func_167(&(Global_99974.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_237(int iParam0)
{
	...
	func_269("Created initial scene");
	return 1;
}
...
int func_238(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_241(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_pumpshotgun"))) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = PED::CREATE_PED(25, iLocal_92, -1299,02f, 4639,86f, 106,66f, 345,7769f, true, true);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_239(&(uParam0->f_35[0]), iVar0[1], -1303,163f, 4648,085f, 104,9664f, 293,1504f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
...
void func_239(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_240(iParam0);
...
int func_243(int iParam0)
{
	...
	if (Global_77852)
	{
		func_269("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_112915.f_9085 && !func_108(1))
	{
		func_269("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_244(iParam0))
	{
		Global_112002[iParam0 /*10*/].f_1 = 1;
		func_269("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_99974.f_11 == 6)
	{
		if (Global_99974 < 9)
		{
			...
			{
				func_269("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112002[iParam0 /*10*/].f_1 = 1;
		func_269("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
int func_252(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	...
	func_269("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}
...
void func_255(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_269("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_257(iParam0, 0, 0, 0);
	}
	func_256(&(iParam0->f_48));
	if (iLocal_93 != -1)
	{
		func_269("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_196(&iLocal_93);
	}
	if (bParam1)
	{
...
void func_257(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_271()
{
	func_269("Running start routines.");
	Global_112633++;
}
