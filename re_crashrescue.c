...
void func_3()
{
	...
	{
		if (func_7(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_6(PLAYER::PLAYER_PED_ID());
			if (func_5(iVar0) && (!func_4(14) || Global_111866))
			{
				if (Global_112915.f_2363.f_539.f_4321 != iVar0 && func_5(Global_112915.f_2363.f_539.f_4321))
				{
...
void func_26()
{
	...
	switch (iLocal_55)
	{
		case 0:
			...
			{
				if (PED::IS_PED_IN_GROUP(iLocal_75) || ENTITY::IS_ENTITY_AT_COORD(iLocal_75, Local_60, Global_22, false, true, 0))
				{
					func_208(1, 0, 1, 0);
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						if (func_206(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 5f, 1, 1056964608, 0, 1, 0))
						{
							iVar0 = 1;
						}
					}
			...
			if (!PED::IS_PED_INJURED(iLocal_75) && !PED::IS_PED_INJURED(iLocal_76))
			{
				if (func_76(&uLocal_88, "RECRAAU", "RECRA_ARRIV", "RECRA_ARRIV_1", 3, 0, 0))
				{
					...
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(iVar1, Local_60, true, false, false, true);
							ENTITY::SET_ENTITY_HEADING(iVar1, 119f);
						}
					...
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_75, false, false);
					MISC::CLEAR_AREA(Local_60, 4f, true, false, false, false);
					func_66(&iVar1);
					iLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, iLocal_271, sLocal_269, "helping_friend_inside_victim", 1000f, -1000f, 0, 0, 1000f, 0);
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_76, iLocal_271, sLocal_269, "helping_friend_inside_friend", 1000f, -1000f, 0, 0, 1000f, 0);
					iLocal_87 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
					CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_87, iLocal_271, "HELPING_FRIEND_INSIDE_CAM", sLocal_269);
		...
		case 4:
			if ((iLocal_288 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_271)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_271) > 0,97f)
			{
...
void func_31(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_48(iParam0))
	{
		...
		{
			func_33(func_39(iParam0, iParam1), Local_48.f_0, Local_48.f_1);
		}
...
void func_34()
{
	...
	{
		func_36(13, SYSTEM::FLOOR(Global_112915.f_10194.f_3853));
	}
...
void func_57(int iParam0, bool bParam1)
{
	...
	{
		case 10:
			MISC::SET_BIT(&(Global_112915.f_1.f_119), 14);
			break;
		
		case 13:
			MISC::SET_BIT(&(Global_112915.f_1.f_119), 16);
			break;
		
		case 12:
			MISC::SET_BIT(&(Global_112915.f_1.f_119), 15);
			break;
		
		case 11:
			MISC::SET_BIT(&(Global_112915.f_1.f_119), 17);
			break;
	}
	if (!bParam1)
	{
...
void func_69(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
void func_77(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			{
				iVar5 = func_120(iParam0, 8);
				if (iVar5 != 9)
				{
					iVar5 = -99;
				}
			}
			iVar6 = func_120(iParam0, 9);
			...
			iVar7 = func_119(iParam0, 1);
			if (!func_118(iVar10, 14, iVar7, -1))
			{
				iVar7 = -99;
			}
			iVar8 = func_119(iParam0, 0);
			if (!func_117(iVar10, 14, iVar8, -1) && !func_116(iVar10, 14, iVar8, -1))
			{
				iVar8 = -99;
			}
			if (iVar10 == joaat("player_one"))
			{
				iVar9 = func_119(iParam0, 2);
			}
		}
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iVar0), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_90(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iVar0), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, iParam4);
						}
						func_122(iVar0);
						if (Global_77661 == 1)
						{
			...
			{
				Global_77663[1 /*14*/] = { func_130(iVar10, iVar0, func_89(iParam0, iVar0, -1), -1) };
	...
	{
		uVar69 = { func_109(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iParam1), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_90(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_90(iParam1), Global_77663[1 /*14*/].f_3, Global_77663[1 /*14*/].f_4, iParam4);
		}
		if (Global_77661 == 1)
		{
			iVar2 = 0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	...
	if (iParam0 == joaat("player_zero"))
	{
		...
		else if (func_117(iParam0, iParam2, iParam3, -1))
		{
				...
				switch (iParam4)
				{
					...
					case 8:
						if (iParam2 == 11 || iParam2 == 3)
						{
							...
							{
								iVar5 = iParam3;
								iVar4 = func_120(iParam0, 3);
							}
							else if (iParam2 == 3)
							{
								iVar4 = iParam3;
								iVar5 = func_120(iParam0, 11);
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar36 = (iParam1 - func_103(iParam0, func_90(iParam2)));
		if (iVar36 < 0)
		{
			return -1;
		}
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_90(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar1 != -1)
		{
			return (func_103(iParam0, func_90(iParam2)) + iVar1);
		}
	}
	return -99;
}
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_115(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[0], Global_112915.f_2363.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_115(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[1], Global_112915.f_2363.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_115(&Var1, -99, -99, Global_112915.f_2363.f_539.f_196[2], Global_112915.f_2363.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_114(Var16.f_2)] = Var16.f_0;
						uParam0->f_16 = 1;
					}
					else
					{
						(*uParam0)[func_114(Var16.f_2)] = func_107(iParam1, Var16.f_0, func_114(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*uParam0)[func_114(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar36++;
		}
...
void func_122(int iParam0)
{
	...
	{
		func_128(iParam0, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 2, Global_77663[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_123(Global_2883588, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_124(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2821895[iParam0 /*3*/][func_125(iParam2)];
	if (iVar0 != 0)
	{
...
int func_126(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12597)
	{
		...
		iVar0 = Global_2821895[iParam0 /*3*/][func_125(iParam1)];
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_126(func_136(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_126(func_135(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_90(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_194(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_77663[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_90(iParam1)) && Global_77663[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_90(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_197(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_198(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_198(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_202(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_200(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_201(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_202(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_203(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_203(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_203(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_203(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_203(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_203(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_203(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_203(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_203(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_203(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_203(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_203(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_203(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_203(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_203(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_203(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_206(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_208(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
		...
		else if (MISC::GET_GAME_TIMER() < iLocal_284)
		{
			...
			if (func_221())
			{
				...
				if (bLocal_256)
				{
					...
					else if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60, Global_19, true, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1722,09f, 3843f, 33,6f, 1740,11f, 3854,94f, 39,22f, 12f, false, true, 0))
					{
						iLocal_54 = 1;
						iLocal_55 = 0;
					}
...
void func_212()
{
	if (!bLocal_256 && func_220(PLAYER::PLAYER_PED_ID(), Local_60, 150f))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_269)) && OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(1728,778f, 3851,287f, 33,7826f, 5f, joaat("prop_skid_chair_01"), false))
		{
			...
			iLocal_271 = PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
			TASK::TASK_SYNCHRONIZED_SCENE(iLocal_76, iLocal_271, sLocal_269, "helping_friend_idle_friend", 1000f, -1000f, 0, 0, 1000f, 0);
			bLocal_256 = true;
		}
	}
}
...
int func_215(struct<3> Param0, bool bParam3)
{
	return func_216(Param0, bParam3);
}

int func_216(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
bool func_220(int iParam0, struct<3> Param1, float fParam4)
{
...
int func_222(int iParam0, bool bParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		{
			uVar0 = func_228(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0), bParam1, 0);
		}
		else if (ENTITY::IS_ENTITY_A_VEHICLE(iParam0))
		{
			uVar0 = func_226(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(iParam0), bParam1, 0);
		}
		else if (ENTITY::IS_ENTITY_AN_OBJECT(iParam0))
		{
			uVar0 = func_223(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(iParam0));
		}
	}
	return uVar0;
}
	...
	switch (iLocal_71)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_75))
			{
				...
				Local_80 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_75, 0f, 0f, 5f) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(Local_80, &(Local_80.f_2), false, false);
				Local_83 = { func_241() };
				Local_83.f_2 = func_240((fLocal_275 + 180f), 0f, 360f);
				iLocal_270 = PED::CREATE_SYNCHRONIZED_SCENE(Local_80, Local_83, 2);
				iLocal_86 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_86, iLocal_270, "HELPING_VICTIM_TO_FEET_CAM", sLocal_263);
				...
				iLocal_280 = GRAPHICS::ADD_DECAL(1110, Local_272, 0f, 0f, -1f, func_204(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
				if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) == 1)
				{
					PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), false, 0);
				}
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", 1000f, -4f, 0, 0, 1000f, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_75, iLocal_270, sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", 1000f, -4f, 0, 0, 1000f, 0);
		...
		case 3:
			...
			else if (func_237(iLocal_270, 0,9f))
			{
		...
		case 4:
			...
			if (iLocal_254)
			{
				...
				PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
				PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_75, false, false);
				Var0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", Local_80, Local_83, 1f, 2) };
				...
				Var0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_263, "HELPING_VICTIM_TO_FEET_PLAYER", Local_80, Local_83, 1f, 2) };
				ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), Var0.f_2);
				Var0 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", Local_80, Local_83, 1f, 2) };
				MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &(Var0.f_2), false, false);
				ENTITY::SET_ENTITY_COORDS(iLocal_75, Var0, true, false, false, true);
				Var0 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_263, "HELPING_VICTIM_TO_FEET_VICTIM", Local_80, Local_83, 1f, 2) };
				ENTITY::SET_ENTITY_HEADING(iLocal_75, Var0.f_2);
			}
			else
			{
				if (!bLocal_255)
...
int func_243(int iParam0)
{
	if (func_247())
	{
		...
		if (func_40(Global_112904))
		{
			func_244(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_40(Global_112904))
		{
...
int func_247()
{
	switch (func_248(&Global_31565, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_251(iParam0, Global_42596);
}
...
int func_253()
{
	if ((Global_112904 == func_49() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_112905)
	{
		return 1;
	}
	return 0;
...
void func_261()
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_258) && STREAMING::HAS_MODEL_LOADED(iLocal_260)) && STREAMING::HAS_MODEL_LOADED(iLocal_259)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_261)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_262)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_266)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_267)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_264)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		MISC::GET_MODEL_DIMENSIONS(iLocal_260, &uVar0, &Var3);
		VEHICLE::SMASH_VEHICLE_WINDOW(iLocal_79, 0);
		VEHICLE::SMASH_VEHICLE_WINDOW(iLocal_79, 2);
		VEHICLE::SMASH_VEHICLE_WINDOW(iLocal_79, 3);
		VEHICLE::POP_OUT_VEHICLE_WINDSCREEN(iLocal_79);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, Var3.f_1, 0f, 500f, 10000f, true);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, Var3.f_0, (Var3.f_1 * 0,75f), 0f, 500f, 10000f, true);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, Var3.f_0, 0f, 0f, 500f, 10000f, true);
		VEHICLE::SET_VEHICLE_DAMAGE(iLocal_79, 0f, 0f, Var3.f_2, 500f, 10000f, true);
		...
		if (bLocal_276)
		{
			iLocal_75 = PED::CREATE_PED(26, iLocal_259, Local_272, (fLocal_275 - 180f), true, true);
		}
		else
		{
			iLocal_75 = PED::CREATE_PED(26, iLocal_259, Local_272, fLocal_275, true, true);
		}
		PED::APPLY_PED_BLOOD_DAMAGE_BY_ZONE(iLocal_75, 0, 0,7f, 0,5f, 2);
		Local_63 = { ENTITY::GET_ENTITY_COORDS(iLocal_75, true) };
		MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Local_63.f_0, (Local_63.f_1 + 0,1f), (Local_63.f_2 + 0,1f), Local_63.f_0, (Local_63.f_1 - 0,1f), (Local_63.f_2 - 0,1f), 1, true, joaat("weapon_assaultrifle"), 0, true, true, -1f);
		...
		iLocal_78 = 1;
		Local_63 = { ENTITY::GET_ENTITY_COORDS(iLocal_77, true) };
...
int func_279(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_314(Global_112915.f_24995.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_280(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_111962) || Global_31508) || func_311()) || func_22(8, -1)) || func_310()) || func_309()) || func_308()) || func_307()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_312()) || Global_31508) || func_311()) || func_22(8, -1)) || func_308()) || func_310()) || func_309()) || func_307()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_111962) || Global_31508) || func_311()) || func_22(8, -1)) || func_308()) || func_310()) || func_309()) || func_307()) || Global_112915.f_7688.f_919[iVar0] == 5) || Global_43143 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_312()) || Global_111962) || Global_31508) || func_311()) || func_22(8, -1)) || func_310()) || func_309()) || func_307()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_312() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_22(8, -1)) || func_307()) || func_306()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_312()) || Global_31508) || func_311()) || func_22(8, -1)) || func_309()) || func_308()) || func_307()) || Global_112915.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_312()) || func_309()) || Global_111962) || Global_31508) || func_311()) || Global_43774) || func_22(8, -1)) || func_308()) || func_306()) || func_307()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_312()) || Global_111962) || Global_31508) || func_311()) || func_22(8, -1)) || func_308()) || func_306()) || func_310()) || func_309()) || func_307())
						{
							return 0;
						}
						break;
...
void func_322()
{
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(Local_57 - Vector(3f, 3f, 3f), Local_57 + Vector(3f, 3f, 3f), 1);
...
void func_323(int iParam0)
{
	...
	if (func_253())
	{
		...
		func_326(30000);
		StringCopy(&cVar0, func_325(Global_112904, 1), 64);
		if (func_48(Global_112904) > 0)
		{
...
void func_328(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = func_295();
	func_331(&uVar0, 0, 0, iParam2, iParam1, 0, 0);
