...
void func_24(char* sParam0)
{
	...
	if (iVar0 == 2)
	{
		if (iLocal_299[2] == 1)
		{
			StringCopy(sParam0, "Bill_ig_4_03_convo_TheEliteAreOutToCrush", 64);
		}
		else
		{
			StringCopy(sParam0, "BILL_IG_5_02_CONVO_GoodToSeeYouAgain", 64);
		}
	}
	else if (iVar0 == 0)
	{
		StringCopy(sParam0, "Bill_ig_2_CONVO_michael_YouSeemMellow", 64);
	}
	else if (iVar0 == 1)
	{
		StringCopy(sParam0, "bill_ig_3_convo_franklin_nothingisupman", 64);
	}
}
...
{
	StringCopy(sParam1, "Special_Ped@bill", 32);
	switch (iParam0)
	{
		case 1:
			StringCopy(sParam2, "Bill_ig_1_A_01_IHearWhatYourSayin", 64);
			break;
		
		case 2:
			StringCopy(sParam2, "Bill_ig_1_A_03_OhIKnowWhatYouAreThinking", 64);
			break;
		
		case 3:
			StringCopy(sParam2, "Bill_ig_1_A_04_TheWholePlaceIsAGoddamPonzieScheme", 64);
			break;
		
		case 4:
			StringCopy(sParam2, "Bill_ig_1_B_01_ImOfferingIronClad", 64);
			break;
		
		case 5:
			StringCopy(sParam2, "Bill_ig_1_B_02_IKnowWhatYouAreThinking", 64);
			break;
		
		case 6:
			StringCopy(sParam2, "Bill_ig_1_C_01_DontBeAFool", 64);
			break;
		
		case 7:
			StringCopy(sParam2, "Bill_ig_1_C_02_YesItsADogEatDog", 64);
			break;
		
		case 8:
			StringCopy(sParam2, "Bill_ig_1_C_03_ILikeSharingInformation", 64);
			break;
	}
}
...
void func_105()
{
	...
	StringCopy(&Local_234, "PBBB", 8);
	StringCopy(&Local_236, "BILLBINDER", 16);
	...
	bLocal_436 = !Global_3;
	iLocal_252 = 8;
	sLocal_303 = "PBBB_INTERACT";
	StringCopy(&Local_312, "PBBB_CONV_GM", 16);
	StringCopy(&Local_316, "PBBB_CONV_GT", 16);
	StringCopy(&Local_320, "PBBB_CONV_GF", 16);
	StringCopy(&cLocal_324, "special_ped@bill@base", 64);
	StringCopy(&cLocal_340, "special_ped@bill@intro", 64);
	iLocal_251 = 2;
	iLocal_255[0] = 7;
	iLocal_255[1] = 5;
	iLocal_255[2] = 5;
