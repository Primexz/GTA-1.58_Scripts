...
void func_1()
{
	...
	if (iLocal_31 < 32)
	{
		bVar0 = MISC::IS_BIT_SET(Global_112915.f_10049.f_96, iLocal_31);
	}
	else if (iLocal_31 < 64)
	{
		bVar0 = MISC::IS_BIT_SET(Global_112915.f_10049.f_97, (iLocal_31 - 32));
	}
	else
	{
		bVar0 = MISC::IS_BIT_SET(Global_112915.f_10049.f_98, (iLocal_31 - 64));
	}
	if (bVar0)
	{
	}
	else
	{
		...
		if (iLocal_31 < 32)
		{
			MISC::SET_BIT(&(Global_112915.f_10049.f_96), iLocal_31);
		}
		else if (iLocal_31 < 64)
		{
			MISC::SET_BIT(&(Global_112915.f_10049.f_97), (iLocal_31 - 32));
		}
		else
		{
			MISC::SET_BIT(&(Global_112915.f_10049.f_98), (iLocal_31 - 64));
		}
		Global_96419 = 1;
		func_30();
		iLocal_29 = 1;
...
void func_9()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_12(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(iVar0) && (!func_53(14) || Global_111866))
			{
...
void func_16()
{
	if ((MISC::GET_GAME_TIMER() - iLocal_268) > 500)
	{
		if (iLocal_31 == 29)
		{
			if (MISC::IS_BIT_SET(Global_112915.f_10049.f_96, iLocal_31))
			{
				bLocal_267 = true;
			}
		}
...
void func_26()
{
	...
	{
		if (MISC::IS_BIT_SET(Global_112915.f_10049.f_97, (iLocal_31 - 32)))
		{
			bLocal_267 = true;
		}
	}
	else if (MISC::IS_BIT_SET(Global_112915.f_10049.f_98, (iLocal_31 - 64)))
	{
		bLocal_267 = true;
	}
	if (bLocal_267)
...
void func_45()
{
	...
	{
		func_48(13, SYSTEM::FLOOR(Global_112915.f_10194.f_3853));
	}
...
void func_47(int iParam0, bool bParam1, int iParam2)
{
	if (iParam2 == -1)
	{
		iParam2 = func_6();
...
int func_49()
{
	...
	while (iVar1 < 32)
	{
		if (MISC::IS_BIT_SET(Global_112915.f_10049.f_96, iVar1))
		{
			if (func_50(iVar1))
			{
				iVar0++;
		...
		if (MISC::IS_BIT_SET(Global_112915.f_10049.f_97, iVar1))
		{
			if (func_50(iVar1 + 32))
			{
				iVar0++;
		...
		if (MISC::IS_BIT_SET(Global_112915.f_10049.f_98, iVar1))
		{
			if (func_50(iVar1 + 64))
			{
				iVar0++;
