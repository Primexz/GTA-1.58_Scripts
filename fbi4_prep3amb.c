...
void func_175()
{
	if ((MISC::IS_BIT_SET(iLocal_105, 0) && Global_42596 == 15) && !func_207())
	{
		if (iLocal_38 == 0)
		{
			if (!MISC::IS_BIT_SET(iLocal_105, 1))
			{
				if (!func_76(PLAYER::PLAYER_PED_ID(), Local_106, 5f))
				{
					...
					{
						if ((func_249(PLAYER::PLAYER_PED_ID()) && !MISC::IS_BIT_SET(uLocal_101[0], 17)) && !MISC::IS_BIT_SET(uLocal_101[1], 18))
						{
...
int func_184()
{
	...
	while (iVar6 <= 4)
	{
		if (func_249(uVar0[iVar6]) && uVar0[iVar6] != PLAYER::PLAYER_PED_ID())
		{
...
int func_220(var uParam0)
{
	...
	if (func_249(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (func_85(iVar0))
		{
...
void func_222()
{
	...
	if (((((((Global_42596 == 15 && iLocal_37 != 3) && MISC::IS_BIT_SET(iLocal_105, 5)) && !func_207()) && Global_77849 == -1) && !func_232()) && !func_84(9)) || func_103(35))
	{
		func_231();
		func_229();
		switch (iLocal_39)
...
void func_223(int iParam0, bool bParam1)
{
	...
	{
		case 1:
			if ((!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_226(func_89())) && !func_225())
			{
...
int func_245(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_96() == 0)
		{
			return MISC::IS_BIT_SET(func_246(func_248(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
struct<8> func_255(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<8> Var0;
