								...
								if (!func_78())
								{
									...
									while (iVar0 < 4)
									{
										if (bLocal_267)
										{
											...
											func_72(iLocal_176[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &fLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_72(iLocal_176[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &fLocal_112, &uLocal_116, 0f, 2f, 0f, 1000, 0f);
										...
										else if (bLocal_264)
										{
											...
											func_72(iLocal_166[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &fLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_72(iLocal_166[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &fLocal_112, &uLocal_116, 0f, 5f, 0f, 1000, 0f);
										...
										else if (bLocal_265)
										{
											...
											func_72(iLocal_171[0], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &fLocal_112, &uLocal_116, 0f, 0f, 0f, 1000, 0f);
											func_72(iLocal_171[1], PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_108, &uLocal_111, &Local_113, &fLocal_112, &uLocal_116, 0f, 5f, 0f, 1000, 0f);
...
void func_7(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_112915.f_20564.f_471, iParam0) || MISC::IS_BIT_SET(Global_2359296[func_9() /*5559*/].f_675.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_112915.f_20564.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_9() /*5559*/].f_675.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_15(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2359296[func_9() /*5559*/].f_675.f_10, iParam0);
}
...
void func_39()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_42(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_40(iVar0) && (!func_32(14) || Global_111866))
			{
...
int func_68(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_72(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, float fParam5, var uParam6, struct<3> Param7, int iParam10, float fParam11)
{
	struct<3> Var0;
				...
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_243, iLocal_132, &(Local_439[0 /*3*/]), 1, 1077936128, 0))
				{
					...
					if (!CAM::IS_SPHERE_VISIBLE(Local_439[0 /*3*/], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_439[1 /*3*/], 7f))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_166[0], false))
						{
							...
							func_96(iLocal_166[0], iLocal_150[0]);
						}
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_166[1], false))
						{
							...
							func_96(iLocal_166[1], iLocal_150[1]);
						}
						if (func_38() == 0)
						{
				...
				if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_243, iLocal_132, &(Local_439[0 /*3*/]), 1, 1077936128, 0))
				{
					...
					if (!CAM::IS_SPHERE_VISIBLE(Local_439[0 /*3*/], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_439[1 /*3*/], 7f))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_171[0], false))
						{
							...
							func_96(iLocal_171[0], iLocal_155[0]);
						}
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_171[1], false))
						{
							...
							func_96(iLocal_171[1], iLocal_155[1]);
						}
						if (func_38() == 0)
						{
							func_80(&uLocal_271, "REDGWAU", "REDGW_MAWAY", 4, 0, 0, 0);
			...
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Local_243, iLocal_132, &(Local_439[0 /*3*/]), 1, 1077936128, 0))
			{
				...
				if (!CAM::IS_SPHERE_VISIBLE(Local_439[0 /*3*/], 7f) && !CAM::IS_SPHERE_VISIBLE(Local_439[1 /*3*/], 7f))
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_176[0], false))
					{
						...
						func_96(iLocal_176[0], iLocal_150[0]);
					}
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_176[1], false))
					{
						...
						func_96(iLocal_176[1], iLocal_150[1]);
					}
					if (func_38() == 0)
					{
						func_80(&uLocal_271, "REDGWAU", "REDGW_MAWAY", 4, 0, 0, 0);
		...
		case 6:
			if (func_66())
			{
				...
				if (iLocal_134 < 5 && iLocal_135 < MISC::GET_GAME_TIMER())
				{
					...
					MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS((Local_90.f_0 + fLocal_120), (Local_90.f_1 + fLocal_121), (Local_90.f_2 + fLocal_122), (Local_90.f_0 - fLocal_120), (Local_90.f_1 - fLocal_121), Local_90.f_2, 10, false, joaat("weapon_assaultrifle"), 0, true, true, -1f);
...
void func_96(int iParam0, int iParam1)
{
	...
	ENTITY::SET_ENTITY_HEADING(iParam0, MISC::GET_HEADING_FROM_VECTOR_2D(Local_452.f_0, Local_452.f_1));
	if (bLocal_267)
	{
...
void func_97()
{
	...
	while (iVar0 < 4)
	{
		if (!PED::IS_PED_INJURED(iLocal_150[iVar0]))
		{
			...
			func_98(&uLocal_271, 4, iLocal_150[iVar0], "REDGWChinese", 0, 1);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!PED::IS_PED_INJURED(iLocal_150[iVar0]))
		{
			...
			else
			{
				...
				func_98(&uLocal_271, 5, iLocal_155[iVar0], "REDGWSalvadoran", 0, 1);
			}
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, iLocal_269, joaat("player"));
...
void func_99()
{
	...
	switch (iLocal_130)
	{
		...
		case 3:
			...
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_269, joaat("player"));
			if (bLocal_264)
			{
				iVar2 = 0;
				while (iVar2 < 4)
		...
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_136))
			{
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_237, 7f, 7f, 10f, false, true, 0))
				{
					...
					if (!HUD::DOES_BLIP_EXIST(iLocal_182))
					{
						iLocal_182 = func_101(iLocal_214);
					}
					iLocal_127 = MISC::GET_GAME_TIMER();
					iLocal_128++;
				}
...
int func_105(int iParam0)
{
	if (func_109())
	{
		...
		if (func_54(Global_112904))
		{
			func_106(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_54(Global_112904))
		{
...
int func_109()
{
	switch (func_110(&Global_31565, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
void func_115()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_160[0], false))
	{
		...
		{
			AUDIO::SET_HORN_PERMANENTLY_ON_TIME(iLocal_160[0], 60000f);
			AUDIO::SET_HORN_PERMANENTLY_ON(iLocal_160[0]);
		}
	}
	if (!PED::IS_PED_INJURED(iLocal_136))
	{
...
void func_116()
{
	...
	if ((((((((STREAMING::HAS_MODEL_LOADED(joaat("g_m_m_chigoon_02")) && STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_03"))) && STREAMING::HAS_MODEL_LOADED(joaat("rebel"))) && STREAMING::HAS_MODEL_LOADED(joaat("bobcatxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("sanchez"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_c_rottweiler"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_security_case_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrong")) && STREAMING::HAS_ANIM_DICT_LOADED("random@dealgonewrongdead_peds"))
	{
		...
		func_98(&uLocal_271, 4, iLocal_137[6], "REDGWChinese", 0, 1);
		...
		func_98(&uLocal_271, 5, iLocal_137[7], "REDGWSalvadoran", 0, 1);
		...
		func_98(&uLocal_271, 4, iLocal_136, "REDGWChinese", 0, 1);
		...
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_270, joaat("player"));
		if (func_38() == 0)
		{
			func_98(&uLocal_271, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		if (func_38() == 1)
		{
			func_98(&uLocal_271, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		if (func_38() == 2)
		{
			func_98(&uLocal_271, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
		iLocal_221[0] = GRAPHICS::ADD_DECAL(1110, -1632,953f, 4745,359f, 51,7876f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[1] = GRAPHICS::ADD_DECAL(1110, -1634,87f, 4744,458f, 51,8233f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[2] = GRAPHICS::ADD_DECAL(1110, -1636,971f, 4736,595f, 52,2814f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[3] = GRAPHICS::ADD_DECAL(1110, -1625,561f, 4741,241f, 51,7102f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[4] = GRAPHICS::ADD_DECAL(1110, -1621,533f, 4744,576f, 51,9093f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[5] = GRAPHICS::ADD_DECAL(1110, -1621,963f, 4737,039f, 51,4174f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[6] = GRAPHICS::ADD_DECAL(1110, -1628,517f, 4736,906f, 51,8207f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[7] = GRAPHICS::ADD_DECAL(1110, -1629,324f, 4732,146f, 51,6947f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[8] = GRAPHICS::ADD_DECAL(1110, -1640,287f, 4738,437f, 52,1756f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[9] = GRAPHICS::ADD_DECAL(1110, -1640,055f, 4701,995f, 41,2428f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		SYSTEM::WAIT(0);
		iLocal_221[10] = GRAPHICS::ADD_DECAL(1110, -1641,924f, 4692,236f, 38,3762f, 0f, 0f, -1f, func_117(0f, 1f, 0f), 1f, 1f, 0,196f, 0f, 0f, 1f, -1f, false, false, false);
		iVar1 = 0;
		while (iVar1 < 6)
		{
...
int func_132()
{
	if ((Global_112904 == func_63() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_112905)
	{
		return 1;
	}
	return 0;
...
int func_136(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_172(Global_112915.f_24995.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_170()) || Global_111962) || Global_31508) || func_169()) || func_93(8, -1)) || func_168()) || func_167()) || func_166()) || func_165()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_170()) || Global_31508) || func_169()) || func_93(8, -1)) || func_166()) || func_168()) || func_167()) || func_165()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_170()) || Global_111962) || Global_31508) || func_169()) || func_93(8, -1)) || func_166()) || func_168()) || func_167()) || func_165()) || Global_112915.f_7688.f_919[iVar0] == 5) || Global_43143 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_170()) || Global_111962) || Global_31508) || func_169()) || func_93(8, -1)) || func_168()) || func_167()) || func_165()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_170() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_93(8, -1)) || func_165()) || func_164()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_170()) || Global_31508) || func_169()) || func_93(8, -1)) || func_167()) || func_166()) || func_165()) || Global_112915.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_170()) || func_167()) || Global_111962) || Global_31508) || func_169()) || Global_43774) || func_93(8, -1)) || func_166()) || func_164()) || func_165()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_170()) || Global_111962) || Global_31508) || func_169()) || func_93(8, -1)) || func_166()) || func_164()) || func_168()) || func_167()) || func_165())
						{
							return 0;
						}
						break;
...
void func_179(int iParam0)
{
	...
	if (func_132())
	{
		...
		func_182(30000);
		StringCopy(&cVar0, func_181(Global_112904, 1), 64);
		if (func_62(Global_112904) > 0)
		{
