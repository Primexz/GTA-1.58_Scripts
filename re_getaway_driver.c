...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		...
		func_244(Var1, &iLocal_290, bVar12);
	}
	func_243(&uLocal_314, 3);
	if (func_212(Local_234, -1, 0, 0, 0))
	{
		func_209(-1);
	}
	else
	...
	while (iVar0 != 7)
	{
		iVar18 = 0;
		func_206(&uLocal_314);
		if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !func_205())
		{
			iVar18 = 0;
			iVar0 = 7;
			func_244(Var1, &iLocal_290, bVar12);
		...
		{
			if (PED::IS_COP_PED_IN_AREA_3D(func_184(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_184(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(func_184(PLAYER::PLAYER_ID()) - Vector(10f, 20f, 20f), func_184(PLAYER::PLAYER_ID()) + Vector(10f, 20f, 20f)))
			{
	...
	switch (*iParam0)
	{
						...
						if (ENTITY::GET_ENTITY_SPEED(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) < 0,1f)
						{
							if (func_126() && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
							{
								...
								if (!PED::IS_PED_INJURED(iLocal_289))
								{
									...
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var56, iLocal_289, 3f, false, 0,5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_290[0], iLocal_309);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
									...
									TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var59, iLocal_289, 3f, false, 0,5f, 4f, true, 0, false, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
									TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 10000, 2096, 4);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_309);
									TASK::TASK_PERFORM_SEQUENCE(iLocal_290[1], iLocal_309);
									TASK::CLEAR_SEQUENCE_TASK(&iLocal_309);
		...
		case 10:
			...
			else
			{
				...
				if (func_62(Var15[iLocal_223 /*3*/], 0f, 0f, 0f, 0))
				{
					iLocal_223 = 0;
				}
				iLocal_53 = func_60(Var15[iLocal_223 /*3*/], 1);
				if (func_117() == 2 && !func_59())
				{
					if (!HUD::DOES_BLIP_EXIST(iLocal_288))
					{
						iLocal_288 = func_60(Local_270, 0);
		...
		case 18:
			iLocal_283 = 1;
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_310, joaat("player"));
...
void func_8()
{
	...
	{
		if (func_12(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_11(PLAYER::PLAYER_PED_ID());
			if (func_10(iVar0) && (!func_9(14) || Global_111866))
			{
...
void func_18(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_19(func_51(iParam0), 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_22(int iParam0)
{
	...
	else if (MISC::IS_BIT_SET(Global_112915.f_20564.f_471, iParam0) || MISC::IS_BIT_SET(Global_2359296[func_24() /*5559*/].f_675.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_112915.f_20564.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_24() /*5559*/].f_675.f_10), iParam0);
	}
	if (bVar0)
	{
...
void func_25(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = Global_2821895[iParam0 /*3*/][func_26(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_30(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_2359296[func_24() /*5559*/].f_675.f_10, iParam0);
}
...
int func_31(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 12597)
	{
		...
		iVar0 = Global_2821895[iParam0 /*3*/][func_26(iParam1)];
...
int func_60(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_79(int iParam0, int iParam1)
{
	...
	func_80(iParam0, &(Global_112915.f_32749.f_5510));
}
...
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_101(iParam0, 0, 0)) || func_101(iParam0, 1, 0)) || func_101(iParam0, 2, 0)) || func_100(iParam0) != 145) || func_99(iParam0)) || func_98(iParam0)) || func_97(iParam0)) || func_96(iParam0)) || !func_86(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_98(iParam0))
		{
		}
...
int func_104(int iParam0)
{
	if (func_108())
	{
		...
		if (func_107(Global_112904))
		{
			func_105(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_107(Global_112904))
		{
...
int func_108()
{
	switch (func_109(&Global_31565, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_112(iParam0, Global_42596);
}
...
void func_119(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_121() == 0)
		{
			iVar0 = func_31(func_120(iParam0), -1, 0);
			MISC::CLEAR_BIT(&iVar0, iParam1);
			func_25(func_120(iParam0), iVar0, -1, 1, 0);
		}
	}
	else
	{
...
int func_123(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_121() == 0)
		{
			return MISC::IS_BIT_SET(func_31(func_120(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_124(struct<3> Param0, float fParam3, int iParam4)
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_111962) || Global_31508) || func_138()) || func_137(8, -1)) || func_136()) || func_135()) || func_134()) || func_133()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_139()) || Global_31508) || func_138()) || func_137(8, -1)) || func_134()) || func_136()) || func_135()) || func_133()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_111962) || Global_31508) || func_138()) || func_137(8, -1)) || func_134()) || func_136()) || func_135()) || func_133()) || Global_112915.f_7688.f_919[iVar0] == 5) || Global_43143 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_111962) || Global_31508) || func_138()) || func_137(8, -1)) || func_136()) || func_135()) || func_133()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_139() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_137(8, -1)) || func_133()) || func_132()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_139()) || Global_31508) || func_138()) || func_137(8, -1)) || func_135()) || func_134()) || func_133()) || Global_112915.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_139()) || Global_111962) || Global_31508) || func_138()) || func_137(8, -1)) || func_134()) || func_132()) || func_136()) || func_135()) || func_133())
						{
							return 0;
						}
						break;
...
void func_155(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
void func_165()
{
	if (!bLocal_278)
	{
		PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(func_184(PLAYER::PLAYER_ID()) - Vector(0f, 10f, 0f), MISC::GET_RANDOM_INT_IN_RANGE(5, 15), &Local_243, 1, 1077936128, 0);
...
void func_190()
{
	...
	{
		func_47(13, SYSTEM::FLOOR(Global_112915.f_10194.f_3853));
	}
...
int func_205()
{
	if ((Global_112904 == func_195() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_112905)
	{
		return 1;
	}
	return 0;
...
{
	func_208(iParam0, &(iParam0->f_2), iParam0->f_1);
}
...
int func_212(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (func_10(func_117()))
		{
			if (func_240(func_117()) == 4 || func_240(func_117()) == 5)
			{
				return 0;
			}
		}
		if (func_10(func_117()))
		{
			if (!func_239(iParam3, iParam4, 145))
			{
				return 0;
			}
		}
		if (!func_238(Global_112915.f_24995.f_43[iParam3]))
		{
			return 0;
		}
...
int func_228()
{
	...
	func_234(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_233(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_232(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_231(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_230(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_229(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}
...
void func_244(struct<9> Param0, int iParam9, bool bParam10)
{
	int iVar0;
	...
	if (iLocal_313)
	{
		...
		if (!bParam10)
		{
			if (!PED::IS_PED_INJURED((*iParam9)[0]))
			{
				TASK::TASK_SMART_FLEE_COORD((*iParam9)[0], func_184(PLAYER::PLAYER_ID()), 200f, -1, false, false);
			}
			if (!PED::IS_PED_INJURED((*iParam9)[1]))
			{
				TASK::TASK_SMART_FLEE_COORD((*iParam9)[1], func_184(PLAYER::PLAYER_ID()), 200f, -1, false, false);
			}
		}
		if (!iLocal_220)
		{
...
void func_245(int iParam0)
{
	...
	if (func_205())
	{
		...
		func_248(30000);
		StringCopy(&cVar0, func_247(Global_112904, 1), 64);
		if (func_194(Global_112904) > 0)
		{
...
char* func_247(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 0:
...
{
	func_250(iParam0, 0, func_255(iParam0));
}
...
void func_250(int iParam0, int iParam1, int iParam2)
{
	...
	uVar0 = func_228();
	func_253(&uVar0, 0, 0, iParam2, iParam1, 0, 0);
	func_252(iParam0, &uVar0);
	Var1 = { func_251(&uVar0) };
}

struct<16> func_251(var uParam0)
{
	struct<16> Var0;
	int iVar16;
...
void func_253(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = (iVar0 + iParam6);
	func_254(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
