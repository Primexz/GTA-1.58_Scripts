...
void __EntryFunction__()
{
	...
	{
		func_289("Force cleanup [TERMINATING]");
		func_266(1);
		func_250();
	}
	while (true)
	{
		...
		func_233(Local_79.f_9, 0, 0, 0, 0, 0);
		...
		case 1:
			switch (iLocal_142)
			{
				...
				case 1:
					...
					{
						func_217(1974,513f, 3814,579f, 32,4266f, 1, 1, 1, 1, 0, 1, 1, 1, 1, 1);
						iLocal_142++;
					}
					break;
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_216(PLAYER::PLAYER_PED_ID(), 1974,513f, 3814,579f, 32,4266f, 270f, 0, 1);
...
void func_203(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_204(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_204(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_204(uParam0->f_41[iVar0]))
		{
...
void func_207(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_211(PLAYER::PLAYER_ID())) && !func_209(PLAYER::PLAYER_ID(), 0)) && !func_208()) && !bParam4) && !bParam5)
			{
...
int func_216(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_217(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_218(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
int func_223(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_230(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_229(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
int func_230(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_232(char* sParam0, bool bParam1)
{
	func_220(bParam1);
	CUTSCENE::REQUEST_CUTSCENE(sParam0, 8);
}

void func_233(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_235(Global_78107, Global_78109, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
...
float func_234(char* sParam0)
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(sParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(true);
}

struct<2> func_235(int iParam0, int iParam1, int iParam2)
{
	struct<2> Var0;
	int iVar2;
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_236(iVar2), 8);
					break;
			}
			break;
...
int func_244(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_247(0) || Global_78121) || Global_78110 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78106)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_246(0)) || func_245(1))
			{
			}
			else
			{
...
{
	return func_249(iParam0, Global_42596);
}
...
void func_250()
{
	...
	func_251(&Local_79, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_251(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_261(uParam0, iParam1);
	func_256(uParam0, bParam2);
	func_252(uParam0, bParam3);
}

void func_252(var uParam0, bool bParam1)
{
	func_253(&(uParam0->f_41), bParam1);
}
...
void func_262(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_263(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_263(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
void func_266(bool bParam0)
{
	...
	if (!func_287())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_267(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112002[iVar0 /*10*/].f_9 == -1)
...
int func_268(char* sParam0, int iParam1, int iParam2)
{
	int iVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_274())
	{
		...
		{
			iVar33 = func_269(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_270()
{
	...
	iVar0 = func_271(&(Global_99974.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_274()
{
	...
	{
		if (func_269(&(Global_99974.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_291(&(uParam0->f_28));
	func_291(&(uParam0->f_35));
	func_291(&(uParam0->f_41));
}
