...
void __EntryFunction__()
{
	...
	iLocal_92 = func_293(56);
	iLocal_93 = func_293(57);
	iLocal_94 = func_293(59);
	...
	if (!func_270(&iVar64, &Var0, Var61, 1f))
	{
		func_269();
	...
	if (Var0.f_0 == 32)
	{
		...
		MISC::CLEAR_AREA(Var61, 40f, true, false, false, false);
	}
	else if (Var0.f_0 == 34)
	{
		iLocal_97 = func_245();
	...
	while (true)
	{
		...
		if (Var0.f_0 == 32)
		{
			...
			{
				if (!func_207(329,513f, 3402,691f, 36,258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], true), 1056964608))
				{
		...
		func_203(Var0.f_0);
		func_196(&iLocal_96, &(Var0.f_9), Var61);
		if (Var0.f_0 == 32)
		{
			func_192(&Var0, Var61, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_99);
		}
		else if (Var0.f_0 == 34)
		{
			func_187(&Var0, Var61, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_173(&Var0, 0))
		{
			if (func_172(Var0.f_0))
			{
				func_169(Var0.f_0, &iLocal_98);
			}
			if (!func_2(&Var0))
			{
				func_273(&Var0, 1);
...
int func_187(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_191(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
float func_191(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	...
	if (!*uParam10 == 3)
	{
		if (func_178(2))
		{
			if (!func_146())
			{
				if (((func_127(PLAYER::PLAYER_PED_ID()) && func_127(iParam0->f_28[0])) && func_127(iParam0->f_28[1])) && func_191(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
			...
			else if (((func_194(sParam5) && !*uParam10 == 1) && func_127(PLAYER::PLAYER_PED_ID())) && func_191(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_290("pause conversation");
				func_193(1);
				*uParam10 = 1;
			}
			if (func_191(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
void func_196(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_191(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_199(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_191(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_201(iParam0);
				}
			}
...
int func_207(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_211(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_213(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_212(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_213(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_212(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar4 = func_230(iParam0, iParam1);
	if (!func_127(iParam0) || !func_127(iParam1))
	{
		if (iVar4 != -1)
		{
			func_229(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_223(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_223(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_228(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_228(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_227(Var3, Var0);
...
float func_227(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_228(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
int func_234(int iParam0, float fParam1)
{
	...
	{
		if (func_235(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_228(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_243() && Global_99974.f_11 == 6) && iParam0 == func_167(&(Global_99974.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245()
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-309,1f, 6205,4f, 30f, -279,33f, 6217,98f, 40f, false, true, true, true);
}
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_41[1], uParam0->f_28[0], PED::GET_PED_BONE_INDEX(uParam0->f_28[0], 18905), 0,12f, 0f, 0,03f, 90f, 0f, 90f, false, false, false, false, 2, true);
			}
			if (bVar7)
			{
				iLocal_91 = 3;
...
void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_249(iParam0);
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_251(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_258(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			MISC::CLEAR_AREA(321,69f, 3408,64f, 35,34f, 10f, true, false, false, false);
			if (!func_255(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmminute1"))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_270(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_271((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_271((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_271(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_272(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_272(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
