...
void func_24(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_76(PLAYER::PLAYER_PED_ID(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_75(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
...
int func_69(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar11]) && !PED::IS_PED_INJURED(uVar0[iVar11])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar11])) && func_76(uVar0[iVar11], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar11++;
...
int func_70(var uParam0)
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (func_76(PLAYER::GET_PLAYER_PED(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_71(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
int func_75(int iParam0, struct<3> Param1, int iParam4)
{
...
void func_80(var uParam0)
{
	...
	else if (uParam0->f_13 > 4)
	{
		...
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_81());
...
{
	func_83(&(uParam0->f_7), 4, func_84());
	func_83(&(uParam0->f_7), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false));
	func_83(&(uParam0->f_7), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true));
	func_83(&(uParam0->f_7), 0, func_50(0));
	func_83(&(uParam0->f_7), 2, TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_85()
{
	...
	if (func_97(PLAYER::PLAYER_ID()) && CAM::IS_SCREEN_FADED_OUT())
	{
		return 1;
	}
	if (func_86())
...
int func_86()
{
	...
	if (func_87() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(func_87()) == 0)
		{
			return 1;
		}
	}
...
int func_97(int iParam0)
{
	...
	{
		if (func_99(iParam0) && !func_98(iParam0))
		{
			return 1;
		}
	}
...
int func_100(int iParam0)
{
	if (iParam0 != func_72())
	{
		if (func_73(iParam0, 1, 1))
		{
			...
			{
				return func_101(Global_2689156[iParam0 /*453*/].f_319.f_6) == 22;
			}
		}
	}
	return 0;
...
int func_102()
{
	if (Global_2689156[PLAYER::PLAYER_ID() /*453*/].f_319.f_9 != func_72())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("auto_shop_seating", Global_2689156[PLAYER::PLAYER_ID() /*453*/].f_319.f_9, true, 0))
		{
			return 0;
		}
...
void func_103()
{
	func_104(0, &uLocal_128, 0, 1);
	func_104(1, &uLocal_128, 1, 1);
	func_104(2, &uLocal_128, 2, 1);
	func_104(3, &uLocal_128, 3, 1);
	func_104(4, &uLocal_128, 4, 1);
}
...
void func_104(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	{
		uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_108(func_106(), func_109(iParam3, fVar3)) + Var0 };
		uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_108(func_105(), func_109(iParam3, fVar3)) + Var0 };
	}
...
void func_111(int iParam0, var uParam1, var uParam2)
{
	if (func_27())
	{
		...
		{
			case 0:
				*uParam1 = { -1356,109f, 137,168f, -96,12f };
				*uParam2 = 180f;
				break;
			
			case 1:
				*uParam1 = { -1353,853f, 138,379f, -96,12f };
				*uParam2 = -92,52f;
				break;
			
			case 2:
				*uParam1 = { -1354,324f, 147,343f, -100,194f };
				*uParam2 = 90f;
				break;
			
			case 3:
				*uParam1 = { -1354,025f, 146,018f, -100,194f };
				*uParam2 = 125f;
				break;
			
			case 4:
				*uParam1 = { -1353,006f, 145,343f, -100,194f };
				*uParam2 = 173,36f;
				break;
		}
	}
