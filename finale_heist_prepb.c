...
void func_8(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_10(Global_112915.f_18533[iVar0], &Var2, &fVar5))
			{
...
{
	return func_39(&(Global_103480.f_2890), Param0, fParam3, 0);
}
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				...
				{
					if ((!bParam4 || func_99(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
...
int func_104(struct<3> Param0, int iParam3)
{
	return func_105(Global_103480.f_2890.f_12.f_66, Param0, iParam3);
}

int func_105(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_108()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_43[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96471.f_9[6]))
		{
			...
			iLocal_43[0] = Global_96471.f_9[6];
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_43[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_96471.f_9[7]))
		{
			...
			iLocal_43[1] = Global_96471.f_9[7];
...
void func_112()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_96471[3]))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96471[3], true, false);
		VEHICLE::DELETE_VEHICLE(&(Global_96471[3]));
	}
	...
	if (iLocal_62 == 3)
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_59))
		{
			if (!func_122())
			{
				...
				{
					iLocal_59 = func_120(Local_116, 1);
				}
			}
		}
		if (func_122())
...
int func_118(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_120(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_147()
{
	if (iLocal_62 == 0)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(Global_96471[3]))
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_96471[3], false))
			{
				if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(Global_96471[3])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96471[3], true, true);
					func_149(1,0095f, -631,9655f, 34,7259f, 349,0681f, 0, 145);
				}
				if (((VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(Global_96471[3])) || VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(Global_96471[3]))) || VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(Global_96471[3]))) || VEHICLE::IS_THIS_MODEL_A_QUADBIKE(ENTITY::GET_ENTITY_MODEL(Global_96471[3])))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_96471[3], true, true);
...
void func_149(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103480.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_103480.f_4, false))
		{
			if (func_169(24) != Global_103480.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_166(ENTITY::GET_ENTITY_COORDS(Global_103480.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_150(Global_103480.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_150(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_163(iParam5, &Var0, Param1, fParam4, func_61(iParam0));
...
void func_163(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_71(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
...
int func_166(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
	
	iVar0 = func_167(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_167(struct<3> Param0, int iParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_173(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_30())
	{
...
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_186(iParam3), false);
}
			...
			if (iLocal_67 == 1)
			{
				...
				if (iParam0 == iLocal_35[6])
				{
					...
					if (iLocal_424 == 1)
					{
						...
						{
							if (func_177(PLAYER::PLAYER_PED_ID(), iLocal_35[6], 1) < 15f && Local_119.f_2 < 40f)
							{
								if (iLocal_426 == 0)
								{
