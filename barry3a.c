#region Local Var
	...
	struct<3> Local_167[6];
	struct<29> Local_186[2];
	int iLocal_245 = 0;
	int iLocal_246 = 0;
	int iLocal_247 = 0;
	int iLocal_248 = 0;
...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_496(49);
	Local_156 = { 0f, -1f, 0,64f };
	iLocal_159 = joaat("prop_weed_tub_01b");
	Local_161 = { -1138,977f, -1252,549f, 6,05f };
	iLocal_246 = joaat("police4");
	iLocal_247 = joaat("a_m_y_business_01");
	...
	{
		func_492("Force cleanup [TERMINATING]");
		func_472(1);
		func_463();
	}
	func_451();
	...
	{
		Local_145.f_4 = Local_81.f_35[0];
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_41[0]))
	{
		iLocal_155 = Local_81.f_41[0];
	}
	if (func_450())
	{
		iVar0 = func_449();
		...
		{
			case 0:
				func_448(Local_145, Local_145.f_3, 1, 0);
				func_446(1);
				break;
			
			case 1:
				func_448(Local_161, 298,7f, 1, 0);
				func_445(1);
				break;
			
			case 2:
				func_448(-1243,316f, -1041,637f, 7,5121f, 28,2f, 1, 0);
				func_437(1);
				break;
	...
	{
		func_423(&(Local_186[0 /*29*/]), &(Local_81.f_35[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_28[0]))
	{
		func_422(&(Local_186[0 /*29*/].f_1), &(Local_81.f_28[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_81.f_28[1]))
	{
		func_422(&(Local_186[0 /*29*/].f_2), &(Local_81.f_28[1]));
	}
	func_420();
	while (true)
	{
		RECORDING::_0x208784099002BC30("SF_GRTP", 0);
		func_404(Local_81.f_9, 0, 0, 1, 0, 0);
		func_399();
		if (iLocal_142 == 9)
		{
			func_392();
...
void func_1()
{
	switch (iLocal_143)
	{
		case 0:
			func_214(&iLocal_144);
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 1)
				{
					iLocal_437 = 1;
					iLocal_438 = 0;
					iLocal_144 = func_213(Local_161, 5, 1);
				}
				else
				{
					iLocal_437 = 1;
					iLocal_438 = 1;
					if (MISC::GET_PROFILE_SETTING(203) == 0 || !func_212())
					{
						func_210(2);
						iLocal_436 = 0;
					}
			...
			else
			{
				...
				iLocal_144 = func_208(Local_145.f_4, 1, 5);
			}
			iLocal_143 = 1;
			break;
		
		case 1:
			if (!func_207(Local_145.f_4, Local_161, 125f))
			{
				sLocal_449 = "B3ANOTDELV";
				iLocal_143 = 0;
				iLocal_142 = 9;
			}
			else if (!iLocal_437)
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
				{
					...
					{
						iLocal_438 = 0;
						if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, true, true, 0))
						{
							func_214(&iLocal_144);
							iLocal_143 = 0;
							iLocal_142 = 6;
				...
				else if (iLocal_436 && !func_212())
				{
					func_210(3);
					iLocal_436 = 0;
				}
			}
			else if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
			{
				HUD::CLEAR_PRINTS();
				iLocal_437 = 0;
				iLocal_436 = 1;
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, true, true, 0))
			{
				func_214(&iLocal_144);
				iLocal_143 = 0;
				iLocal_142 = 6;
		...
		case 2:
			HUD::CLEAR_PRINTS();
			func_206(&iLocal_155);
			func_203(&(Local_145.f_4));
			if (iLocal_429 || iLocal_430)
			{
				func_202(746);
			}
			func_2();
...
bool func_207(int iParam0, struct<3> Param1, float fParam4)
{
...
{
	if (Local_167[iParam0 /*3*/].f_1 < Local_167[iParam0 /*3*/] || Local_167[iParam0 /*3*/] == -1)
	{
		return 1;
	}
	return 0;
...
void func_210(int iParam0)
{
	if (func_209(iParam0))
	{
		func_211(Local_167[iParam0 /*3*/].f_2, 7500, 1);
		Local_167[iParam0 /*3*/].f_1++;
	}
}
...
int func_213(struct<3> Param0, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_215()
{
	...
	{
		case 0:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 10f, 10f, 2f, false, true, 0))
			{
				func_214(&iLocal_144);
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 10f, 10f, 2f, false, true, 0))
			{
				...
				{
					func_217();
					if (!func_216(PLAYER::PLAYER_PED_ID(), Local_145.f_4, 55f, 1) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_145.f_4))
					{
						iLocal_143 = 2;
					}
					else if ((iLocal_433 && func_209(5)) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_212()))
					{
						func_210(5);
					}
				}
...
void func_217()
{
	if (!iLocal_434)
	{
		iLocal_435 = MISC::GET_GAME_TIMER() + 3500;
		iLocal_434 = 1;
	}
	else if (!iLocal_433)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_435)
		{
			if (iLocal_429 == 1)
			{
				if (func_218(&uLocal_251, 49, "BAR3AAU", "BAR3A_P1", 9, 1, 0, 0, 0))
				{
					iLocal_143 = 1;
					iLocal_433 = 1;
				}
			}
			else if (func_218(&uLocal_251, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0))
			{
				iLocal_143 = 1;
				iLocal_433 = 1;
			}
...
bool func_218(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
...
int func_235()
{
	...
	while (iLocal_250 <= 5)
	{
		if (func_236(Local_167[iLocal_250 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_250++;
...
void func_237()
{
	...
	{
		case 0:
			if (VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_145.f_4) < 1f)
			{
				VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(Local_145.f_4, 10f);
			}
			if (VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_145.f_4) < 1f)
			{
				VEHICLE::SET_VEHICLE_ENGINE_HEALTH(Local_145.f_4, 10f);
			}
			if (func_240(Local_145.f_4, 1093140480, 1, 1056964608, 0, 1, 0))
			{
				func_239(0, -1);
				iLocal_442 = 0;
				iLocal_439 = 0;
		...
		case 2:
			func_238(&uLocal_251, 3, 0, "BARRY", 0, 1);
			iLocal_143 = 0;
			iLocal_142 = 7;
			break;
	}
...
int func_240(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_242()
{
	switch (iLocal_143)
	{
		case 0:
			func_214(&iLocal_144);
			if (!func_212() || MISC::GET_PROFILE_SETTING(203) == 0)
			{
				func_210(2);
				func_253(&uLocal_450);
				iLocal_431 = 0;
			...
			iLocal_429 = 1;
			iLocal_249 = MISC::GET_GAME_TIMER() + 2500;
			iLocal_143 = 1;
			break;
		
		case 1:
			func_248(&uLocal_450, &uLocal_251, "BAR3AAU", &sLocal_451, &cLocal_457);
			if (!iLocal_248 && MISC::GET_GAME_TIMER() > iLocal_249)
			{
...
void func_245()
{
	if (iLocal_428 && iLocal_426 < 4)
	{
		if (!func_212() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
		{
			if (!iLocal_425)
			{
				iLocal_425 = 1;
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_427) > Local_416[iLocal_426 /*2*/].f_1 && (func_247() || iLocal_426 == 0))
			{
				if (iLocal_426 != 2 || ENTITY::GET_ENTITY_SPEED(Local_145.f_4) > 10f)
				{
					if (func_235() || MISC::GET_PROFILE_SETTING(203) == 0)
					{
						if (func_246(&uLocal_251, "BAR3AAU", Local_416[iLocal_426 /*2*/], 7, 1, 0, 0))
						{
							iLocal_425 = 0;
							iLocal_426++;
						}
					}
					else if (func_246(&uLocal_251, "BAR3AAU", Local_416[iLocal_426 /*2*/], 7, 0, 0, 0))
					{
						iLocal_425 = 0;
						iLocal_426++;
					}
...
void func_248(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 2:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					if (func_249(uParam1, sParam2, sParam3, sParam4, 8, 1, 0))
					{
						*uParam0 = 3;
					}
				}
		...
		case 4:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && func_249(uParam1, sParam2, sParam3, sParam4, 8, 0, 0))
			{
				*uParam0 = 0;
			}
			break;
...
void func_254()
{
	switch (iLocal_143)
	{
		case 0:
			func_214(&iLocal_144);
			iLocal_144 = func_208(Local_145.f_4, 1, 5);
			HUD::SET_BLIP_ROUTE(iLocal_144, true);
			if (func_209(3) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_212()))
			{
				func_210(3);
				func_253(&uLocal_450);
			}
	...
	switch (iLocal_143)
	{
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
			{
				func_214(&iLocal_144);
				iLocal_144 = func_213(Local_161, 5, 1);
				if (func_209(0) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_212()))
				{
					func_210(0);
					func_253(&uLocal_450);
				}
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
			{
				...
				{
					if (func_209(0) && !func_212())
					{
						func_210(0);
						func_253(&uLocal_450);
					}
					if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4) && ENTITY::IS_ENTITY_AT_COORD(Local_145.f_4, Local_161, 6f, 6f, 2f, true, true, 0))
					{
						iLocal_439 = 0;
						iLocal_143 = 2;
					}
					if (!iLocal_432)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_427) > 8000 && iLocal_426 >= 4) && !func_212())
						{
							if (func_246(&uLocal_251, "BAR3AAU", "BAR3A_LW", 7, 0, 0, 0))
							{
								iLocal_432 = 1;
							}
						}
		...
		case 2:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_145.f_4, false))
			{
				...
				{
					func_258(1, "Deliver vehicle.", 1, 0, 0, 1);
					iLocal_142 = 6;
				}
			}
			else
...
void func_258(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_331(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
			Global_112915.f_9085.f_330[iVar1 /*6*/].f_1 = 0;
			iVar2 = func_329(iVar1);
		...
		{
			iVar5 = func_201(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_328(&(Global_99974.f_3));
				if (iVar10 > -1)
				{
...
{
	func_260(&Global_106464, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_260(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_230();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		func_291(&(uParam0->f_2884), 0);
		func_290(PLAYER::PLAYER_PED_ID());
		func_283(PLAYER::PLAYER_PED_ID(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_282())
		{
			func_278(PLAYER::PLAYER_PED_ID(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_262(&(uParam0->f_2890), uParam0, iParam5, 1, 1, 0);
	}
	func_261(&(uParam0->f_2980));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
void func_262(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	{
		uParam1->f_5 = func_148(iParam2);
	}
	if (func_275(iParam2, &iVar0, iParam3, iParam5))
	{
...
{
	func_271(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_268(iParam1, 145, 0);
	uParam0->f_11 = func_267(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97305[iVar0]))
		{
			if (Global_97305[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_269(iParam1, iParam2))
					{
						return 1;
					}
				}
...
void func_271(int iParam0, var uParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_273(&iParam0, &(uParam1->f_9), &(uParam1->f_59));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_77), func_272(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_275(int iParam0, var uParam1, int iParam2, int iParam3)
{
	char* sVar0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
				{
					if (iParam2 == 0 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(*uParam1, true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 100f)
					{
						...
						if (func_276(*uParam1, func_230(), 1))
						{
...
void func_278(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_281(iParam0, iVar1, &(uParam1->f_13[iVar1]), uParam1[iVar1], &(uParam1->f_26[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_280(iParam0, iVar1, &(uParam1->f_39[iVar1]), &(uParam1->f_49[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_151(iVar0))
		{
...
int func_279(int iParam0, int iParam1)
{
	...
	iVar0 = Global_2860375[iParam0 /*3*/][func_68(iParam1)];
...
void func_280(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
...
void func_281(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)
{
	int iVar0;
...
void func_283(int iParam0, bool bParam1)
{
	...
	iVar0 = func_148(iParam0);
	if (func_151(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_284(iParam0, &(Global_112915.f_2363.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_284(int iParam0, var uParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			iVar3 = func_289(iVar0);
			if (iVar3 != 0)
			{
				Var4.f_0 = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_289(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar9 < iVar10)
		{
			if ((FILES::_GET_DLC_WEAPON_DATA_SP(iVar9, &Var11) && !func_286(Var11.f_1)) && iVar72 < 51)
			{
...
void func_291(var uParam0, int iParam1)
{
	...
	*uParam0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
	...
	if (iParam1 == 1)
	{
		...
		else if (func_292(*uParam0, "v_hospital", 307,3065f, -589,9595f, 43,302f))
		{
...
int func_292(struct<3> Param0, char* sParam3, struct<3> Param4)
{
	int iVar0;
	int iVar1;
...
bool func_293(int iParam0, var uParam1, var uParam2)
{
	...
	*uParam2 = 0f;
	...
	return !func_294(*uParam1, 0f, 0f, 0f, 0);
}

bool func_294(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
...
int func_295(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_316())
		{
			*uParam0 = func_300(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 6, -1, 0, 1, -1);
			if (func_299(*uParam0) && !func_296(*uParam0))
			{
				return 1;
			}
		}
...
int func_297(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_7() == 0)
		{
			return MISC::IS_BIT_SET(func_69(func_298(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_300(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 57)
	{
		if (iParam3 == 6 || iParam3 == func_315(iVar0))
		{
			if (!bParam5 || func_314(iVar0))
			{
				fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_301(iVar0, 0), true);
...
Vector3 func_301(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_311(Global_102098);
			break;
		
		case 46:
			if (Global_1852965 != func_224())
			{
				if (func_310(Global_1852965))
				{
					return func_303(2, 2);
				}
				else if (func_302(Global_1852965))
				{
					return func_303(45, 3);
				}
				else
				{
...
Vector3 func_303(int iParam0, int iParam1)
{
	...
	if (Global_1852965 != func_224())
	{
		if (iParam1 == 3)
		{
			if (func_304(iParam0, 1, &Var0, 0, 0))
			{
				Var6 = { Var0 };
			}
		}
		else if (iParam1 == 2)
		{
			...
			{
				if (func_304(iParam0, 2, &Var0, 0, 0))
				{
					Var6 = { Var0 };
				}
			}
...
int func_304(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<4> Var0;
	struct<3> Var6;
	struct<4> Var12;
	...
	if (!func_309(iParam3, &Var0))
	{
		return 0;
	}
	if (!func_309(iParam1, &Var6))
	{
		return 0;
	}
	if (!bParam4)
	{
		Var12 = { func_307(iParam0) };
	}
	else
	{
		Var12 = { func_306(iParam0) };
	}
	Var18 = { Var12 - Var0 };
	Var18 = { func_305(Var18, -Var0.f_3.f_2) };
	Var18 = { func_305(Var18, Var6.f_3.f_2) };
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_323(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_329(int iParam0)
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_330(Global_112915.f_9085.f_99.f_205[10]);
			break;
		
		case 74:
		case 75:
			return func_330(Global_112915.f_9085.f_99.f_205[8]);
			break;
		
		case 84:
		case 85:
			return func_330(Global_112915.f_9085.f_99.f_205[11]);
			break;
		
		case 90:
			return func_330(Global_112915.f_9085.f_99.f_205[7]);
			break;
		
		case 93:
			return func_330(Global_112915.f_9085.f_99.f_205[9]);
			break;
	}
	return 0;
}
...
void func_335(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_103480.f_4))
	{
		...
		{
			if (func_362(24) != Global_103480.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_359(ENTITY::GET_ENTITY_COORDS(Global_103480.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_336(Global_103480.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_336(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		Var0.f_9 = 49;
		Var0.f_59 = 2;
		func_271(iParam0, &Var0);
		if (func_294(Param1, 0f, 0f, 0f, 0))
		{
		...
		func_355(iParam5, &Var0, Param1, fParam4, func_267(iParam0));
		func_337(iParam5, iParam0, 0);
	}
}
...
void func_337(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_354(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_112915.f_32749.f_4801 = func_317();
			}
...
void func_338(int iParam0, int iParam1)
{
	...
	func_271(iParam0, &(Global_112915.f_32749.f_5510));
}

int func_339(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_267(iParam0) != 145) || func_353(iParam0)) || func_352(iParam0)) || func_351(iParam0)) || func_350(iParam0)) || !func_340(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_352(iParam0))
		{
		}
...
int func_341(int iParam0, bool bParam1)
{
	...
	{
		if ((((!func_348() && !func_347()) && !func_346()) && !func_345()) && !func_349())
		{
			return 0;
		}
	}
...
int func_354(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_294(Global_112915.f_32749.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_112915.f_2363.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_294(Global_112915.f_2363.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_355(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_354(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_357(iParam0);
			func_356(uParam1, &(Global_112915.f_32749.f_69[Global_76670.f_555[0 /*21*/].f_14 /*78*/]));
...
void func_364()
{
	switch (iLocal_143)
	{
		case 0:
			func_238(&uLocal_251, 3, 0, "BARRY", 0, 1);
			if (func_218(&uLocal_251, 49, "BAR3AAU", "BAR3A_PICK2", 7, 1, 0, 0, 0))
			{
				iLocal_143 = 1;
			}
			break;
...
void func_365()
{
	...
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142,829f, -1254,585f, 0f, -1136,686f, -1246,472f, 8f, false, true);
		iLocal_144 = func_208(Local_145.f_4, 1, 5);
		iLocal_142 = 1;
		iLocal_143 = 0;
	}
...
void func_366()
{
	...
	if ((iLocal_245 && Local_186[0 /*29*/].f_24 == 1) && Local_186[1 /*29*/].f_24 == 1)
	{
...
{
	switch (Local_186[iParam0 /*29*/].f_24)
	{
		case 0:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_1))
			{
				if (func_204(Local_186[iParam0 /*29*/]))
				{
					if (STREAMING::HAS_MODEL_LOADED(iLocal_247))
					{
						Local_186[iParam0 /*29*/].f_1 = PED::CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0 /*29*/], 6, iLocal_247, -1, true, true);
						Local_186[iParam0 /*29*/].f_2 = PED::CREATE_PED_INSIDE_VEHICLE(Local_186[iParam0 /*29*/], 6, iLocal_247, 0, true, true);
					}
				}
				else if (STREAMING::HAS_MODEL_LOADED(iLocal_246))
				{
					Local_186[iParam0 /*29*/] = VEHICLE::CREATE_VEHICLE(iLocal_246, Local_186[iParam0 /*29*/].f_3, Local_186[iParam0 /*29*/].f_6, true, true, false);
				}
			}
			else if (!ENTITY::IS_ENTITY_DEAD(Local_186[iParam0 /*29*/].f_1, false))
			{
				PED::SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_1, true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_1, true);
				WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0 /*29*/].f_1, joaat("weapon_pistol"), 100, true);
				PED::SET_PED_ACCURACY(Local_186[iParam0 /*29*/].f_1, 10);
				if (func_204(Local_186[iParam0 /*29*/].f_2))
				{
					PED::SET_PED_AS_COP(Local_186[iParam0 /*29*/].f_2, true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_186[iParam0 /*29*/].f_2, true);
					WEAPON::GIVE_DELAYED_WEAPON_TO_PED(Local_186[iParam0 /*29*/].f_2, joaat("weapon_pistol"), 100, true);
					PED::SET_PED_ACCURACY(Local_186[iParam0 /*29*/].f_2, 10);
				}
				Local_186[iParam0 /*29*/].f_24 = 1;
			}
			break;
		
		case 1:
			if (func_207(PLAYER::PLAYER_PED_ID(), Local_186[iParam0 /*29*/].f_3, 275f))
			{
				if (func_386(iParam0))
				{
					Local_186[iParam0 /*29*/].f_25 = MISC::GET_GAME_TIMER() + 1750;
					Local_186[iParam0 /*29*/].f_24 = 2;
				}
				else if ((func_385(Local_186[iParam0 /*29*/]) || func_372(Local_186[iParam0 /*29*/].f_1)) || func_372(Local_186[iParam0 /*29*/].f_2))
				{
					func_370(iParam0, 0);
				}
				else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			...
			{
				if (!Local_186[iParam0 /*29*/].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_1))
				{
					func_369(&(Local_186[iParam0 /*29*/].f_1));
					Local_186[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/].f_2))
				{
					func_369(&(Local_186[iParam0 /*29*/].f_2));
					Local_186[iParam0 /*29*/].f_27 = 1;
				}
				if (!Local_186[iParam0 /*29*/].f_28 && ENTITY::DOES_ENTITY_EXIST(Local_186[iParam0 /*29*/]))
				{
					func_203(&(Local_186[iParam0 /*29*/]));
					Local_186[iParam0 /*29*/].f_28 = 1;
				}
				if ((Local_186[iParam0 /*29*/].f_26 && Local_186[iParam0 /*29*/].f_27) && Local_186[iParam0 /*29*/].f_28)
				{
					Local_186[iParam0 /*29*/].f_24 = 4;
				}
			}
			if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
			{
				if ((func_372(Local_186[iParam0 /*29*/].f_1) || func_372(Local_186[iParam0 /*29*/].f_2)) || func_385(Local_186[iParam0 /*29*/]))
				{
					func_370(iParam0, 0);
				}
			}
		...
		case 2:
			if (MISC::GET_GAME_TIMER() > Local_186[iParam0 /*29*/].f_25)
			{
				func_370(iParam0, 1);
			}
			else if ((func_372(Local_186[iParam0 /*29*/].f_1) || func_372(Local_186[iParam0 /*29*/].f_2)) || func_385(Local_186[iParam0 /*29*/]))
			{
				func_370(iParam0, 0);
			}
			break;
...
int func_372(int iParam0)
{
	...
	if (func_204(iParam0))
	{
		...
		if (PED::IS_PED_BEING_JACKED(iParam0) && func_216(iParam0, PLAYER::PLAYER_PED_ID(), 2f, 1))
		{
			return 1;
		}
		...
		else if (func_373(iParam0, 1126825984))
		{
			return 1;
		}
	}
...
int func_373(int iParam0, float fParam1)
{
	float fVar0;
	
	if (func_204(PLAYER::PLAYER_PED_ID()) && func_204(iParam0))
	{
		if (func_384(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_374(int iParam0, float fParam1)
{
...
bool func_375(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_204(iParam0) || !func_204(iParam1))
	{
		if (iVar4 != -1)
		{
			func_382(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_376(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
...
int func_379(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_381(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_381(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
{
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[0 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[0 /*8*/].f_7, false, true, 0))
	{
		return 1;
	}
	else if (Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7 != 0f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_145.f_4, Local_186[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_186[iParam0 /*29*/].f_7[1 /*8*/].f_7, false, true, 0))
	{
		return 1;
	}
	return 0;
...
int func_390()
{
	switch (iLocal_439)
	{
		...
		case 1:
			iLocal_440 = CLOCK::GET_MILLISECONDS_PER_GAME_MINUTE() * 120;
			iLocal_440 = (iLocal_440 + MISC::GET_GAME_TIMER());
			iLocal_441 = (iLocal_440 - CLOCK::GET_MILLISECONDS_PER_GAME_MINUTE() * 30);
			iLocal_444 = (iLocal_440 - 11000);
			iLocal_445 = (iLocal_440 - 6000);
			iLocal_446 = (iLocal_440 - 1000);
			iLocal_448 = 0;
			iLocal_439 = 2;
			return 0;
			break;
		...
		case 2:
			...
			{
				if ((!iLocal_443 && MISC::GET_GAME_TIMER() >= iLocal_441) && !func_212())
				{
					if (func_246(&uLocal_251, "BAR3AAU", "BAR3A_HURRY", 7, 0, 0, 0))
					{
						iLocal_443 = 1;
					}
				}
...
void func_391()
{
	...
	if (iVar0 >= iLocal_446)
	{
		if ((iVar0 - iLocal_447) > 500)
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "TIMER_STOP", "HUD_MINI_GAME_SOUNDSET", true);
			iLocal_447 = MISC::GET_GAME_TIMER() + 1000;
		}
	}
	else if (iVar0 >= iLocal_445)
	{
		if ((iVar0 - iLocal_447) > 500)
		{
	...
	switch (iLocal_143)
	{
		case 0:
			if (!func_398())
			{
				...
				HUD::CLEAR_PRINTS();
				HUD::CLEAR_HELP(true);
				if (MISC::IS_STRING_NULL_OR_EMPTY(sLocal_449))
				{
					sLocal_449 = "DEFAULT";
				}
				if (MISC::ARE_STRINGS_EQUAL(sLocal_449, "DEFAULT"))
				{
					func_472(1);
				}
				else
				{
					func_396(sLocal_449, 1);
				}
				iLocal_143 = 1;
			}
			break;
...
void func_393(bool bParam0)
{
	if (bParam0)
	{
		...
		while (iLocal_250 <= 1)
		{
			func_369(&(Local_186[iLocal_250 /*29*/].f_1));
			func_369(&(Local_186[iLocal_250 /*29*/].f_2));
			iLocal_250++;
		}
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
		{
			func_203(&(Local_186[iLocal_250 /*29*/]));
			iLocal_250++;
		}
	}
	else
	{
		func_394(&iLocal_155, 0);
		func_371(&(Local_145.f_4));
		iLocal_250 = 0;
		while (iLocal_250 <= 1)
		{
			func_368(&(Local_186[iLocal_250 /*29*/].f_1), 1, 0, 1);
			func_368(&(Local_186[iLocal_250 /*29*/].f_2), 1, 0, 1);
			func_371(&(Local_186[iLocal_250 /*29*/]));
			iLocal_250++;
		}
	}
	if (iLocal_245)
	...
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-1142,829f, -1254,585f, 0f, -1136,686f, -1246,472f, 8f, true, true);
}
...
void func_400(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17)
{
	int iVar0;
	int iVar1;
...
void func_404(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_78106 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_406(Global_78107, Global_78109, iParam10) };
				if (fVar7 == -0,014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_407(iVar2), 8);
					break;
			}
			break;
...
int func_415(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	if (((!func_417(0) || Global_78121) || Global_78110 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78106)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_403(0)) || func_416(1))
			{
			}
			else
			{
...
{
	return func_419(iParam0, Global_42596);
}
...
void func_429(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_435(0, bParam3, iParam2, 0);
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		{
			if (((((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_433(PLAYER::PLAYER_ID())) && !func_431(PLAYER::PLAYER_ID(), 0)) && !func_430()) && !bParam4) && !bParam5)
			{
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
			}
		}
		else if (((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_433(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5)
		{
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false);
		}
		Global_77850 = 0;
...
int func_435(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_437(bool bParam0)
{
	...
	{
		ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1243,316f, -1041,637f, 7,5121f, true, false, false, true);
...
{
	if (Local_167[iParam0 /*3*/] == -1)
	{
	}
	else
	{
		Local_167[iParam0 /*3*/].f_1 = Local_167[iParam0 /*3*/];
	}
}
...
void func_441(bool bParam0)
{
	...
	while (iLocal_250 <= 1)
	{
		...
		if (bParam0)
		{
			Local_186[iLocal_250 /*29*/].f_26 = 0;
			Local_186[iLocal_250 /*29*/].f_27 = 0;
			Local_186[iLocal_250 /*29*/].f_28 = 0;
			Local_186[iLocal_250 /*29*/].f_24 = 0;
			if (!iLocal_245)
			{
		...
		{
			Local_186[iLocal_250 /*29*/].f_26 = 1;
			Local_186[iLocal_250 /*29*/].f_27 = 1;
			Local_186[iLocal_250 /*29*/].f_28 = 1;
			Local_186[iLocal_250 /*29*/].f_24 = 4;
			if (iLocal_245)
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_247);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_246);
...
void func_442(struct<3> Param0, float fParam3, bool bParam4)
{
	STREAMING::REQUEST_MODEL(Local_145.f_5);
	STREAMING::REQUEST_MODEL(iLocal_159);
	while (!STREAMING::HAS_MODEL_LOADED(Local_145.f_5) || !STREAMING::HAS_MODEL_LOADED(iLocal_159))
	{
		SYSTEM::WAIT(0);
	}
	if (func_204(Local_145.f_4))
	{
		if (bLocal_152)
		{
			VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_145.f_4);
			bLocal_152 = false;
		}
	}
	if (bParam4)
	...
	func_206(&iLocal_155);
	func_203(&(Local_145.f_4));
	Local_145.f_4 = VEHICLE::CREATE_VEHICLE(Local_145.f_5, Param0, fParam3, true, true, false);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_145.f_4, 1);
	if (bParam4)
	{
		func_443(PLAYER::PLAYER_PED_ID(), Local_145.f_4, -1, 0);
	}
	VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_145.f_4, false);
	VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_145.f_4, false);
	VEHICLE::SET_VEHICLE_STRONG(Local_145.f_4, true);
	VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_145.f_4, true);
	VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_145.f_4);
	VEHICLE::SET_VEHICLE_EXTRA(Local_145.f_4, 1, true);
	VEHICLE::SET_VEHICLE_EXTRA(Local_145.f_4, 2, true);
	VEHICLE::SET_VEHICLE_EXTRA(Local_145.f_4, 3, true);
	iLocal_155 = OBJECT::CREATE_OBJECT(iLocal_159, Param0, true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_155, Local_145.f_4, 0, Local_156, 0f, 0f, 0f, false, false, true, false, 2, true);
	ENTITY::SET_ENTITY_COLLISION(iLocal_155, true, false);
	bLocal_152 = true;
	func_421(Local_145.f_4, 0);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_145.f_5);
...
void func_446(bool bParam0)
{
	...
	if (bParam0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_145.f_4))
		{
			func_442(Local_145, Local_145.f_3, 0);
		}
		while (!HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			SYSTEM::WAIT(0);
	...
	{
		func_442(Local_145, Local_145.f_3, 1);
	}
	iLocal_439 = 1;
	iLocal_442 = 1;
}
...
{
	Local_167[iParam0 /*3*/].f_1 = iParam1;
}
...
void func_452(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 160)
	{
		...
		if (iParam1 == 4)
		{
			...
			func_457(iParam0, 0, 1);
			func_457(iParam0, 1, 1);
			func_457(iParam0, 2, 1);
		}
		else
		{
			if (func_456(iParam0, iParam1) == 1 && func_455(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_458(iParam0, iVar0, 1);
			func_457(iParam0, iVar0, 1);
		...
		if (bParam2)
		{
			if (!Global_77852)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_454(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_454(iParam0) };
...
void func_459()
{
	Local_186[0 /*29*/].f_3 = { 1195,3f, -1312,74f, 34,75f };
	Local_186[0 /*29*/].f_6 = 282,4f;
	Local_186[0 /*29*/].f_7[0 /*8*/][0 /*3*/] = { 1216,144f, -1287,004f, 33,97642f };
	Local_186[0 /*29*/].f_7[0 /*8*/][1 /*3*/] = { 1202,456f, -1306,054f, 39,47411f };
	Local_186[0 /*29*/].f_7[0 /*8*/].f_7 = 16,5f;
	Local_186[0 /*29*/].f_7[1 /*8*/][0 /*3*/] = { 1204,858f, -1296,131f, 33,97642f };
	Local_186[0 /*29*/].f_7[1 /*8*/][1 /*3*/] = { 1198,832f, -1365,926f, 39,47705f };
	Local_186[0 /*29*/].f_7[1 /*8*/].f_7 = 37,5f;
	Local_186[0 /*29*/].f_24 = 0;
	Local_186[1 /*29*/].f_3 = { 1162,71f, -1357,86f, 33,73f };
	Local_186[1 /*29*/].f_6 = 266,7f;
	Local_186[1 /*29*/].f_7[0 /*8*/][0 /*3*/] = { 1164,457f, -1363,839f, 33,51062f };
	Local_186[1 /*29*/].f_7[0 /*8*/][1 /*3*/] = { 1180,637f, -1359,837f, 39,11396f };
	Local_186[1 /*29*/].f_7[0 /*8*/].f_7 = 15,5f;
	Local_186[1 /*29*/].f_7[1 /*8*/][0 /*3*/] = { 0f, 0f, 0f };
	Local_186[1 /*29*/].f_7[1 /*8*/][1 /*3*/] = { 0f, 0f, 0f };
	Local_186[1 /*29*/].f_7[1 /*8*/].f_7 = 0f;
	Local_186[1 /*29*/].f_24 = 0;
}

void func_460()
{
	Local_167[0 /*3*/] = { func_461("B3ADELV", 1) };
	Local_167[1 /*3*/] = { func_461("B3AGETIN", 1) };
	Local_167[2 /*3*/] = { func_461("B3AWAN1", -1) };
	Local_167[3 /*3*/] = { func_461("B3ARTV", 1) };
	Local_167[4 /*3*/] = { func_461("B3AEXIT", 1) };
	Local_167[5 /*3*/] = { func_461("B3ALEAVE", 1) };
}

Vector3 func_461(char* sParam0, int iParam1)
{
	struct<3> Var0;
...
void func_462()
{
	Local_416[0 /*2*/] = "BAR3A_C1";
	Local_416[0 /*2*/].f_1 = 1000;
	Local_416[1 /*2*/] = "BAR3A_W2";
	Local_416[1 /*2*/].f_1 = 19000;
	Local_416[2 /*2*/] = "BAR3A_W1";
	Local_416[2 /*2*/].f_1 = 20000;
	Local_416[3 /*2*/] = "BAR3A_W4";
	Local_416[3 /*2*/].f_1 = 22000;
}
...
void func_464(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_469(uParam0, iParam1);
	func_467(uParam0, bParam2);
	func_465(uParam0, bParam3);
}

void func_465(var uParam0, bool bParam1)
{
	func_466(&(uParam0->f_41), bParam1);
}
...
int func_474(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_477())
	{
		...
		{
			iVar33 = func_328(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_475()
{
	...
	iVar0 = func_331(&(Global_99974.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_477()
{
	...
	{
		if (func_328(&(Global_99974.f_3)) > -1)
		{
			return 1;
		}
	}
