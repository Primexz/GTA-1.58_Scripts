...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_78121 || Global_78121.f_1)
		{
			bLocal_29 = false;
		}
		bVar5 = false;
		...
		if (bLocal_30 != bLocal_29)
		{
			...
			if (bLocal_29 && !bVar6)
			{
				...
				if (bVar7)
				{
					...
					{
						if (!MISC::IS_BIT_SET(Global_112915.f_7688.f_923, 0))
						{
							func_10(1628462442, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!MISC::IS_BIT_SET(Global_112915.f_7688.f_923, 1))
						{
							func_10(1791324372, 7, 1, 31, 3, 10000, 20000, -1, -1, 150, -1, 1024);
						}
						else if (!MISC::IS_BIT_SET(Global_112915.f_7688.f_923, 2))
						{
					...
					{
						if (!MISC::IS_BIT_SET(Global_112915.f_7688.f_923, 3))
						{
							func_10(1806999335, 7, 4, 31, 3, 10000, 20000, -1, -1, 151, -1, 1024);
						}
						else if (!MISC::IS_BIT_SET(Global_112915.f_7688.f_923, 4))
						{
...
{
	return func_3(iParam0, Global_42596);
}
...
void func_5(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_112915.f_7229.f_17[iParam0]), 0);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_112915.f_7229.f_17[iParam0]), 0);
	}
	MISC::DISABLE_POLICE_RESTART(Global_95113[iParam0 /*9*/].f_8, !bParam1);
	func_6(Global_95113[iParam0 /*9*/].f_7, 0, 0);
}
...
void func_7(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_112915.f_7229.f_11[iParam0]), 0);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_112915.f_7229.f_11[iParam0]), 0);
	}
	MISC::DISABLE_HOSPITAL_RESTART(Global_95177[iParam0 /*9*/].f_8, !bParam1);
	func_6(Global_95177[iParam0 /*9*/].f_7, 0, 0);
}
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_16(Global_112915.f_2363.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(iVar0) && (!func_9(14) || Global_111866))
			{
...
void func_29(int iParam0)
{
	...
	while (iVar15 < Global_112915.f_7688.f_198)
	{
		...
		{
			func_30(Global_112915.f_7688.f_137[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_30(int iParam0)
{
	...
	{
		if (func_36(iParam0, Global_19954) == 1)
		{
			func_35(iParam0, Global_19954, 0);
			if (func_34(iParam0, Global_19954) == 0)
			{
				iVar0 = Global_19954;
