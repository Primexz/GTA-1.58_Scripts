...
void __EntryFunction__()
{
	...
	Local_92 = { -1593,813f, 5221,235f, 1,94482f };
	Local_95 = { -1603,986f, 5243,624f, 4,940323f };
	uLocal_98 = func_296(16);
	cLocal_99 = "rcmabigail";
	iLocal_100 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_112002[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_292(&(Global_112002[Var0.f_0 /*10*/].f_9));
			}
		}
		func_275(&Var0, 1);
	}
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_272(&iVar231, &Var0, Var61, 1f))
	{
		func_271();
	...
	while (true)
	{
		...
		func_213(Var0.f_0);
		func_206(&iLocal_100, &(Var0.f_9), Var61);
		switch (Var0.f_0)
		{
			case 0:
				func_193(&Var64, &(Var0.f_28[0]), "SONAR_PRE");
				break;
			
			case 1:
				func_188(&Var0, Var61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_173(&Var0, 0))
		{
...
int func_188(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_127(PLAYER::PLAYER_PED_ID()) && func_127(uParam0->f_28[0])) && !func_146()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_192(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_191(&uVar0, iParam6, uParam0->f_28[0], sParam7, 0, 1);
		func_189(&uVar0, cParam4, sParam5, 7, 0, 0);
...
{
	if (func_127(*uParam1) && func_127(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 1000f, -8f, -1, 1, 0f, false, false, false);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, false, true, 0))
					{
						TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "intro", 8f, -8f, -1, 2, 0f, false, false, false);
						*iParam0 = 3;
					}
					else if (func_205(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "outro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "outro") > 0,99f)
				{
					TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "base", 8f, -8f, -1, 1, 0f, false, false, false);
				}
				break;
			
			case 3:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "intro") > 0,99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_194(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, false, true, 0))
					{
						TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_talk", 8f, -8f, -1, 1, 0f, false, false, false);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_146())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "loop_talk") > 0,99f)
						{
							iParam0->f_166 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 10000));
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, false, true, 0))
							{
								TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "outro", 8f, -8f, -1, 2, 0f, false, false, false);
								*iParam0 = 1;
							}
							else
							{
								TASK::TASK_PLAY_ANIM(*uParam1, cLocal_99, "loop_look", 8f, -8f, -1, 1, 0f, false, false, false);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_99, "loop_look", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_99, "loop_look") > 0,99f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_92, Local_95, 8f, false, true, 0))
					{
						if (MISC::GET_GAME_TIMER() > iParam0->f_166)
...
{
	if ((func_250() && Global_99974.f_11 == 6) && iParam0 == func_167(&(Global_99974.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_253(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			STREAMING::REQUEST_ANIM_DICT(cLocal_99);
			func_260(&(uParam0->f_48), cLocal_99, "base", 0);
			iLocal_91 = 1;
			break;
		
		case 1:
			if (!func_259(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
...
void func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_255(iParam0);
...
int func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_257(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_261(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_99))
			{
				return 0;
			}
			iLocal_91 = 2;
...
int func_272(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_273((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_273((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_273(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_274(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_274(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
