...
void __EntryFunction__()
{
	...
	{
		func_307("Force cleanup [TERMINATING]");
		if (Var0.f_0 != -1)
		{
			if (Global_112002[Var0.f_0 /*10*/].f_9 != -1)
			{
				func_307("Relinquishing candidate id...");
				func_306(&(Global_112002[Var0.f_0 /*10*/].f_9));
			}
		}
		func_289(&Var0, 1);
	}
	if (!func_286(&iVar64, &Var0, Var61, 1f))
	{
		func_285();
		func_307("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (!func_277(Var0.f_0))
	{
		func_285();
		func_307("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	}
	if (func_276(Var0.f_0))
	{
		func_285();
		func_307("SCRIPT TERMINATED");
		SCRIPT::TERMINATE_THIS_THREAD();
	...
	while (!func_256(&Var0))
	{
		...
		{
			func_307("Player out of range [TERMINATING]");
			func_289(&Var0, 1);
		}
	}
	...
	if (Var0.f_0 == 27)
	{
		func_255(&uLocal_97, 5, Var0.f_28[0], "JOSH", 0, 1);
	}
	else if (Var0.f_0 == 30)
	{
		func_255(&uLocal_97, 4, Var0.f_28[0], "JOSH", 0, 1);
		func_255(&uLocal_97, 3, Var0.f_28[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		if (!func_218(&Var0, 1))
		{
			if (Var0.f_0 == 30)
			{
				if (func_217(PLAYER::PLAYER_PED_ID(), -1102,724f, 290,1463f, 63,23002f, 1) < 200f)
				{
					PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(PLAYER::PLAYER_ID(), 1, false);
					func_216(&Var0);
					func_307("Making Josh cops attack");
				}
			}
			func_289(&Var0, 1);
		}
		func_215(Var0.f_0);
		func_208(&iLocal_95, &(Var0.f_9), Var61);
		if (Var0.f_0 == 27)
		{
			func_206(&Var0, Var61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0.f_0 == 28)
		{
			func_206(&Var0, Var61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 29)
		{
			func_206(&Var0, Var61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 30)
		{
			if (iLocal_265 == 0)
			{
				...
				{
					if (func_205(Var0.f_28[1]))
					{
						func_307("Josh 4: Trying to set Cop 1 component variation");
						CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Var0.f_28[1], 0);
					}
					if (func_205(Var0.f_28[2]))
					{
						func_307("Josh 4: Trying to set Cop 2 component variation");
		...
		if (((func_177(&Var0, 0) || func_176(&Var0)) || func_174(&Var0)) || func_172(&Var0))
		{
			if (func_171(Var0.f_0))
			{
				func_168(Var0.f_0, &iLocal_264);
			}
			if (!func_2(&Var0))
			{
				func_289(&Var0, 1);
...
int func_2(int iParam0)
{
	...
	if (!func_167())
	{
		while (!func_158(*iParam0))
		{
			...
			{
				func_307("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_113(iParam0))
	{
		func_307("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
int func_113(var* uParam0)
{
	...
	if (func_142(&(uParam0->f_1)))
	{
		...
		{
			func_307("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::_0x8D9DF6ECA8768583(iVar0);
		}
		else
		{
			func_307("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
int func_142(char* sParam0)
{
	...
	func_307("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}
...
void func_147()
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (func_148(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 10,5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_148(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_158(int iParam0)
{
	...
	iVar0 = func_160(&(Global_112002[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	return func_163(iParam0, Global_42596);
}
...
int func_166(char* sParam0, int iParam1)
{
	int iVar0;
	char* sVar1;
	int iVar33;
...
int func_169(struct<3> Param0, bool bParam3)
{
	int iVar0;
	...
	if (*uParam0 == 30)
	{
		if (func_205(uParam0->f_28[0]))
		{
			if (bLocal_263)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_173(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 15f)
					{
						func_307("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_173(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 10f)
				{
					func_307("Special launching Josh 4 (in vehicle)");
					return 1;
				}
			}
		}
...
int func_174(var uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_217(PLAYER::PLAYER_PED_ID(), 566,7472f, -1771,875f, 28,35786f, 1) < 6f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_307("Special launching Josh 3");
				return 1;
			}
			else if ((!func_175(PLAYER::PLAYER_PED_ID(), -828834893) && func_205(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_148(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_176(var uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_217(PLAYER::PLAYER_PED_ID(), 566,7472f, -1771,875f, 28,35786f, 1) < 9f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				func_307("Special launching Josh 2");
				return 1;
			}
			else if ((!func_175(PLAYER::PLAYER_PED_ID(), -828834893) && func_205(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_148(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826,631f, 4699,115f, 35,38089f, 1812,878f, 4710,457f, 42,05354f, 23,75f, false, true, 0))
				{
					if (func_205(uParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], true), true) < 3f)
						{
							if (func_183(2))
							{
								if (func_181(uParam0->f_27))
								{
									func_180(uParam0->f_27, *uParam0);
									func_307("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				else if (func_205(uParam0->f_28[0]))
				{
					if (func_179(uParam0))
					{
						if (func_183(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_205(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245,8885f, 371,9034f, 103,9884f, 241,5898f, 359,6458f, 107,3461f, 1,25f, false, true, 0))
					{
						if (func_183(2))
						{
							...
							{
								func_180(uParam0->f_27, *uParam0);
								func_307("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728,948f, 4143,44f, 42,29295f, 2722,213f, 4144,521f, 45,43182f, 10f, false, true, 0))
				{
					if (func_183(2))
					{
						...
						{
							func_180(1, *uParam0);
							func_307("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983,5426f, 369,1104f, 68,46017f, -1028,566f, 395,4613f, 94,57245f, 15f, false, true, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983,875f, 346,7556f, 68,02096f, -1021,451f, 336,3458f, 93,18714f, 14,5f, false, true, 0))
						{
							if (func_183(2))
							{
								...
								{
									func_180(uParam0->f_27, *uParam0);
									func_307("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_180(int iParam0, int iParam1)
{
	if (iParam0 == 1)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			func_307("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_307("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_191()) || Global_111962) || Global_31508) || func_190()) || func_189(8, -1)) || func_93()) || func_188()) || func_187()) || func_186()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191()) || Global_31508) || func_190()) || func_189(8, -1)) || func_187()) || func_93()) || func_188()) || func_186()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_191()) || Global_111962) || Global_31508) || func_190()) || func_189(8, -1)) || func_187()) || func_93()) || func_188()) || func_186()) || Global_112915.f_7688.f_919[iVar0] == 5) || Global_43143 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_191()) || Global_111962) || Global_31508) || func_190()) || func_189(8, -1)) || func_93()) || func_188()) || func_186()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_189(8, -1)) || func_186()) || func_185()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_189(8, -1) || func_93()) || func_188()) || func_185()) || func_184())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_191()) || Global_31508) || func_190()) || func_189(8, -1)) || func_188()) || func_187()) || func_186()) || Global_112915.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_191()) || func_188()) || Global_111962) || Global_31508) || func_190()) || Global_43774) || func_189(8, -1)) || func_187()) || func_185()) || func_186()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_191()) || Global_111962) || Global_31508) || func_190()) || func_189(8, -1)) || func_187()) || func_185()) || func_93()) || func_188()) || func_186())
						{
							return 0;
						}
						break;
...
void func_192()
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_262) > 100 && bLocal_263 == 0)
			{
				iLocal_96 = 1;
			}
			break;
		...
		case 1:
			if (func_217(PLAYER::PLAYER_PED_ID(), -1103,44f, 290,18f, 63,28f, 1) <= 20f)
			{
				if (func_193(&uLocal_97, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_96 = 2;
				}
			}
		...
		case 2:
			if (!func_145())
			{
				...
				iLocal_96 = 0;
				bLocal_263 = true;
				func_307("Josh 4 conversation finished and will not loop");
			}
			else if (func_217(PLAYER::PLAYER_PED_ID(), -1103,44f, 290,18f, 63,28f, 1) >= 25f)
			{
				func_143();
				bLocal_263 = true;
				iLocal_96 = 0;
...
{
	func_204(uParam0, 145, sParam1, iParam4, iParam5, iParam6);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_204(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_206(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_205(PLAYER::PLAYER_PED_ID()) && func_205(iParam0->f_28[0])) && !func_145()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_217(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_255(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_207(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_207(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_204(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_217(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_217(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_213(iParam0);
				}
			}
...
void func_216(int iParam0)
{
	...
	if (func_205(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
...
int func_218(var uParam0, bool bParam1)
{
	...
	if (Global_77852)
	{
		func_307("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_110(*uParam0, &Var0);
	if ((func_254(*uParam0) || func_252(*uParam0)) || Global_78097 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_307("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_248(*uParam0))
	{
		...
		func_307("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_25 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_307("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_307("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_222(&(uParam0->f_48)) && bParam1)
	{
		func_219(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}
...
void func_219(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_205(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_221(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_220(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_221(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_220(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_69(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0f, false, false, false);
...
void func_223(var uParam0)
{
	...
	if (*uParam0 == 52)
	{
		func_224(&(uParam0->f_41[1]));
		func_224(&(uParam0->f_41[2]));
	}
	if (func_205(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
	...
	if (func_126(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				{
					func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_35[iVar0], false))
				{
					func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_35[iVar0], PLAYER::PLAYER_PED_ID(), false))
				{
					func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_35[iVar0]) < 850)
				{
					func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						...
						{
							func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_182(iVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_182(uParam0->f_35[iVar0]))
								{
									...
									{
										func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_182(iVar3))
						{
							...
							{
								func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_226(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
								func_307("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
	...
	if (func_126(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_28[iVar0]))
						{
							...
							func_307("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_28[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_28[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_28[iVar0]))
					{
						...
						func_307("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_28[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
						{
							...
							func_307("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_246(*uParam0))
					{
						if (!func_157(*uParam0))
						{
							if (func_241(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								...
								func_307("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_28[iVar0], true), 15f))
						{
							...
							func_307("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_229(uParam0->f_28[iVar0], 1126825984))
						{
							...
							func_307("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_228(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_307("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_307("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_205(uParam0->f_41[0]))
						{
...
int func_229(int iParam0, float fParam1)
{
	...
	if (func_205(PLAYER::PLAYER_PED_ID()) && func_205(iParam0))
	{
		if (func_240(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
{
	return func_231(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}
...
bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar4 = func_239(iParam0, iParam1);
	if (!func_205(iParam0) || !func_205(iParam1))
	{
		if (iVar4 != -1)
		{
			func_238(&(Local_37[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_232(&(Local_37[iVar4 /*4*/]), Var1, iParam1, &(Local_37[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_37[iVar4 /*4*/].f_3) < iParam4);
}

int func_232(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_235(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_237(ENTITY::GET_ENTITY_COORDS(iParam1, true) - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_237(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_236(Var3, Var0);
...
float func_236(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_243(int iParam0, float fParam1)
{
	...
	{
		if (func_244(iParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_237(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
...
{
	if ((func_253() && Global_99974.f_11 == 6) && iParam0 == func_166(&(Global_99974.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_256(int iParam0)
{
	...
	func_307("Created initial scene");
	return 1;
}
...
int func_257(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_270(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_263(&(uParam0->f_28[0]), 58, -1103,6f, 290,81f, 64,31f, -99,24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_261(&(uParam0->f_28[1]), iVar0[2], -1102,92f, 290,12f, 64,28f, 40,46f, 6);
			...
			{
				func_261(&(uParam0->f_28[2]), iVar0[2], -1102,73f, 290,91f, 64,28f, 92,06f, 6);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_259(&(uParam0->f_35[0]), iVar0[3], -1107,5f, 280,33f, 64,01f, 97,97f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_258(&(uParam0->f_35[1]), 0);
...
void func_258(int* iParam0, bool bParam1)
{
	...
	func_259(iParam0, iLocal_93, Var0, fVar3);
...
void func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_260(iParam0);
...
void func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_262(iParam0);
...
int func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_264(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_270(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_271(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_269(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh3"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_263(&(uParam0->f_28[0]), 58, 566,1639f, -1773,817f, 29f, 14,4f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uParam0->f_59, "rcmjosh3", "sit_stairs_idle", 8f, -8f, 17, 0, 1000f, 0);
...
{
	func_259(iParam0, iLocal_93, 558,09f, -1765,39f, 28,86f, 335,3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam0, 4);
...
int func_273(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (!func_269(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh2"))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_263(&(uParam0->f_28[0]), 58, 565,3901f, -1772,838f, 29,80087f, 62,50156f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
		...
		case 3:
			if (func_205(uParam0->f_28[0]))
			{
				...
				iLocal_94 = PED::CREATE_SYNCHRONIZED_SCENE(563,76f, -1773,86f, 28,36f, 0,02f, 0,02f, -110,7f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_94, true);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_94, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1000f, 0);
			}
...
int func_274(var uParam0)
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			func_270(&(uParam0->f_48), "rcmjosh1", "idle", 0);
			iLocal_91 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_263(&(uParam0->f_28[0]), 58, -1104,72f, 291,02f, 64,39f, 138,35f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
int func_277(int iParam0)
{
	...
	if (Global_77852)
	{
		func_307("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!Global_112915.f_9085 && !func_108(1))
	{
		func_307("STEP_3_COMMON_CanRCLaunch - Script denied, game flow is not active");
		return 0;
	}
	if (!func_278(iParam0))
	{
		Global_112002[iParam0 /*10*/].f_1 = 1;
		func_307("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_99974.f_11 == 6)
	{
		if (Global_99974 < 9)
		{
			...
			{
				func_307("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_112002[iParam0 /*10*/].f_1 = 1;
		func_307("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}
...
bool func_280(int iParam0, char* sParam1)
{
...
int func_286(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	...
	if (*iParam0 == 1)
	{
		if (func_287((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_287((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_307("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_287(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_288(Var1.f_6, Param1, fParam4, 0))
	{
...
int func_288(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_289(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		func_307("SCRIPT TERMINATING: Cleaning up entities in Launcher");
	...
	if (iLocal_95 != -1)
	{
		func_307("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_214(&iLocal_95);
	}
	switch (*iParam0)
	{
...
void func_309()
{
	func_307("Running start routines.");
	Global_112633++;
}
