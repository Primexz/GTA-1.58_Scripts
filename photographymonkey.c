		...
		if (!func_104(0) && !func_103(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_113())
				{
					...
					bLocal_461 = MISC::IS_BIT_SET(Global_7825, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
							...
							Var7 = { Local_455 };
							Var10 = { Local_455 };
							func_99(iLocal_48, &Var1, &Var4, &Var7, &Var10);
							fVar13 = 0f;
							fVar14 = 0f;
							...
							if (((((fVar15 >= 0,35f && func_97(Var1, 0f, 1f)) && func_97(Var4, 0f, 1f)) && func_97(Var7, 0f, 1f)) && func_97(Var10, 0f, 1f)) || ((((fVar15 < 0,35f && func_97(Var1, 0,05f, 0,95f)) && func_97(Var4, 0,05f, 0,95f)) && func_97(Var7, 0,05f, 0,95f)) && func_97(Var10, 0,05f, 0,95f)))
							{
								if (fVar13 >= 0,08f && fVar14 >= 0,101f)
								{
									...
									func_96(&iLocal_50, Var1, 0,01f);
									func_96(&iLocal_51, Var4, 0,01f);
									func_96(&iLocal_52, Var7, 0,01f);
									func_96(&iLocal_53, Var10, 0,01f);
									bVar16 = false;
									iVar17 = 0;
									while (iVar17 < 10 && !bVar16)
									{
										bVar16 = ((((GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_49) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_50)) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_51)) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_52)) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_53));
										iVar17++;
										SYSTEM::WAIT(0);
									}
									if (bVar16)
...
void func_1()
{
	Global_112915.f_10049.f_135[1] = -1;
}
...
void func_2(int iParam0, bool bParam1)
{
	...
	if (iVar0 < 31)
	{
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_112915.f_24995), iVar0);
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_112915.f_24995), iVar0);
		}
	}
	else
	{
		...
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_112915.f_24995.f_1), iVar0);
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_112915.f_24995.f_1), iVar0);
		}
	}
}
...
{
	func_91(iParam0, iParam1, iParam2, bParam3);
...
{
	Global_77663[1 /*14*/] = { func_10(iParam0, iParam1, iParam2, -1) };
	if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 2, Global_77663[1 /*14*/].f_1, 0, 1);
		}
		else
		{
			func_9(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 2, Global_77663[1 /*14*/].f_1, 1, 0);
		}
		return 1;
	}
	return 0;
...
void func_12(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_23(iVar10, iParam0, 155, -1);
			return;
			break;
	}
	func_13(&(Global_77663[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
...
void func_13(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_20(Global_2883588, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_20(Global_2883588, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_16(func_19(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			iVar0 = func_16(func_15(iParam1, uParam0->f_2), Global_77660, 0);
			if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_16(iVar1, Global_77660, 0);
				if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_13(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_13(&(Global_77663[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_13(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("OUTFIT_ONLY"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_77833)
		{
			...
			func_13(&(Global_77663[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, false, -1, func_24(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_80(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 1, Global_77663[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
		...
		{
			func_9(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 1, Global_77663[1 /*14*/].f_1, 0, 1);
		}
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				default:
					func_82(&Var1, iParam0, iParam1, 10);
					break;
			}
			break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				default:
					func_82(&Var1, iParam0, iParam1, 9);
					break;
			}
			break;
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				...
				default:
					func_82(&Var1, iParam0, iParam1, 25);
					break;
			}
			break;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, false, -1, func_24(iParam2));
		iVar1 = FILES::_0x96E2929292A4DB77(iParam1);
		if (iVar1 != -1)
		{
			return (func_84(iParam0, func_24(iParam2)) + iVar1);
		}
	}
	return -99;
}
		...
		while (iVar36 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar36, &Var16))
			{
				if ((Var16.f_0 != 0 && Var16.f_0 != -1) && Var16.f_0 != joaat("0"))
				{
					...
					{
						(*uParam0)[func_89(Var16.f_2)] = func_83(iParam1, Var16.f_0, func_89(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_91(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_77663[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 0, Global_77663[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_9(iParam1, Global_77663[1 /*14*/].f_5, Global_77663[1 /*14*/].f_2, 0, Global_77663[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
bool func_93(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_112915.f_10049.f_135[iVar0], iVar1);
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_112915.f_10049.f_135[iVar0]), iVar1);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_112915.f_10049.f_135[iVar0]), iVar1);
	}
}

void func_96(int iParam0, struct<3> Param1, float fParam4)
{
...
void func_98(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, float fParam10)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_99(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	{
		Var3 = { Local_54[iParam0 /*8*/] };
		Var6 = { Local_54[iParam0 /*8*/].f_3 };
		fVar9 = Local_54[iParam0 /*8*/].f_6;
		fVar10 = Local_54[iParam0 /*8*/].f_7;
	}
	fVar12 = (fVar9 / 2f);
	fVar13 = (fVar10 / 2f);
	Var14 = { func_100(func_101(Var6, 0f, 0f, -1f)) };
	Var17 = { func_100(func_101(Var6, Var14)) };
...
Vector3 func_100(struct<3> Param0)
{
	float fVar0;
...
int func_102(float fParam0)
{
	...
	while (iVar0 < 50)
	{
		if (!func_93(iVar0))
		{
			fVar5 = SYSTEM::VDIST2(Var2, Local_54[iVar0 /*8*/]);
...
bool func_105()
{
	...
	if (Global_112915.f_10049.f_135[1] == -1)
	{
		return 1;
	}
	...
	if (iVar0 > 0)
	{
		...
		while (iVar2 <= (iVar0 - 1))
		{
			if (Global_112915.f_10049.f_135[iVar2] != -1)
			{
				return 0;
			}
			iVar2++;
	...
	if (iVar1 == 31)
	{
		return Global_112915.f_10049.f_135[iVar0] == -1;
	}
	return Global_112915.f_10049.f_135[iVar0] == (SYSTEM::ROUND(SYSTEM::POW(2f, SYSTEM::TO_FLOAT(iVar1 + 1))) - 1);
}
...
void func_106()
{
	if (bLocal_460)
	{
		...
		{
			case 0:
				iLocal_462 = MISC::GET_GAME_TIMER() + 2000;
				iLocal_458++;
				break;
			
			case 1:
				if (iLocal_462 < MISC::GET_GAME_TIMER())
				{
					if (!func_112())
					{
			...
			case 2:
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_459) || iLocal_462 < MISC::GET_GAME_TIMER())
				{
					if (iLocal_462 < MISC::GET_GAME_TIMER())
					{
						bLocal_460 = false;
			...
			case 3:
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_459, "SHOW_BRIDGES_KNIVES_PROGRESS");
				func_111("PM_TITLE");
				...
				iLocal_462 = MISC::GET_GAME_TIMER() + 7500;
				AUDIO::PLAY_SOUND_FRONTEND(-1, "UNDER_THE_BRIDGE", "HUD_AWARDS", true);
				iLocal_458++;
				break;
			
			case 4:
				if ((((((iLocal_462 < MISC::GET_GAME_TIMER() || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || func_112()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_110()) || func_109())
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_459, "SHARD_ANIM_OUT");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0,33f);
					GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
					iLocal_462 = MISC::GET_GAME_TIMER() + 500;
					iLocal_458++;
				}
				break;
			...
			case 6:
				...
				if (func_105())
				{
					iLocal_462 = MISC::GET_GAME_TIMER() + 1000;
					iLocal_458++;
				}
				else
				{
...
void func_115(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7, float fParam8)
{
	Local_54[iParam0 /*8*/] = { Param1 };
	Local_54[iParam0 /*8*/].f_3 = { Param4 };
