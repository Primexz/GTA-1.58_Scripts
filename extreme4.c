...
void __EntryFunction__()
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_80 = func_377(52);
	iLocal_81 = joaat("a_c_retriever");
	Local_143 = { 1726,4f, 83,0424f, 169,67f };
	...
	{
		func_374("Force cleanup [TERMINATING]");
		func_351(1);
		func_336(1);
	}
	if (func_335())
	...
	if (!func_335())
	{
		if ((func_317(Local_82.f_28[0]) && func_317(PLAYER::PLAYER_PED_ID())) && !func_316(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 4f, 1))
		{
			iLocal_383 = 1;
		}
	}
	while (true)
	{
		...
		func_299(Local_82.f_9, 0, 0, 0, 0, 0);
		...
		{
			if (func_317(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668,882f, -19,65248f, 172,6748f, 1653,855f, 8,008027f, 175,0248f, 7f, false, true, 0))
			{
				if (func_317(Local_155.f_0))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 10f, 1))
					{
						func_297();
					}
				}
...
void func_1()
{
	switch (iLocal_147)
	{
		case 0:
			...
			HUD::CLEAR_PRINTS();
			HUD::CLEAR_HELP(true);
			if (MISC::IS_STRING_NULL_OR_EMPTY(sLocal_168))
			{
				func_351(1);
			}
			else
...
void func_8()
{
	switch (iLocal_149)
	{
		...
		case 1:
			...
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_178, false))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), iLocal_178, 1f, 1))
					{
			...
			if (iLocal_347 == 0)
			{
				...
				if (func_228(Local_155.f_0))
				{
				}
				iLocal_347 = 1;
			}
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				if (iLocal_375 == 0)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1624,015f, -5,45107f, 102,0677f, 1639,007f, -52,9875f, 181,3352f, 58,75f, false, true, 0) && PED::GET_PED_PARACHUTE_STATE(PLAYER::PLAYER_PED_ID()) == 2)
					{
						iLocal_375 = 1;
					}
				}
				if (func_228(Local_155.f_0))
				{
					...
					{
						if ((MISC::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665,729f, -26,27869f, 172,5815f, 1672,652f, -24,58394f, 177,2547f, 4f, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650,519f, 5,134407f, 172,6743f, 1656,571f, 9,669823f, 176,7743f, 15,25f, false, true, 0))
						{
							iLocal_149 = 2;
						}
					}
				}
				else if ((MISC::GET_GAME_TIMER() > iLocal_370 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665,729f, -26,27869f, 172,5815f, 1672,652f, -24,58394f, 177,2547f, 4f, false, true, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650,519f, 5,134407f, 172,6743f, 1656,571f, 9,669823f, 176,7743f, 15,25f, false, true, 0))
				{
					iLocal_149 = 2;
				}
			}
			if (MISC::GET_GAME_TIMER() < iLocal_370 + 5000)
			{
				if (RECORDING::_IS_RECORDING())
				{
		...
		case 2:
			...
			{
				if (func_211(&uLocal_182, "EXT4AUD", "EXT4_WIL2", 8, 0, 0, 0))
				{
					func_9();
				}
			}
...
void func_229()
{
	...
	while (MISC::GET_GAME_TIMER() < iLocal_374 + 11000 && !CAM::IS_SCREEN_FADED_OUT())
	{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_371) == 1f)
				{
					if (func_317(Local_155.f_0))
					{
						...
						iLocal_364 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
						TASK::TASK_SYNCHRONIZED_SCENE(Local_155.f_0, iLocal_372, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1000f, 0);
						PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_372, false);
						CAM::SET_CAM_ACTIVE(iLocal_364, true);
						CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_364, iLocal_372, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, false, false);
						CAM::DESTROY_CAM(iLocal_363, false);
						iLocal_379 = 1;
					}
				}
			}
		...
		{
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_372) >= 0,2f)
			{
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_372) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_372) == 1f)
			{
				if (func_317(Local_155.f_0))
				{
					...
					iLocal_365 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
					TASK::TASK_SYNCHRONIZED_SCENE(Local_155.f_0, iLocal_373, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1000f, 0);
					PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_373, true);
					CAM::SET_CAM_ACTIVE(iLocal_365, true);
					...
					CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, false, false);
					CAM::DESTROY_CAM(iLocal_364, false);
					iLocal_380 = 1;
				}
			}
		}
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_373) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_373) >= 0,323f)
		{
			if (!iLocal_376)
			{
			...
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_373) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_373) >= 0,44f)
				{
					iLocal_180 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_extrm4_water_blood", 1655,27f, -20,8134f, 133,842f, 0f, 0f, 0f, 1f, false, false, false, false);
					GRAPHICS::SET_PARTICLE_FX_LOOPED_ALPHA(iLocal_180, 1f);
					iLocal_382 = 1;
				}
			}
		}
		if (MISC::GET_GAME_TIMER() > iLocal_374 + 600 && fVar1 == 1f)
		{
			if (!iLocal_377)
			{
				iLocal_377 = 1;
		...
		if (MISC::GET_GAME_TIMER() > iLocal_374 + 630)
		{
		...
		if (MISC::GET_GAME_TIMER() > iLocal_374 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&iLocal_175);
		...
		if (MISC::GET_GAME_TIMER() > iLocal_374 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_317(Local_155.f_0))
		...
		if (MISC::GET_GAME_TIMER() > iLocal_374 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_317(Local_155.f_0))
		...
		if (MISC::GET_GAME_TIMER() > iLocal_374 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (MISC::GET_GAME_TIMER() > iLocal_374 + 10000)
		{
			if (iVar0 != 7)
			{
				CAM::DESTROY_CAM(iLocal_365, false);
				iLocal_362 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", true);
				CAM::SET_CAM_PARAMS(iLocal_362, 1659,893f, -6,552459f, 174,871f, -29,25931f, 1E-06f, 122,4502f, 50f, 0, 1, 1, 2);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
				CAM::SET_CAM_ACTIVE(iLocal_362, true);
				iVar0 = 7;
			}
		}
	}
	...
	if (func_317(Local_155.f_0))
	{
		if (iVar0 < 3)
		{
			ENTITY::SET_ENTITY_HEALTH(Local_155.f_0, 101, 0);
			Var4 = { ENTITY::GET_ENTITY_COORDS(Local_155.f_0, true) };
			if (Var4.f_2 > 155f)
			{
				fVar7 = 155f;
			}
			...
			ENTITY::SET_ENTITY_COORDS(Local_155.f_0, 1657,046f, -17,4571f, fVar7, true, false, false, true);
		}
	}
	...
	if (func_228(Local_155.f_0))
	{
		...
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_155.f_0);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, false, false);
		ENTITY::SET_ENTITY_COORDS(Local_155.f_0, 1655,77f, -20,04f, 135,8f, true, false, false, true);
		ENTITY::SET_ENTITY_HEALTH(Local_155.f_0, 0, 0);
	}
	func_230(&uLocal_182, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_211(&uLocal_182, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}
...
int func_238(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_245()
{
	...
	switch (iLocal_149)
	{
		case 0:
			iLocal_151 = 0;
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1655,139f, 5,342447f, 172,6748f, 1662,085f, -6,198325f, 175,0248f, 8,25f, false, true, 0))
			{
			...
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658,95f, -5,45f, 173,78f, 0,2f, 0,2f, 0,2f, false, true, 0))
					{
						RECORDING::_0x48621C9FCA3EBD28(1);
						CUTSCENE::START_CUTSCENE(2048);
						if (func_317(Local_155.f_0))
						{
							CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_155.f_0, "Dom", 0, joaat("cs_dom"), 0);
						}
						SYSTEM::WAIT(0);
						iLocal_383 = 0;
						...
						if (func_317(Local_155.f_0))
						{
							ENTITY::FREEZE_ENTITY_POSITION(Local_155.f_0, false);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_179) && !ENTITY::IS_ENTITY_DEAD(iLocal_179, false))
						{
							ENTITY::SET_ENTITY_VISIBLE(iLocal_179, false, false);
						}
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							iLocal_172 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
							iLocal_181 = ENTITY::GET_ENTITY_MODEL(iLocal_172);
							if (VEHICLE::IS_THIS_MODEL_A_CAR(iLocal_181) == 1 || VEHICLE::IS_THIS_MODEL_A_BIKE(iLocal_181) == 1)
							{
								Local_348 = { 1649,793f, 11,7826f, 172,7745f };
								fLocal_351 = 220,9923f;
							}
							else
							{
								Local_348 = { 1662,016f, 53,0925f, 171,2482f };
								fLocal_351 = 298,6364f;
							}
							func_251(1654,721f, 4,166876f, 172,5245f, 1662,562f, -8,920052f, 178,2742f, 6,25f, Local_348, fLocal_351, 1, 1, 1, 0, 0);
						}
						else
						{
							Local_348 = { 1649,793f, 11,7826f, 172,7745f };
							fLocal_351 = 220,9923f;
							func_250(Local_348, fLocal_351);
						}
						func_247(1660,186f, -7,492f, 172,774f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
						MISC::CLEAR_AREA_OF_PEDS(1660,186f, -7,492f, 172,774f, 200f, 0);
						iLocal_366 = PED::ADD_SCENARIO_BLOCKING_AREA(1636,691f, -89,8127f, 150f, 1706,146f, 58,721f, 190f, false, true, true, true);
						iLocal_149 = 1;
					}
				}
			}
					...
					if (!iLocal_154)
					{
						if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371))
						{
							if (func_317(Local_155.f_0))
							{
								...
								{
									iLocal_363 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
								}
								CAM::SET_CAM_ACTIVE(iLocal_363, true);
								CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
								iLocal_371 = PED::CREATE_SYNCHRONIZED_SCENE(1656,378f, -12,057f, 169,038f, 0f, 0f, 115,85f, 2);
								TASK::TASK_SYNCHRONIZED_SCENE(Local_155.f_0, iLocal_371, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1000f, 0);
								PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_371, true);
								CAM::SET_CAM_ACTIVE(iLocal_363, true);
								CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_363, iLocal_371, "Base_Jump_Spot_CAM", "rcmextreme4");
								CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
								PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_155.f_0, false, false);
								iLocal_154 = 1;
							}
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_179) && !ENTITY::IS_ENTITY_DEAD(iLocal_179, false))
			{
				ENTITY::SET_ENTITY_VISIBLE(iLocal_179, true, false);
			}
			if (iLocal_151 == 0)
			{
...
void func_247(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_248(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_250(struct<3> Param0, float fParam3)
{
	int iVar0;
...
void func_251(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	func_252(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
		{
			...
			else
			{
				...
				{
					if (func_256(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_254(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar0 = 0;
	while (func_255(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_255(int iParam0, int iParam1, char* sParam2, var uParam3)
{
...
int func_256(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if (((((((((((((((func_257(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_257(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_257(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_257(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_257(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_257(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_257(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_257(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_257(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_257(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_257(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_257(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_257(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_257(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_257(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_257(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_257(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		{
			if (!func_264(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_263(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
int func_264(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
void func_267()
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (((((((PAD::IS_CONTROL_PRESSED(0, 30) || PAD::IS_CONTROL_PRESSED(0, 31)) || PAD::IS_CONTROL_PRESSED(0, 23)) || PAD::IS_CONTROL_PRESSED(0, 21)) || PAD::IS_CONTROL_PRESSED(0, 22)) || (func_279() && PAD::IS_CONTROL_PRESSED(0, 1))) || (func_279() && PAD::IS_CONTROL_PRESSED(0, 2))) || (func_279() && PAD::IS_CONTROL_PRESSED(0, 32)))
			{
	...
	{
		case 0:
			if (func_317(Local_82.f_28[0]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_82.f_28[0], 17, true);
			}
			iLocal_368 = 0;
			iLocal_383 = 1;
			func_278("EXT4_01", 7500, 1);
			iLocal_170 = func_277(Local_155.f_0, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_149 = 1;
			break;
		...
		case 1:
			...
			if (func_317(PLAYER::PLAYER_PED_ID()))
			{
				if (func_317(Local_155.f_0))
				{
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 100f, 1))
					{
						CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
					...
					if (PED::IS_PED_RAGDOLL(Local_155.f_0))
					{
						ENTITY::SET_ENTITY_HEALTH(Local_155.f_0, 0, 0);
					}
					if (func_316(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 32f, 1))
					{
						if (func_271(Local_155.f_0, 1, 0, 0, 0))
						{
							if (iLocal_169 == 0)
							{
								if (!func_266())
								{
									func_270(&uLocal_182, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_1", 7, 0, 0);
									iLocal_169 = 1;
								}
							}
							else if (iLocal_169 == 1)
							{
								if (!func_266())
								{
									func_270(&uLocal_182, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_2", 7, 0, 0);
									iLocal_169 = 2;
								}
							}
						}
						else
						{
							if (!iLocal_378)
							{
								if (func_316(PLAYER::PLAYER_PED_ID(), Local_155.f_0, 30f, 1) && !func_266())
								{
									if (func_211(&uLocal_182, "EXT4AUD", "EXT4_COMM", 7, 0, 0, 0))
									{
										iLocal_378 = 1;
									}
								}
							...
							func_269();
							if (!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), Local_155.f_0))
							{
								TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_155.f_0, -1, 0, 2);
							}
						}
					}
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1663,587f, -11,71415f, 172,6748f, 1658,387f, -1,735749f, 175,7748f, 5,5f, false, true, 0))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							iLocal_149 = 2;
...
void func_268()
{
	if (func_317(Local_155.f_0))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(Local_155.f_0, 242628503) != 1)
		{
			TASK::TASK_PERFORM_SEQUENCE(Local_155.f_0, iLocal_171);
		}
	}
}
...
void func_269()
{
	if (!func_266())
	{
		if (iLocal_368 < 5)
		{
			if (MISC::GET_GAME_TIMER() > (iLocal_369 + (8000 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))))
			{
				if (AUDIO::HAS_SOUND_FINISHED(iLocal_367))
				{
					if (func_211(&uLocal_182, "EXT4AUD", "EXT4_DOM", 6, 0, 0, 0))
					{
	...
	if (!func_266())
	{
		if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
		{
			if (AUDIO::HAS_SOUND_FINISHED(iLocal_367))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_367, "DOM", Local_155.f_0, "EXTREME_04_SOUNDSET", false, 0);
			}
		}
	}
}

int func_270(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_272(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_274(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_258(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, true)) };
	...
	{
		Var3 = { func_258(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_275(Var3, Var0);
...
int func_277(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
...
void func_280()
{
	...
	{
		func_290(1732,133f, 91,9424f, 169,7872f, 128,6917f, 1, 0);
		func_288(0, -1, 1);
...
void func_281()
{
	if (func_228(Local_82.f_28[0]))
	{
		func_285(Local_82.f_28[0], 1737,453f, 101,7498f, 170,0243f, 288,5211f, 0, 1);
	}
	else
	{
		func_282(&(Local_82.f_28[0]), 1737,453f, 101,7498f, 170,0243f, 288,5211f);
	}
	TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_82.f_28[0], 1826,662f, 146,9161f, 170,4472f, 1f, -1, 0,25f, false, 40000f);
	TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", false);
	MISC::CLEAR_AREA_OF_VEHICLES(Local_155.f_1, 20f, false, false, false, false, false, false, 0);
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_173))
	{
		iLocal_173 = VEHICLE::CREATE_VEHICLE(joaat("sanchez"), 1662,88f, -14,255f, 172,7742f, 205,3516f, true, true, false);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_174))
	{
		iLocal_174 = VEHICLE::CREATE_VEHICLE(joaat("bmx"), 1633,766f, -23,6768f, 127,0535f, 55,7565f, true, true, false);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_176))
	{
		iLocal_176 = OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1666,282f, -11,20408f, 172,7773f, true, true, false);
		ENTITY::SET_ENTITY_ROTATION(iLocal_176, 0,000637f, -0,000136f, 10,66059f, 2, true);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_177))
	{
		iLocal_177 = OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1667,076f, -12,07778f, 173,2611f, true, true, false);
		ENTITY::SET_ENTITY_ROTATION(iLocal_177, 90,03932f, -0,257438f, -13,86142f, 2, true);
	}
	if (func_317(Local_155.f_0))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(Local_155.f_0, 242628503) != 1)
		{
			...
			TASK::SET_SEQUENCE_TO_REPEAT(iLocal_171, true);
	...
	if (func_317(Local_155.f_0))
	{
		PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_155.f_0, false);
		func_230(&uLocal_182, 4, Local_155.f_0, "DOM", 0, 1);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_155.f_0, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID()));
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_179))
	{
		iLocal_179 = OBJECT::CREATE_AMBIENT_PICKUP(joaat("pickup_parachute"), 1665,264f, -11,4427f, 172,7747f, 7, -1, joaat("p_parachute_s"), true, true);
	}
	ENTITY::SET_ENTITY_ROTATION(iLocal_179, -111,8225f, -0,454914f, -162,2231f, 2, true);
	ENTITY::PLAY_ENTITY_ANIM(iLocal_179, "Chute_Off_Bag", "skydive@parachute@", 4f, false, true, false, 0,99f, 0);
	func_246(1);
}

void func_282(int* iParam0, struct<3> Param1, float fParam4)
{
	func_283(iParam0, iLocal_81, Param1, fParam4, 26);
	PED::SET_PED_DEFAULT_COMPONENT_VARIATION(*iParam0);
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(*iParam0, false);
	PED::SET_PED_NAME_DEBUG(*iParam0, "EXTREME LAUNCHER RC");
}

void func_283(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_284(iParam0);
...
int func_285(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_290(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	if (func_335())
	{
...
void func_291()
{
	switch (iLocal_150)
	{
		case 0:
			func_296();
			iLocal_151 = 0;
			func_295("es_4_rcm_p1", 0);
			if (func_293(1, 1093140480, 0))
			{
				if (!iLocal_383 || MISC::GET_GAME_TIMER() > iLocal_384 + 3500)
				{
					func_292();
					RECORDING::_0x48621C9FCA3EBD28(1);
					...
					SYSTEM::WAIT(0);
					CAM::STOP_GAMEPLAY_HINT(false);
					func_251(1729,922f, 89,4162f, 174,0123f, 1739,745f, 101,2816f, 167,8282f, 7f, 1739,956f, 97,8651f, 169,9797f, 140,876f, 1, 1, 1, 0, 0);
					func_251(1743,115f, 105,833f, 169,6362f, 1732,029f, 93,77112f, 172,6075f, 4f, 1739,956f, 97,8651f, 169,9797f, 140,876f, 1, 1, 1, 0, 0);
					func_247(1733,315f, 95,2246f, 169,9192f, 1, 1, 1, 1, 1, 1, 0, 1, 1, 1);
					iLocal_150 = 1;
				}
			}
			break;
		...
		case 2:
			func_285(PLAYER::PLAYER_PED_ID(), 1732,222f, 92,0087f, 169,7867f, 138,1854f, 0, 1);
			PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Walk"), false, 1, false);
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1723,452f, 80,729f, 169,6701f, 1f, -1, 1f, 2113, 40000f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
...
void func_296()
{
	...
	fVar3 = -0,85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_82.f_28[0])) && func_317(PLAYER::PLAYER_PED_ID())) && iLocal_383 == 1)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], -1, 0, 2);
			TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 0f, 0f, 0f, 1f, -1, 0,5f, true);
			CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(true);
			CAM::SET_GAMEPLAY_ENTITY_HINT(Local_82.f_28[0], -0,5f, 0f, -0,2f, true, 30000, 2000, 2000, 0);
		...
		{
			if (func_316(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 4f, 1))
			{
				iLocal_384 = (iLocal_384 - 10000);
			}
...
void func_297()
{
	...
	if (iLocal_383)
	{
		if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
		{
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
			TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_155.f_0, -1, 0, 2);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1658,95f, -5,45f, 173,78f, 1f, -1, 0,25f, false, -161,08f);
			CAM::_SET_GAMEPLAY_HINT_ANIM_CLOSEUP(true);
			CAM::SET_GAMEPLAY_ENTITY_HINT(Local_155.f_0, 0f, 0f, 0f, true, 30000, 2000, 2000, 0);
			CAM::SET_GAMEPLAY_HINT_FOV(fVar0);
			CAM::SET_GAMEPLAY_HINT_FOLLOW_DISTANCE_SCALAR(fVar1);
			CAM::SET_GAMEPLAY_HINT_BASE_ORBIT_PITCH_OFFSET(fVar2);
			CAM::_SET_GAMEPLAY_HINT_ANIM_OFFSETX(fVar3);
...
void func_298()
{
	...
	if (iLocal_148 == 1)
	{
		...
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_155.f_0, true), true);
			if (iLocal_153 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					HUD::SET_BLIP_FLASHES(iLocal_170, true);
				}
			}
			else if (HUD::DOES_BLIP_EXIST(iLocal_170))
			{
				HUD::SET_BLIP_FLASHES(iLocal_170, false);
			}
		}
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1660,332f, -20,45607f, 136,7029f, 1584,419f, -30,29117f, 120,6038f, 32f, false, true, 0))
		{
			sLocal_168 = "EXT4_F2";
			iLocal_148 = 4;
		}
...
{
	if (((!func_313(0) || Global_78121) || Global_78110 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_78106)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_312(0)) || func_311(1))
			{
			}
			else
			{
...
{
	return func_315(iParam0, Global_42596);
}
...
bool func_316(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
void func_318()
{
	...
	{
		iLocal_175 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_box_guncase_03a"), 1658,299f, -7,930665f, 173,71f, true, true, false);
		ENTITY::SET_ENTITY_ROTATION(iLocal_175, 90f, 0f, -63f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(iLocal_175, true);
		ENTITY::SET_ENTITY_VISIBLE(iLocal_175, false, false);
	}
	func_322(1);
	if (!ENTITY::DOES_ENTITY_EXIST(Local_155.f_0))
	{
		func_319(&Local_155, 52, Local_155.f_1, Local_155.f_4, "Ext4-Dom", 1);
		ENTITY::FREEZE_ENTITY_POSITION(Local_155.f_0, true);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_155.f_0, true);
		WEAPON::REMOVE_ALL_PED_WEAPONS(Local_155.f_0, true);
		PED::SET_PED_COMPONENT_VARIATION(Local_155.f_0, 8, 2, 0, 0);
		AUDIO::DISABLE_PED_PAIN_AUDIO(Local_155.f_0, true);
		PED::SET_PED_CONFIG_FLAG(Local_155.f_0, 137, true);
		PED::SET_PED_CONFIG_FLAG(Local_155.f_0, 118, false);
		PED::SET_PED_CONFIG_FLAG(Local_155.f_0, 208, true);
		PED::SET_PED_MONEY(Local_155.f_0, 5000);
	}
	if (func_228(PLAYER::PLAYER_PED_ID()))
	{
		func_230(&uLocal_182, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
int func_319(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_320(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_320(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_322(int iParam0)
{
	...
	if (iParam0 == 1)
	{
		while ((((!STREAMING::HAS_MODEL_LOADED(Local_155.f_5) || !STREAMING::HAS_MODEL_LOADED(joaat("sanchez"))) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmextreme4")) || !STREAMING::HAS_ANIM_DICT_LOADED("skydive@parachute@")) || !STREAMING::HAS_PTFX_ASSET_LOADED())
		{
			SYSTEM::WAIT(0);
		}
	}
...
void func_323(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_117[iParam0 /*10*/].f_8 != 160)
	{
		...
		if (iParam1 == 4)
		{
			...
			func_328(iParam0, 2, 1);
		}
		else
		{
			if (func_327(iParam0, iParam1) == 1 && func_326(iParam0, iParam1) == 1)
			{
				bParam2 = false;
			}
			iVar0 = iParam1;
			func_329(iParam0, iVar0, 1);
			func_328(iParam0, iVar0, 1);
		...
		if (bParam2)
		{
			if (!Global_77852)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_8483[iParam1 /*4*/] = { func_325(iParam0) };
					...
					{
						Global_8434[1 /*6*/] = { func_325(iParam0) };
...
int func_330(var uParam0)
{
	...
	switch (iLocal_79)
	{
		case 0:
			...
			func_334(&(uParam0->f_48), "rcmextreme4", "idle_a", "idle_c");
			iLocal_79 = 1;
			break;
		
		case 1:
			if (!func_333(&iVar0) || !func_331(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_79 = 2;
		...
		case 2:
			func_282(&(uParam0->f_28[0]), 1732,27f, 96,36f, 170,29f, -98,56f);
...
void func_334(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
void func_336(int iParam0)
{
	...
	func_348(&iLocal_176, 0);
	func_348(&iLocal_177, 0);
	func_348(&iLocal_178, 0);
	TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", true);
	func_337(&Local_82, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_337(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	func_345(uParam0, iParam1);
	func_340(uParam0, bParam2);
	func_338(uParam0, bParam3);
}

void func_338(var uParam0, bool bParam1)
{
	func_339(&(uParam0->f_41), bParam1);
}
...
void func_346(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_347(uParam0[iVar0], 0, 1, 0);
		}
		iVar0++;
	}
}

void func_347(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
{
	func_337(&Local_82, 1, 0, 0);
	func_347(&(Local_82.f_28[0]), 1, 0, 1);
...
void func_351(bool bParam0)
{
	...
	if (!func_372())
	{
		...
		{
			func_167(iVar0, 1, 0);
			func_352(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_112002[iVar0 /*10*/].f_9 == -1)
...
void func_352(char* sParam0, int iParam1)
{
	if (Global_99974 != 12)
	{
		if (func_353(sParam0, 6, iParam1))
		{
...
int func_353(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_359())
	{
		...
		{
			iVar33 = func_354(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_355()
{
	...
	iVar0 = func_356(&(Global_99974.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_359()
{
	...
	{
		if (func_354(&(Global_99974.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_376(&(uParam0->f_28));
	func_376(&(uParam0->f_35));
	func_376(&(uParam0->f_41));
}
