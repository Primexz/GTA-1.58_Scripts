...
void __EntryFunction__()
{
	...
	StringCopy(&Local_677, "MAUDE_MCS_3", 24);
	...
	if (func_521())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_PLANE(Global_106464.f_2890.f_12.f_66))
				{
	...
	else if (func_434(0))
	{
		...
		{
			func_432(PLAYER::PLAYER_PED_ID(), Local_698, fLocal_458, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_692 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_421();
			func_420();
			switch (iLocal_98)
			{
		...
		switch (iLocal_98)
		{
			case 0:
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_701, fLocal_459, 0, 1);
			...
			case 1:
				...
				if (iLocal_100 == 1)
				{
					if (!func_71())
					{
						func_20(PLAYER::PLAYER_PED_ID(), Local_704, fLocal_460, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_443 == 0)
						{
				...
				if (iLocal_100 == 1)
				{
					...
					if (iLocal_473 > 0)
					{
						...
						while (iVar0 <= (iLocal_473 - 1))
						{
							...
							{
								PED::EXPLODE_PED_HEAD(Local_132[iVar0 /*20*/], joaat("weapon_sniperrifle"));
								ENTITY::SET_ENTITY_HEALTH(Local_132[iVar0 /*20*/], 0, 0);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_100 == 1)
				{
					...
					if (!func_71())
					{
						func_432(PLAYER::PLAYER_PED_ID(), Local_689, 254,9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_443 == 0)
						{
		...
		case 0:
			...
			if (iLocal_102 == 4)
			{
				if (func_23(Local_385.f_0))
				{
					...
					{
						if (func_112(Local_385.f_0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f))
						{
				...
				if (iLocal_102 == 4)
				{
					...
					else if (func_23(Local_385.f_0))
					{
						if (!func_64(Local_385.f_0, 1805844857))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_385.f_0, func_109(), func_74(), 3))
								{
									func_73(&Local_385);
	...
	switch (iLocal_100)
	{
		case 0:
			...
			while (iVar0 <= (iLocal_473 - 1))
			{
				if (func_23(Local_132[iVar0 /*20*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_132[iVar0 /*20*/], iLocal_664);
					if (!PED::IS_PED_FLEEING(Local_132[iVar0 /*20*/]))
					{
						func_121(iVar0);
					}
				}
		...
		case 1:
			if (func_120(iLocal_477, 500))
			{
				...
				if (!iLocal_445)
				{
					SCRIPT::REQUEST_SCRIPT(&cLocal_671);
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_671))
					{
						iVar0 = 0;
						while (iVar0 <= (iLocal_473 - 1))
						{
						...
						SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_671);
						iLocal_445 = 1;
					}
				}
	...
	if (func_23(Local_112.f_9))
	{
		...
		switch (iLocal_100)
		{
			case 0:
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_664);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_664, joaat("player"));
				iLocal_478 = ENTITY::GET_ENTITY_HEALTH(Local_112.f_9);
				Local_707 = { ENTITY::GET_ENTITY_COORDS(Local_112.f_9, false) };
				...
				if (!iLocal_448)
				{
					...
					if (Local_112.f_10 == 13 || Local_112.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_120(iLocal_463, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_112(Local_112.f_9, Local_692, 30f))
									{
			...
			switch (Local_112.f_10)
			{
				...
				case 29:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 14, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 28, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 37, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 43, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 45, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 50, false);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_112.f_9, 51, false);
						PED::SET_PED_COMBAT_RANGE(Local_112.f_9, 2);
						...
						TASK::TASK_COMBAT_PED(Local_112.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_112.f_9, Local_695, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_112.f_9, true);
						Local_112.f_10 = 30;
					}
					break;
				...
				case 13:
					if (func_120(Local_112.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_112.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_112.f_9, Local_692);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_112.f_9, &iVar0, true);
						if (iVar0 != joaat("weapon_unarmed"))
						{
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], false) && func_112(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) && func_369(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_254[0 /*6*/], false) || PED::IS_PED_BEING_JACKED(Local_112.f_9)) || !func_112(Local_254[0 /*6*/], Local_254[0 /*6*/].f_1, 3f)) || !func_369(ENTITY::GET_ENTITY_HEADING(Local_254[0 /*6*/]), Local_254[0 /*6*/].f_4, 20f))
					{
						Local_112.f_10 = 13;
					}
...
void func_383()
{
	if (func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_689, 100f))
	{
		if (!func_384())
		{
			CUTSCENE::REQUEST_CUTSCENE(&Local_677, 8);
			func_67();
			iLocal_453 = 1;
		}
	}
	...
	{
		if (!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_689, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_112.f_9, false) && PED::GET_VEHICLE_PED_IS_IN(Local_112.f_9, false) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_462) > 7500)
						{
							func_389(0);
						}
					}
					...
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_462) > 10000)
						{
							func_389(1);
						}
					}
			...
			else
			{
				...
				else if (Local_112.f_10 == 24 && func_64(Local_112.f_9, -1519143300))
				{
					if (func_112(Local_112.f_9, Local_692, 25f))
					{
						...
						{
							if (func_120(iLocal_464, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_62())
								{
									func_3();
				...
				else
				{
					...
					if (!func_62())
					{
						if (func_120(iLocal_463, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_112(Local_112.f_9, Local_692, 20f))
							{
...
void func_388(char* sParam0, bool bParam1)
{
	if (func_325(sParam0))
	{
		...
		switch (iLocal_100)
		{
			...
			case 1:
				if (!iLocal_449)
				{
					...
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_456))
						{
							if (iLocal_436)
							{
								iLocal_456 = func_395(Local_689, 5, 1);
							}
						}
						if (!iLocal_419)
						{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_689, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_112(PLAYER::PLAYER_PED_ID(), Local_689, 6,5f))
							{
								iLocal_100 = 2;
							}
						}
						else if (func_112(PLAYER::PLAYER_PED_ID(), Local_689, 2,5f))
						{
							iLocal_100 = 2;
						}
					}
		...
		switch (iLocal_100)
		{
			...
			case 1:
				...
				if (!iLocal_448)
				{
					...
					else if ((iLocal_468 > 0 && func_112(Local_112.f_9, Local_692, 85f)) || ENTITY::GET_ENTITY_HEALTH(Local_112.f_9) < 200)
					{
						Local_112.f_10 = 13;
						Local_112.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						iLocal_475 = MISC::GET_GAME_TIMER();
					...
					{
						if (func_120(iLocal_463, MISC::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_112(Local_112.f_9, Local_692, 30f))
							{
								if (MISC::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_132[iVar0 /*20*/]))
		{
			...
			switch (Local_132[iVar0 /*20*/].f_14)
			{
				...
				case 2:
					func_400(Local_132[iVar0 /*20*/], &(Local_132[iVar0 /*20*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0);
					break;
...
void func_401(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_23(Local_132[iVar0 /*20*/]))
		{
			Local_132[iVar0 /*20*/].f_15 = MISC::GET_GAME_TIMER();
	...
	if (!iLocal_431)
	{
		if (!func_62())
		{
			if (func_112(Local_112.f_9, Local_692, (22f + 5f)))
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(&Local_683))
				{
...
void func_422()
{
	...
	if (iLocal_98 == 0)
	{
		if (!SYSTEM::VDIST2(Local_692, Local_103) <= ((Local_103.f_3 + 25f) * (Local_103.f_3 + 25f)))
		{
...
int func_424(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_433(PLAYER::PLAYER_PED_ID()) && func_433(iParam0))
	{
...
int func_429(int iParam0, float fParam1)
{
	...
	if (func_433(PLAYER::PLAYER_PED_ID()) && func_433(iParam0))
	{
		if (func_431(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
		...
		if (Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_484(iParam0, &(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_484(iParam0, &(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_112915.f_2363.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
	...
	if ((func_89(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		if (VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && func_453(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_112915.f_20118[iParam0 /*43*/].f_31 = func_452(*iParam1);
				...
				func_450(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_112915.f_20118[iParam0 /*43*/].f_1));
				...
				func_450(Global_112915.f_2363.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_112915.f_20118[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_453(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if ((!func_479(iVar0, bParam1, uParam2) && !func_478(PLAYER::PLAYER_ID())) && !func_461(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_459(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0)))
	{
		bVar1 = true;
	}
	if (((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_457(iParam0)) && !bVar1) && !(func_456(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_454(PLAYER::PLAYER_ID())))
	{
...
int func_454(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			...
			{
				return func_455(Global_2689156[iParam0 /*453*/].f_319.f_6) == 11;
			}
		}
	}
	return 0;
...
int func_458(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_455(Global_2689156[iParam0 /*453*/].f_319.f_6) == 13;
			}
		}
	}
	return 0;
...
int func_459(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_455(Global_2689156[iParam0 /*453*/].f_319.f_6) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_477(PLAYER::PLAYER_ID()) || func_476(PLAYER::PLAYER_ID()))
	{
		if (func_462(iParam0))
		{
			return 1;
...
int func_463(int iParam0)
{
	...
	if (func_464(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
	{
		return 1;
	}
	return 0;
...
int func_465(int iParam0, bool bParam1)
{
	switch (ENTITY::GET_ENTITY_MODEL(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_467(ENTITY::GET_ENTITY_MODEL(iParam0), 0))
			{
...
int func_476(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			...
			{
				return func_455(Global_2689156[iParam0 /*453*/].f_319.f_6) == 5;
			}
		}
	}
	return 0;
...
int func_477(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1 && Global_2689156[iParam0 /*453*/].f_319.f_9 != func_82())
			{
				return func_455(Global_2689156[iParam0 /*453*/].f_319.f_6) == 8;
			}
		}
	}
	return 0;
...
int func_478(int iParam0)
{
	if (iParam0 != func_82())
	{
		if (func_341(iParam0, 1, 1))
		{
			if (Global_2689156[iParam0 /*453*/].f_319.f_6 != -1)
			{
				return func_455(Global_2689156[iParam0 /*453*/].f_319.f_6) == 9;
			}
		}
	}
	return 0;
...
int func_479(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_459(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0)))
	{
		bVar0 = true;
	}
...
int func_484(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_475(ENTITY::GET_ENTITY_MODEL(*iParam0), 1) && VEHICLE::GET_VEHICLE_MOD(*iParam0, 24) != func_487(*iParam0, ((*uParam1)[38] - 1)))
	{
		VEHICLE::SET_VEHICLE_MOD(*iParam0, 24, func_487(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_486(iParam0);
	if (func_485(*iParam0))
	{
...
void func_490(struct<3> Param0, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_491(int iParam0)
{
	...
	if (func_164(&(Global_76670.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_76670.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_170(iParam0, 0)) && Global_77579.f_66 == 0) && Global_112915.f_32749.f_1958[Global_76670.f_555[0 /*21*/].f_14] != 0) && Global_112915.f_32749.f_1958[Global_76670.f_555[0 /*21*/].f_14] > 3) && (!func_492(0, Global_76670.f_555[0 /*21*/].f_12) || !func_492(1, Global_76670.f_555[0 /*21*/].f_12)))
			{
...
int func_492(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_493(&(Global_112915.f_32749.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
...
{
	return func_495(&(Global_106464.f_2890), Param0, fParam3, 0);
}
	...
	if (func_512(uParam0))
	{
		...
		if (func_511(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_497(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_497(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_499(iParam0, uVar1[iVar6], 1) && func_498(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136,133f, 4780,563f, 39,9702f, 5f, 0))
				{
...
int func_498(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_512(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == joaat("stunt") && func_498(*uParam0, 1694,62f, 3276,27f, 41,31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
int func_516(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_518(Global_106464.f_2890.f_12.f_66))
	{
		return 0;
	}
...
void func_522()
{
	...
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_664);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_664, joaat("player"));
	Var0 = { func_529(Local_103) };
	Var3 = { func_528(Local_103) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var3);
	iLocal_482 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, false, true, true, true);
	MISC::CLEAR_AREA(Local_103, 15f, false, false, false, false);
...
void func_523()
{
	...
	if (func_23(Local_112.f_9))
	{
		...
		Local_112.f_10 = 0;
		PED::SET_PED_COMPONENT_VARIATION(Local_112.f_9, 0, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_112.f_9, 2, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_112.f_9, 3, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_112.f_9, 4, 0, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_112.f_9, 8, 0, 0, 0);
		TASK::OPEN_SEQUENCE_TASK(&iLocal_484);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0f, false, false, false);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0f, false, false, false);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_c", 8f, -4f, -1, 0, 0f, false, false, false);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0f, false, false, false);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0f, false, false, false);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0f, false, false, false);
	...
	while (iVar0 <= 5)
	{
		if (func_23(Local_132[iVar0 /*20*/]))
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_132[iVar0 /*20*/], Local_132[iVar0 /*20*/].f_5, -1, true, true);
			}
			PED::SET_PED_CONFIG_FLAG(Local_132[iVar0 /*20*/], 137, true);
			func_524(Local_132[iVar0 /*20*/], "BACKUP_", iVar0);
			if (func_102(Local_254[0 /*6*/]))
			{
				if (iVar0 == 1)
				{
					PED::SET_PED_INTO_VEHICLE(Local_132[iVar0 /*20*/], Local_254[0 /*6*/], -1);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_132[iVar0 /*20*/], 1, false);
				}
				else if (iVar0 == 2)
				{
					PED::SET_PED_INTO_VEHICLE(Local_132[iVar0 /*20*/], Local_254[0 /*6*/], 2);
				}
				else if (iVar0 == 3)
				{
					PED::SET_PED_INTO_VEHICLE(Local_132[iVar0 /*20*/], Local_254[0 /*6*/], 1);
			...
			{
				case 0:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 0, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 2, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 3, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 4, 0, 0, 0);
					break;
				
				case 1:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 0, 0, 3, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 2, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 3, 2, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 4, 0, 1, 0);
					break;
				
				case 2:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 0, 1, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 2, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 3, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 4, 0, 2, 0);
					break;
				
				case 3:
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 0, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 2, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_132[iVar0 /*20*/], 4, 0, 2, 0);
					break;
			}
			if (iVar0 == 0)
			{
				...
				TASK::SET_SEQUENCE_TO_REPEAT(iLocal_484, true);
				TASK::CLOSE_SEQUENCE_TASK(iLocal_484);
				TASK::TASK_PERFORM_SEQUENCE(Local_132[iVar0 /*20*/], iLocal_484);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_484);
				if (func_23(Local_132[iVar0 /*20*/]))
				{
					func_97(&uLocal_499, 4, Local_132[iVar0 /*20*/], "HILLBILLY", 0, 1);
					PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Local_132[iVar0 /*20*/], true);
				}
			}
		}
		iVar0++;
	...
	if (iLocal_473 > 0)
	{
		...
		while (iVar2 <= (iLocal_473 - 1))
		{
			if (func_54(&(Local_132[iVar2 /*20*/]), Local_132[iVar2 /*20*/].f_19, Local_132[iVar2 /*20*/].f_1, Local_132[iVar2 /*20*/].f_4, 0, 0, 0))
			{
				...
				{
					PED::SET_PED_CONFIG_FLAG(Local_132[iVar2 /*20*/], 132, true);
					iVar0++;
					iVar1++;
				}
			}
...
int func_526(var uParam0, int iParam1, struct<3> Param2, int iParam5, int iParam6, bool bParam7)
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_527(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_111962) || Global_31508) || func_551()) || func_95(8, -1)) || func_550()) || func_549()) || func_543()) || func_544()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_545()) || Global_31508) || func_551()) || func_95(8, -1)) || func_543()) || func_550()) || func_549()) || func_544()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_111962) || Global_31508) || func_551()) || func_95(8, -1)) || func_543()) || func_550()) || func_549()) || func_544()) || Global_112915.f_7688.f_919[iVar0] == 5) || Global_43143 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_545()) || Global_111962) || Global_31508) || func_551()) || func_95(8, -1)) || func_550()) || func_549()) || func_544()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_545() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_95(8, -1)) || func_544()) || func_548()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_545()) || Global_31508) || func_551()) || func_95(8, -1)) || func_549()) || func_543()) || func_544()) || Global_112915.f_7688.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_545()) || func_549()) || Global_111962) || Global_31508) || func_551()) || Global_43774) || func_95(8, -1)) || func_543()) || func_548()) || func_544()) || Global_112915.f_7688.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
{
	return func_553(iParam0, Global_42596);
}
...
void func_554(int iParam0)
{
	...
	if (!func_578())
	{
		...
		func_555(SCRIPT::GET_THIS_SCRIPT_NAME());
	}
}
...
int func_556(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_567())
	{
		...
		{
			iVar33 = func_557(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
void func_559(var uParam0, char* sParam1, struct<2> Param2, int iParam4, int iParam5, int iParam6, struct<3> Param7, int iParam10, char* sParam11, int iParam12, int iParam13, char* sParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, var uParam22, int iParam23, int iParam24)
{
	uParam0->f_4 = iParam5;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_563()
{
	...
	iVar0 = func_564(&(Global_99974.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_567()
{
	...
	{
		if (func_557(&(Global_99974.f_3)) > -1)
		{
			return 1;
		}
	}
