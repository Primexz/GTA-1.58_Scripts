	...
	while (true)
	{
		switch (iLocal_52)
		{
			...
			case 1:
				...
				iLocal_53 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("PSYCHOLOGY_REPORT");
				while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_53))
				{
					func_43();
					SYSTEM::WAIT(0);
				}
				...
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_53, "SET_PLAYER_NAME");
				...
				func_42(&Var0);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				while (!func_13(&uLocal_70, &iLocal_71, &uLocal_54))
				{
					func_43();
					SYSTEM::WAIT(0);
				}
...
void func_1(int* iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4, float fParam5)
{
	...
	if (!func_6(iParam0->f_1, 256) || (func_6(iParam0->f_1, 8192) && PAD::_0x6CD79468A1E595C6(2)))
	{
		...
		if (MISC::IS_PC_VERSION())
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(func_6(iParam0->f_1, 4096));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_34(int iParam0)
{
	if (iParam0 < 9)
	{
		return MISC::IS_BIT_SET(Global_112915.f_18103.f_175[iParam0 /*19*/].f_18, 0);
	}
	return 0;
}
...
int func_36(int iParam0)
{
	...
	{
		case 0:
			return Global_112915.f_10049.f_90[0];
			break;
		
		case 1:
			return Global_112915.f_10049.f_90[1];
			break;
		
		case 2:
			return Global_112915.f_10049.f_90[2];
			break;
	}
	return 0;
}
