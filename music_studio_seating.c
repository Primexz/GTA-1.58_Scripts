...
void func_3(var uParam0)
{
	...
	if (uParam0->f_13 > 2)
	{
		...
		{
			func_4(PLAYER::PLAYER_ID(), 1, 0, 0);
		}
	}
	MISC::CLEAR_BIT(&(Global_2689156[PLAYER::PLAYER_ID() /*453*/].f_319.f_4), 15);
}
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || (!func_13(PLAYER::PLAYER_ID(), 0) && !func_12()))
				{
			...
			if (bParam1)
			{
				...
				if (!func_8(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					if (!bVar22)
					{
			...
			else
			{
				if (!func_8(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (func_5(Global_4718592.f_138117))
					{
...
void func_24(var uParam0)
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if ((func_78(PLAYER::PLAYER_PED_ID(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_77(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13)) && !(func_75() && uParam0->f_9 == 8))
			{
				if ((((((((((((func_74(uParam0) || func_70(uParam0)) || func_69(uParam0)) || !func_68(uParam0)) || func_66(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1946934.f_4, 2)) || func_65(uParam0->f_16[uParam0->f_9 /*14*/].f_13))
				{
					MISC::SET_BIT(&(Global_1946934.f_3), 16);
					if (func_70(uParam0))
					{
						func_64(&(uParam0->f_6), 4, "POD_TOO_MANY", 0, 0, 0, 0);
					}
					else
					{
						func_22(&(uParam0->f_6));
				...
				else
				{
					...
					if (uParam0->f_6 == -1)
					{
						...
						{
							if (func_63(uParam0->f_9) && !Global_262145.f_26719)
							{
								func_64(&(uParam0->f_6), 4, "MPTV_WALKOFF", 0, 0, 0, 0);
							}
							else
							{
								func_64(&(uParam0->f_6), 4, "MPJAC_SIT", 0, 0, 0, 0);
							}
						}
					}
					else if (PAD::IS_CONTROL_JUST_PRESSED(0, 51))
					{
						...
						{
							MISC::SET_BIT(&(Global_2689156[PLAYER::PLAYER_ID() /*453*/].f_319.f_4), 15);
							func_58(157);
						}
					}
				}
		...
		case 4:
			func_57(uParam0, &sVar0);
			func_56(uParam0, &sVar16);
			if (uParam0->f_1.f_1 == 3)
			{
				if (CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0) == 4)
				{
					if (!func_55(&(uParam0->f_7), 13))
					{
						CAM::SET_CAM_VIEW_MODE_FOR_CONTEXT(0, 1);
						func_54(&(uParam0->f_7), 13);
					}
				}
			}
			PAD::DISABLE_CONTROL_ACTION(0, 0, true);
			Var20 = { PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar16, func_53(uParam0), func_52(uParam0), 0f, 2) };
			Var23 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_53(uParam0), func_52(uParam0), 0f, 2) };
			fVar26 = Var23.f_2;
			fVar27 = 0,05f;
		...
		case 5:
			...
			Var29 = { PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar16, func_53(uParam0), func_52(uParam0), 0f, 2) };
			fVar32 = Var29.f_2;
			if ((iVar28 != 1 && iVar28 != 0) || func_39(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar32, 5f))
			{
				if (uParam0->f_1.f_1 == 3)
				{
					if (CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0) == 4)
				...
				PAD::DISABLE_CONTROL_ACTION(0, 0, true);
				uParam0->f_8 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_53(uParam0), func_52(uParam0), 2, true, false, 1f, 0f, 1,12f);
				...
				func_54(&(uParam0->f_7), 8);
				func_80(uParam0, 6);
			}
			break;
		
		case 6:
			if (func_55(&(uParam0->f_7), 10) || func_38())
			{
				func_81(&(uParam0->f_7), 10);
				func_37(uParam0);
			}
			if (func_75() && uParam0->f_9 == 8)
			{
				func_37(uParam0);
			}
			func_40(uParam0);
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar33))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar33) >= 1f)
				{
					...
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_8);
					func_54(&(uParam0->f_7), 8);
					func_54(&(uParam0->f_7), 11);
				}
				else
				{
					func_81(&(uParam0->f_7), 8);
				}
			}
			else if (!func_55(&(uParam0->f_7), 8))
			{
				func_80(uParam0, 8);
			}
			break;
...
int func_26(var uParam0)
{
	...
	iVar0 = (uParam0->f_1.f_2 + 1 % func_29(uParam0->f_1.f_1));
...
void func_31(var uParam0)
{
	...
	if (uParam0->f_13 == 6)
	{
		...
		if ((uParam0->f_13 == 6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BLOCK_INTERRUPT"))) && !func_55(&(uParam0->f_7), 12))
		{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_55(&(uParam0->f_7), 0)) && !func_55(&(uParam0->f_7), 4)) && !func_34()) && !func_32(1)) && uParam0->f_1.f_3 != 3)
			{
				if (uParam0->f_6 == -1)
				{
					if (uParam0->f_1.f_1 == 1 || uParam0->f_1.f_1 == 0)
					{
						...
						{
							func_64(&(uParam0->f_6), 4, "MPOF_AC_PC_EXIT", 0, 0, 0, 0);
						}
						else
						{
							func_64(&(uParam0->f_6), 4, "MPOF_AC_EXIT", 0, 0, 0, 0);
						}
					}
					else if (PAD::_IS_USING_KEYBOARD(2))
					{
						func_64(&(uParam0->f_6), 4, "MPOFSEAT_PCEXIT", 0, 0, 0, 0);
					}
					else
					{
						func_64(&(uParam0->f_6), 4, "MPOFSEAT_EXIT", 0, 0, 0, 0);
					}
				}
				if (uParam0->f_13 == 6)
				{
...
void func_36(var uParam0)
{
	...
	if (((func_26(uParam0) != uParam0->f_1.f_2 && uParam0->f_1.f_3 < 6) && uParam0->f_1.f_3 != 3) && uParam0->f_1.f_3 != 4)
	{
		func_25(uParam0, 1);
		func_57(uParam0, &sVar0);
		func_56(uParam0, &sVar16);
...
int func_39(float fParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
void func_58(int iParam0)
{
	...
	while (iVar0 < 3)
	{
		if (Global_2359296[func_59() /*5559*/].f_675.f_4239[iVar0 /*3*/] == iParam0)
		{
...
{
	uParam0->f_1.f_1 = func_62(uParam0->f_16[uParam0->f_9 /*14*/].f_13);
	uParam0->f_1.f_2 = func_61(uParam0);
	uParam0->f_1.f_3 = 3;
	uParam0->f_1.f_4 = 3;
}
...
int func_61(var uParam0)
{
	...
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, func_29(uParam0->f_1.f_1));
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_27())
		{
...
int func_63(int iParam0)
{
	switch (iParam0)
	{
		...
		case 6:
		case 7:
			if (Global_100026.f_374 == joaat("Apart_Cin_Room"))
			{
				return 1;
			}
			break;
...
void func_64(var uParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
{
	Stack.Push(!func_55(&(uParam0->f_7), 5));
...
int func_69(var uParam0)
{
	...
	while (iVar11 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar11]) && !PED::IS_PED_INJURED(uVar0[iVar11])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar11])) && func_78(uVar0[iVar11], &(uParam0->f_16[uParam0->f_9 /*14*/])))
		{
			return 1;
		}
		iVar11++;
...
int func_70(var uParam0)
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			if (iVar1 != PLAYER::PLAYER_ID() && func_73(iVar1, 1, 1))
			{
				if (func_78(PLAYER::GET_PLAYER_PED(iVar1), &(uParam0->f_16[uParam0->f_9 /*14*/])) || func_71(iVar1) == uParam0->f_9)
				{
					return 1;
				}
			}
...
bool func_76()
{
	return Global_1578985.f_2 != 8;
}

int func_77(int iParam0, struct<3> Param1, int iParam4)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (iParam4 == 3 || iParam4 == 4)
		{
			if (func_39(ENTITY::GET_ENTITY_HEADING(iParam0), (Param1.f_2 - 180f), 45f))
			{
				return 1;
			}
		}
		else if (func_39(ENTITY::GET_ENTITY_HEADING(iParam0), Param1.f_2, 45f))
		{
			return 1;
		}
	}
...
int func_79(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		if (func_78(PLAYER::PLAYER_PED_ID(), &(uParam0->f_16[uParam0->f_9 /*14*/])) && func_77(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
		{
			return 1;
		}
		else
...
void func_82(var uParam0)
{
	...
	else if (uParam0->f_13 > 4)
	{
		...
		PED::SET_PED_CAPSULE(PLAYER::PLAYER_PED_ID(), func_83());
...
{
	func_85(&(uParam0->f_7), 4, func_86());
	func_85(&(uParam0->f_7), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false));
	func_85(&(uParam0->f_7), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true));
	func_85(&(uParam0->f_7), 0, func_50(0));
	func_85(&(uParam0->f_7), 2, TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
...
int func_87()
{
	...
	if (func_99(PLAYER::PLAYER_ID()) && CAM::IS_SCREEN_FADED_OUT())
	{
		return 1;
	}
	if (func_88())
...
int func_88()
{
	...
	if (func_89() != 0)
	{
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(func_89()) == 0)
		{
			return 1;
		}
	}
...
{
	if (iParam0 != func_72() && func_73(iParam0, 1, 1))
	{
		if (func_101(iParam0) && !func_100(iParam0))
		{
			return 1;
		}
	}
...
int func_102(int iParam0)
{
	if (iParam0 != func_72())
	{
		if (func_73(iParam0, 1, 1))
		{
			...
			{
				return func_103(Global_2689156[iParam0 /*453*/].f_319.f_6) == 21;
			}
		}
	}
	return 0;
...
int func_104()
{
	if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("music_studio_seating", func_115(), true, 0))
	{
		return 0;
	}
	NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, false, func_115());
	func_113(0, -1, 0);
...
void func_105()
{
	func_106(0, &uLocal_128, 0, 1);
	func_106(1, &uLocal_128, 1, 1);
	func_106(2, &uLocal_128, 2, 1);
	func_106(3, &uLocal_128, 3, 1);
	func_106(4, &uLocal_128, 4, 1);
	func_106(5, &uLocal_128, 5, 2);
	func_106(6, &uLocal_128, 6, 1);
	func_106(7, &uLocal_128, 7, 2);
	func_106(8, &uLocal_128, 8, 1);
	func_106(9, &uLocal_128, 9, 1);
	func_106(10, &uLocal_128, 10, 2);
	func_106(11, &uLocal_128, 11, 1);
	func_106(12, &uLocal_128, 12, 2);
	func_106(13, &uLocal_128, 13, 2);
	func_106(14, &uLocal_128, 14, 1);
	func_106(15, &uLocal_128, 15, 1);
	func_106(16, &uLocal_128, 16, 3);
	func_106(17, &uLocal_128, 17, 1);
}
...
void func_106(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_111(iParam0, &Var0, &fVar3);
	uParam1->f_16[iParam2 /*14*/].f_13 = iParam3;
	uParam1->f_16[iParam2 /*14*/] = { Var0 };
	uParam1->f_16[iParam2 /*14*/].f_3 = { 0f, 0f, fVar3 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_108(func_110(), func_109(iParam3, fVar3)) + Var0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_108(func_107(), func_109(iParam3, fVar3)) + Var0 };
...
Vector3 func_108(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_111(int iParam0, var uParam1, var uParam2)
{
	if (func_27())
	{
		...
		{
			case 0:
				*uParam1 = { -1017,25f, -90,296f, -100,388f };
				*uParam2 = -90f;
				break;
			
			case 1:
				*uParam1 = { -1017,25f, -91,034f, -100,388f };
				*uParam2 = -90f;
				break;
			
			case 2:
				*uParam1 = { -1018,919f, -88,779f, -100,416f };
				*uParam2 = 5,76f;
				break;
			
			case 3:
				*uParam1 = { -1006,604f, -75,716f, -100,001f };
				*uParam2 = 0f;
				break;
			
			case 4:
				*uParam1 = { -1002,706f, -75,829f, -100,001f };
				*uParam2 = -45f;
				break;
			
			case 5:
				*uParam1 = { -1003,631f, -65,468f, -100,001f };
				*uParam2 = 65,88f;
				break;
			
			case 6:
				*uParam1 = { -1003,241f, -64,703f, -100,001f };
				*uParam2 = 54,72f;
				break;
			
			case 7:
				*uParam1 = { -1002,81f, -64,054f, -100,001f };
				*uParam2 = 65,16f;
				break;
			
			case 8:
				*uParam1 = { -1002,294f, -63,104f, -100,001f };
				*uParam2 = 60,84f;
				break;
			
			case 9:
				*uParam1 = { -998,893f, -80,68f, -100,001f };
				*uParam2 = 141,12f;
				break;
			
			case 10:
				*uParam1 = { -999,73f, -80,017f, -100,001f };
				*uParam2 = 147,96f;
				break;
			
			case 11:
				*uParam1 = { -997,339f, -61,701f, -100,001f };
				*uParam2 = -36,72f;
				break;
			
			case 12:
				*uParam1 = { -984,732f, -65,988f, -100,001f };
				*uParam2 = -25,65f;
				break;
			
			case 13:
				*uParam1 = { -983,832f, -66,376f, -100,001f };
				*uParam2 = -26f;
				break;
			
			case 14:
				*uParam1 = { -979,469f, -73,513f, -100,001f };
				*uParam2 = -122,76f;
				break;
			
			case 15:
				*uParam1 = { -990,732f, -77,676f, -100,001f };
				*uParam2 = 166,68f;
				break;
			
			case 16:
				*uParam1 = { -985,745f, -71,501f, -99,426f };
				*uParam2 = 44,28f;
				break;
			
			case 17:
				*uParam1 = { -1002,362f, -78,16f, -99,98f };
				*uParam2 = -89,64f;
				break;
		}
	}
